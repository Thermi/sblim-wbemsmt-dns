...
public class CreateDnsSlaveZone extends CimCommand implements ContainerUpdater {
	...
	//All Options that are local and defined for this command
		 ...
		 * 
		 */
		public static final OptionDefinition KEY_zoneName = new OptionDefinition(null,"zoneName","noDefaultValue","DnsSlaveZoneWizardPage1DataContainer.Name.argValue",true,false,"DnsSlaveZoneWizardPage1DataContainer.Name.argDescription");
			/**
		 * 
		 */
