/**
 * CreateDnsSlaveZone.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS
...
public class CreateDnsSlaveZone extends CimCommand implements ContainerUpdater {
    ...
    public static final OptionDefinition KEY_zoneName = new OptionDefinition(null, "zoneName",
            null, "DnsSlaveZoneWizardPage1DataContainer.Name.argValue", true, false,
            "DnsSlaveZoneWizardPage1DataContainer.Name.argDescription");
    /**
     *  --masters
     */
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] { KEY_zoneName,
            KEY_masters, KEY_removeMasterEntry, KEY_newMasterEntry, KEY_addNewMasterEntry,
            KEY_addPredefinedMaster, KEY_predefinedMasters, };
    ...
    public void execute(CimCommandValues values) throws WbemsmtException {
        ...
        try {
            ...
            org.sblim.wbemsmt.cli.dns.wizard.CreateSlaveZoneWizard wizard = new org.sblim.wbemsmt.cli.dns.wizard.CreateSlaveZoneWizard(
            ...
            while (!wizard.getContainer().isLast(wizard.getContainer().getCurrentPageName())) {
                ...
                if (true == false)
                    ;
                else if (dataContainer instanceof org.sblim.wbemsmt.dns.bl.container.wizard.DnsSlaveZoneWizardPage1DataContainer)
                    setCommandLineValues(
                            cmd,
                            adapter,
                            (org.sblim.wbemsmt.dns.bl.container.wizard.DnsSlaveZoneWizardPage1DataContainer) dataContainer);
                else if (dataContainer instanceof org.sblim.wbemsmt.dns.bl.container.wizard.DnsSlaveZoneWizardSummaryDataContainer)
                    setCommandLineValues(
                            cmd,
                            adapter,
                            (org.sblim.wbemsmt.dns.bl.container.wizard.DnsSlaveZoneWizardSummaryDataContainer) dataContainer);
                else {
            ...
            if (true == false)
                ;
            else if (lastPanel instanceof org.sblim.wbemsmt.dns.bl.container.wizard.DnsSlaveZoneWizardSummaryDataContainer)
                ((CreateDnsSlaveZoneLoader) loader)
                        .loadTracingObject(
                                bundle,
                                adapter,
                                (org.sblim.wbemsmt.dns.bl.container.wizard.DnsSlaveZoneWizardSummaryDataContainer) lastPanel);
            else {
            ...
            org.sblim.wbemsmt.cli.dns.container.edit.DnsSlaveZoneDataContainerImpl dc = new org.sblim.wbemsmt.cli.dns.container.edit.DnsSlaveZoneDataContainerImpl(
                    adapter);
    ...
    private void updateContainerChilds(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dns.bl.container.wizard.DnsSlaveZoneWizardPage1DataContainer dc)
    ...
    private void updateContainerChilds(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dns.bl.container.wizard.DnsSlaveZoneWizardSummaryDataContainer dc)
            throws WbemsmtException {
