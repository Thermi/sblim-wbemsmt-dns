/**
 * EditDnsHintZone.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS OF
...
public class EditDnsHintZone extends CimCommand {
    ...
    public static final OptionDefinition KEY_zoneFile = new OptionDefinition(null, "zoneFile",
            null, "DnsHintZoneDataContainer.ZoneFile.argValue", false, false,
            "DnsHintZoneDataContainer.ZoneFile.argDescription");
    /**
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] { KEY_zoneFile,
            KEY_zoneName, KEY_ttl, KEY_ttlUnit, KEY_removeTTL, };
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DnsHintZoneDataContainer.caption") }));

            CliDataLoader loader = new EditDnsHintZoneLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.cli.dns.container.edit.DnsHintZoneDataContainerImpl dc = new org.sblim.wbemsmt.cli.dns.container.edit.DnsHintZoneDataContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dns.bl.container.edit.DnsHintZoneDataContainer dc)
