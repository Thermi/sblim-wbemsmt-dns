/**
 * EditDnsForwardersForService.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class EditDnsForwardersForService extends CimCommand {
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] { KEY_forward,
            KEY_forwarders, KEY_removeForwarder, KEY_newForwarder, KEY_addForwarder,
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DnsForwardersForServiceDataContainer.caption") }));

            CliDataLoader loader = new EditDnsForwardersForServiceLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.cli.dns.container.edit.DnsForwardersForServiceDataContainerImpl dc = new org.sblim.wbemsmt.cli.dns.container.edit.DnsForwardersForServiceDataContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dns.bl.container.edit.DnsForwardersForServiceDataContainer dc)
