/**
 * DeleteDnsResourceRecord.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class DeleteDnsResourceRecord extends CimCommand {
    ...
    public static final OptionDefinition KEY_zoneName = new OptionDefinition(null, "zoneName",
            null, "DeleteDnsResourceRecord.zoneName.argValue", true, false,
            "DeleteDnsResourceRecord.zoneName.argDescription");
    /**
    ...
    public static final OptionDefinition KEY_recordNameToSelect = new OptionDefinition(null,
            "recordNameToSelect", null, "DeleteDnsResourceRecord.recordNameToSelect.argValue",
            true, false, "DeleteDnsResourceRecord.recordNameToSelect.argDescription");
    /**
    ...
    public static final OptionDefinition KEY_recordTypeToSelect = new OptionDefinition(null,
            "recordTypeToSelect", null, "DeleteDnsResourceRecord.recordTypeToSelect.argValue",
            true, false, "DeleteDnsResourceRecord.recordTypeToSelect.argDescription");
    /**
    ...
    public static final OptionDefinition KEY_recordValueToSelect = new OptionDefinition(null,
            "recordValueToSelect", null, "DeleteDnsResourceRecord.recordValueToSelect.argValue",
            true, false, "DeleteDnsResourceRecord.recordValueToSelect.argDescription");
    /**
    ...
    public static final OptionDefinition KEY_mxPriorityToSelect = new OptionDefinition(null,
            "mxPriorityToSelect", null, "DeleteDnsResourceRecord.mxPriorityToSelect.argValue",
            true, false, "DeleteDnsResourceRecord.mxPriorityToSelect.argDescription");
    ...
    public DeleteDnsResourceRecord(java.util.Locale locale) {
