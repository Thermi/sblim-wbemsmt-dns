...
/** 
  ...
  * Contributors: 
  * 
  * Description: Loader for editing a StubZone
  * 
  */
...
public class EditDnsStubZoneLoader extends DnsDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		this.commandValues = commandValues;
				String name = CliUtil.getOption(commandValues,EditDnsStubZone.KEY_zoneName);
