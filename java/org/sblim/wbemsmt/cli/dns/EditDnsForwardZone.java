/**
 * EditDnsForwardZone.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS
...
public class EditDnsForwardZone extends CimCommand {
    ...
    public static final OptionDefinition KEY_useGlobalForwarders = new OptionDefinition(null,
            ...
            "DnsForwardZoneDataContainer.useGlobalForwarders.argDescription");
    /**
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dns.bl.container.edit.DnsForwardZoneDataContainer dc)
