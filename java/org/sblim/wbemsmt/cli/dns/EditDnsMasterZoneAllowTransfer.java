...
public class EditDnsMasterZoneAllowTransfer extends CimCommand {
	...
	//All Options that are local and defined for this command
		 ...
		 * 
		 */
		public static final OptionDefinition KEY_zoneName = new OptionDefinition(null,"zoneName","noDefaultValue","EditDnsMasterZoneAllowTransfer.zoneName.argValue",true,false,"EditDnsMasterZoneAllowTransfer.zoneName.argDescription");
			/**
		 * 
		 */
