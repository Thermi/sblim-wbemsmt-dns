/** 
  * EditDnsMasterZoneAllowTransfer.java
  *
...
public class EditDnsMasterZoneAllowTransfer extends CimCommand {

			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_hostname = new OptionDefinition("hostname",null,"EditDnsMasterZoneAllowTransfer.hostname.argValue",true,false,"EditDnsMasterZoneAllowTransfer.hostname.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_port = new OptionDefinition("port","5988","EditDnsMasterZoneAllowTransfer.port.argValue",false,false,"EditDnsMasterZoneAllowTransfer.port.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_namespace = new OptionDefinition("namespace","/root/cimv2","EditDnsMasterZoneAllowTransfer.namespace.argValue",false,false,"EditDnsMasterZoneAllowTransfer.namespace.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_user = new OptionDefinition("user",null,"EditDnsMasterZoneAllowTransfer.user.argValue",true,false,"EditDnsMasterZoneAllowTransfer.user.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_password = new OptionDefinition("password",null,"EditDnsMasterZoneAllowTransfer.password.argValue",true,false,"EditDnsMasterZoneAllowTransfer.password.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_publickeyfile = new OptionDefinition("publickeyfile","none","EditDnsMasterZoneAllowTransfer.publickeyfile.argValue",false,false,"EditDnsMasterZoneAllowTransfer.publickeyfile.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_privatekeyfile = new OptionDefinition("privatekeyfile","none","EditDnsMasterZoneAllowTransfer.privatekeyfile.argValue",false,false,"EditDnsMasterZoneAllowTransfer.privatekeyfile.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_dnsServiceName = new OptionDefinition("dnsServiceName",null,"EditDnsMasterZoneAllowTransfer.dnsServiceName.argValue",true,false,"EditDnsMasterZoneAllowTransfer.dnsServiceName.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_zoneName = new OptionDefinition("zoneName",null,"EditDnsMasterZoneAllowTransfer.zoneName.argValue",true,false,"EditDnsMasterZoneAllowTransfer.zoneName.argDescription");
...
public static final OptionDefinition KEY_locale = new OptionDefinition("locale","en","locale",false,false,"locale");	
 ...
 CommandLine cmd = null;
	...
	public EditDnsMasterZoneAllowTransfer(java.util.Locale locale)
	{
		super("EditDnsMasterZoneAllowTransfer", new String[]{"messages","messagesDns"},locale);
	}
	...
	public void execute(String[] args) throws WbemSmtException {
		...
		try {
			...
			CliDataLoader loader = new EditDnsMasterZoneAllowTransferLoader();
