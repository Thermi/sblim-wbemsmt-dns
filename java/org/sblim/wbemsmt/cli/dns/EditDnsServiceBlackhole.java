/**
 * EditDnsServiceBlackhole.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class EditDnsServiceBlackhole extends CimCommand {
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DnsBlackholeForServiceDataContainer.caption") }));

            CliDataLoader loader = new EditDnsServiceBlackholeLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.cli.dns.container.edit.DnsBlackholeForServiceDataContainerImpl dc = new org.sblim.wbemsmt.cli.dns.container.edit.DnsBlackholeForServiceDataContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dns.bl.container.edit.DnsBlackholeForServiceDataContainer dc)
