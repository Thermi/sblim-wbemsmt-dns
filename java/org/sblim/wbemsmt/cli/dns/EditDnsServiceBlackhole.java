...
public class EditDnsServiceBlackhole extends CimCommand {

			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_hostname = new OptionDefinition("hostname",null,"EditDnsServiceBlackhole.hostname.argValue",true,false,"EditDnsServiceBlackhole.hostname.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_port = new OptionDefinition("port","5988","EditDnsServiceBlackhole.port.argValue",false,false,"EditDnsServiceBlackhole.port.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_namespace = new OptionDefinition("namespace","/root/cimv2","EditDnsServiceBlackhole.namespace.argValue",false,false,"EditDnsServiceBlackhole.namespace.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_user = new OptionDefinition("user",null,"EditDnsServiceBlackhole.user.argValue",true,false,"EditDnsServiceBlackhole.user.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_password = new OptionDefinition("password",null,"EditDnsServiceBlackhole.password.argValue",true,false,"EditDnsServiceBlackhole.password.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_publickeyfile = new OptionDefinition("publickeyfile","none","EditDnsServiceBlackhole.publickeyfile.argValue",false,false,"EditDnsServiceBlackhole.publickeyfile.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_privatekeyfile = new OptionDefinition("privatekeyfile","none","EditDnsServiceBlackhole.privatekeyfile.argValue",false,false,"EditDnsServiceBlackhole.privatekeyfile.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_dnsServiceName = new OptionDefinition("dnsServiceName",null,"EditDnsServiceBlackhole.dnsServiceName.argValue",true,false,"EditDnsServiceBlackhole.dnsServiceName.argDescription");
...
public static final OptionDefinition KEY_locale = new OptionDefinition("locale","en","locale",false,false,"locale");	
 ...
 CommandLine cmd = null;
	...
	public EditDnsServiceBlackhole(java.util.Locale locale)
	{
		super("EditDnsServiceBlackhole", new String[]{"messages","messagesDns"},locale);
	}
	...
	public void execute(String[] args) throws WbemSmtException {
		...
		System.out.println("\n" + bundle.getString("editing",new Object[]{bundle.getString("DnsBlackholeForServiceDataContainer.caption")}));
		try {
			...
			CliDataLoader loader = new EditDnsServiceBlackholeLoader();
			loader.load(bundle,adapter, cmd);
			
			org.sblim.wbemsmt.cli.dns.container.edit.DnsBlackholeForServiceDataContainerImpl dc = new org.sblim.wbemsmt.cli.dns.container.edit.DnsBlackholeForServiceDataContainerImpl(adapter);
			...
			System.out.println("\n" + bundle.getString("edited", new Object[]{bundle.getString("DnsBlackholeForServiceDataContainer.caption")}));
	 ...
	 **/
	private void setKeyValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dns.bl.container.edit.DnsBlackholeForServiceDataContainer dc) throws WbemSmtException {
    	    				    				    				    				    				    				    				    					}	
	
	/**
	 * Set all Values that are not read-Only
	 **/
	private void setValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dns.bl.container.edit.DnsBlackholeForServiceDataContainer dc) throws WbemSmtException {
