/**
 * ListDnsServiceConfiguration.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class ListDnsServiceConfiguration extends CimCommand {
    ...
    public static final OptionDefinition KEY_list = new OptionDefinition(null, "list",
            "INSTANCE_WITH_CHILDS", "ListDnsServiceConfiguration.list.argValue", false, false,
            "ListDnsServiceConfiguration.list.argDescription");
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("listing", new Object[] { bundle
                                    .getString("DnsServiceTracingDataContainer.caption") }));

            CliDataLoader loader = new ListDnsServiceConfigurationLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.cli.dns.container.edit.DnsServiceTracingDataContainerImpl dc = new org.sblim.wbemsmt.cli.dns.container.edit.DnsServiceTracingDataContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dns.bl.container.edit.DnsServiceTracingDataContainer dc)
