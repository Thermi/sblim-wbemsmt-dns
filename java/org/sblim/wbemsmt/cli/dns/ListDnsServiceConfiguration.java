...
public class ListDnsServiceConfiguration extends CimCommand {
	...
	//All Options that are local and defined for this command
		 ...
		 * 
		 */
		public static final OptionDefinition KEY_list = new OptionDefinition(null,"list","INSTANCE_WITH_CHILDS","ListDnsServiceConfiguration.list.argValue",false,false,"ListDnsServiceConfiguration.list.argDescription");
