...
/** 
  ...
  * Contributors: 
  * 
  * Description: Loader for deleting a SlaveZone
  * 
  */
...
public class DeleteDnsSlaveZoneLoader extends DnsDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		this.commandValues = commandValues;
				String name = CliUtil.getOption(commandValues,DeleteDnsSlaveZone.KEY_zoneName);
