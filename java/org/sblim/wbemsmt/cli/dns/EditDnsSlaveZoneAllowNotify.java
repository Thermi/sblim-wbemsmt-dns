/**
 * EditDnsSlaveZoneAllowNotify.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class EditDnsSlaveZoneAllowNotify extends CimCommand {
    ...
    public static final OptionDefinition KEY_zoneName = new OptionDefinition(null, "zoneName",
            null, "EditDnsSlaveZoneAllowNotify.zoneName.argValue", true, false,
            "EditDnsSlaveZoneAllowNotify.zoneName.argDescription");
    /**
    ...
    public static final OptionDefinition KEY_useGlobalAddressMatchList = new OptionDefinition(null,
            ...
            "DnsAllowNotifyForZoneDataContainer.useGlobalAddressMatchList.argDescription");
    /**
     *  --addressList
     */
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DnsAllowNotifyForZoneDataContainer.caption") }));

            CliDataLoader loader = new EditDnsSlaveZoneAllowNotifyLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.cli.dns.container.edit.DnsAllowNotifyForZoneDataContainerImpl dc = new org.sblim.wbemsmt.cli.dns.container.edit.DnsAllowNotifyForZoneDataContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dns.bl.container.edit.DnsAllowNotifyForZoneDataContainer dc)
