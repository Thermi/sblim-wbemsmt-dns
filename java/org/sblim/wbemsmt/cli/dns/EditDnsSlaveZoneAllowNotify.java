...
public class EditDnsSlaveZoneAllowNotify extends CimCommand {
	...
	//All Options that are local and defined for this command
		 ...
		 */
		public static final OptionDefinition KEY_zoneName = new OptionDefinition(null,"zoneName",null,"EditDnsSlaveZoneAllowNotify.zoneName.argValue",true,false,"EditDnsSlaveZoneAllowNotify.zoneName.argDescription");
			/**
   		 *  --useGlobalAddressMatchList
		 */
		public static final OptionDefinition KEY_useGlobalAddressMatchList = new OptionDefinition(null,"useGlobalAddressMatchList",null,null,false,false,"DnsAllowNotifyForZoneDataContainer.useGlobalAddressMatchList.argDescription");
			/**
   		 *  --addressList
		 */
