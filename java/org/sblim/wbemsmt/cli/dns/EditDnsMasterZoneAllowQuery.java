...
public class EditDnsMasterZoneAllowQuery extends CimCommand {
	...
	//All Options that are local and defined for this command
		 ...
		 */
		public static final OptionDefinition KEY_zoneName = new OptionDefinition(null,"zoneName","noDefaultValue","EditDnsMasterZoneAllowQuery.zoneName.argValue",true,false,"EditDnsMasterZoneAllowQuery.zoneName.argDescription");
			/**
