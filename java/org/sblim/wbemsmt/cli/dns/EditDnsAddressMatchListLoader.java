...
public class EditDnsAddressMatchListLoader extends DnsDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
			...
			String name = commandValues.getOptionValue(EditDnsAddressMatchList.KEY_matchListName.getLongKey());
