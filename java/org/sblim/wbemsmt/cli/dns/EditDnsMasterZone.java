...
public class EditDnsMasterZone extends CimCommand {
	...
	//All Options that are local and defined for this command
		 ...
		 * 
		 */
		public static final OptionDefinition KEY_zoneFile = new OptionDefinition(null,"zoneFile","noDefaultValue","DnsMasterZoneDataContainer.ZoneFile.argValue",false,false,"DnsMasterZoneDataContainer.ZoneFile.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_useGlobalForwarders = new OptionDefinition(null,"useGlobalForwarders","noDefaultValue","DnsMasterZoneDataContainer.useGlobalForwarders.argValue",false,false,"DnsMasterZoneDataContainer.useGlobalForwarders.argDescription");
			/**
		 * 
		 */
