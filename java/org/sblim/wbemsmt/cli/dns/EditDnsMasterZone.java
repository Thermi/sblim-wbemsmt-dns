/**
 * EditDnsMasterZone.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS OF
...
public class EditDnsMasterZone extends CimCommand {
    ...
    public static final OptionDefinition KEY_zoneFile = new OptionDefinition(null, "zoneFile",
            null, "DnsMasterZoneDataContainer.ZoneFile.argValue", false, false,
            "DnsMasterZoneDataContainer.ZoneFile.argDescription");
    /**
     *  --useGlobalForwarders
     */
    public static final OptionDefinition KEY_useGlobalForwarders = new OptionDefinition(null,
            ...
            "DnsMasterZoneDataContainer.useGlobalForwarders.argDescription");
    /**
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DnsMasterZoneDataContainer.caption") }));
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dns.bl.container.edit.DnsMasterZoneDataContainer dc)
