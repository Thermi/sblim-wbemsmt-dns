...
/** 
  * EditDnsSlaveZoneAllowNotifyLoader.java
  *
...
public class EditDnsSlaveZoneAllowNotifyLoader extends DnsDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		this.commandValues = commandValues;
				String name = CliUtil.getOption(commandValues,EditDnsSlaveZoneAllowNotify.KEY_zoneName);
