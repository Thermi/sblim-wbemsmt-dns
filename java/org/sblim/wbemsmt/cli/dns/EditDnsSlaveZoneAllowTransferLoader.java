...
/** 
  * EditDnsSlaveZoneAllowTransferLoader.java
  *
...
public class EditDnsSlaveZoneAllowTransferLoader extends DnsDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		this.cmd = cmd;
				String name = CliUtil.getOption(cmd,EditDnsSlaveZoneAllowTransfer.KEY_zoneName);
