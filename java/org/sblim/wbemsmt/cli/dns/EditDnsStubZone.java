...
public class EditDnsStubZone extends CimCommand {
		 ...
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_hostname = new OptionDefinition("hostname",null,"EditDnsStubZone.hostname.argValue",true,false,"EditDnsStubZone.hostname.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_port = new OptionDefinition("port","5988","EditDnsStubZone.port.argValue",false,false,"EditDnsStubZone.port.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_namespace = new OptionDefinition("namespace","/root/cimv2","EditDnsStubZone.namespace.argValue",false,false,"EditDnsStubZone.namespace.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_user = new OptionDefinition("user",null,"EditDnsStubZone.user.argValue",true,false,"EditDnsStubZone.user.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_password = new OptionDefinition("password",null,"EditDnsStubZone.password.argValue",true,false,"EditDnsStubZone.password.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_publickeyfile = new OptionDefinition("publickeyfile","none","EditDnsStubZone.publickeyfile.argValue",false,false,"EditDnsStubZone.publickeyfile.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_privatekeyfile = new OptionDefinition("privatekeyfile","none","EditDnsStubZone.privatekeyfile.argValue",false,false,"EditDnsStubZone.privatekeyfile.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_dnsServiceName = new OptionDefinition("dnsServiceName",null,"EditDnsStubZone.dnsServiceName.argValue",true,false,"EditDnsStubZone.dnsServiceName.argDescription");
	
			/**
		 * ${option.getOption().getComment()}
		 */
		public static final OptionDefinition KEY_zoneFile = new OptionDefinition("zoneFile",null,"DnsStubZoneDataContainer.ZoneFile.argValue",false,false,"DnsStubZoneDataContainer.ZoneFile.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_useGlobalForwarders = new OptionDefinition("useGlobalForwarders",null,null,false,false,"DnsStubZoneDataContainer.useGlobalForwarders.argDescription");
			/**
		 * 
		 */
