...
public class EditDnsStubZone extends CimCommand {
	...
	//All Options that are local and defined for this command
		 ...
		 * 
		 */
		public static final OptionDefinition KEY_useGlobalForwarders = new OptionDefinition(null,"useGlobalForwarders","noDefaultValue","DnsStubZoneDataContainer.useGlobalForwarders.argValue",false,false,"DnsStubZoneDataContainer.useGlobalForwarders.argDescription");
			/**
		 * 
		 */
