/**
 * EditDnsStubZone.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS OF
...
public class EditDnsStubZone extends CimCommand {
    ...
    public static final OptionDefinition KEY_zoneFile = new OptionDefinition(null, "zoneFile",
            null, "DnsStubZoneDataContainer.ZoneFile.argValue", false, false,
            "DnsStubZoneDataContainer.ZoneFile.argDescription");
    /**
     *  --useGlobalForwarders
     */
    public static final OptionDefinition KEY_useGlobalForwarders = new OptionDefinition(null,
            ...
            "DnsStubZoneDataContainer.useGlobalForwarders.argDescription");
    /**
     *  --forward
     */
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] { KEY_zoneFile,
            ...
            KEY_newForwarder, KEY_addForwarder, KEY_newForwarderType, KEY_zoneName, KEY_masters,
            KEY_removeMasterEntry, KEY_newMasterEntry, KEY_addNewMasterEntry,
            KEY_addPredefinedMaster, KEY_predefinedMasters, KEY_ttl, KEY_ttlUnit, KEY_removeTTL, };
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DnsStubZoneDataContainer.caption") }));
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dns.bl.container.edit.DnsStubZoneDataContainer dc)
