/** 
  * EditDnsReverseZoneAllowTransfer.java
  *
...
public class EditDnsReverseZoneAllowTransfer extends CimCommand {

			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_hostname = new OptionDefinition("hostname",null,"EditDnsReverseZoneAllowTransfer.hostname.argValue",true,false,"EditDnsReverseZoneAllowTransfer.hostname.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_port = new OptionDefinition("port","5988","EditDnsReverseZoneAllowTransfer.port.argValue",false,false,"EditDnsReverseZoneAllowTransfer.port.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_namespace = new OptionDefinition("namespace","/root/cimv2","EditDnsReverseZoneAllowTransfer.namespace.argValue",false,false,"EditDnsReverseZoneAllowTransfer.namespace.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_user = new OptionDefinition("user",null,"EditDnsReverseZoneAllowTransfer.user.argValue",true,false,"EditDnsReverseZoneAllowTransfer.user.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_password = new OptionDefinition("password",null,"EditDnsReverseZoneAllowTransfer.password.argValue",true,false,"EditDnsReverseZoneAllowTransfer.password.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_publickeyfile = new OptionDefinition("publickeyfile","none","EditDnsReverseZoneAllowTransfer.publickeyfile.argValue",false,false,"EditDnsReverseZoneAllowTransfer.publickeyfile.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_privatekeyfile = new OptionDefinition("privatekeyfile","none","EditDnsReverseZoneAllowTransfer.privatekeyfile.argValue",false,false,"EditDnsReverseZoneAllowTransfer.privatekeyfile.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_dnsServiceName = new OptionDefinition("dnsServiceName",null,"EditDnsReverseZoneAllowTransfer.dnsServiceName.argValue",true,false,"EditDnsReverseZoneAllowTransfer.dnsServiceName.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_zoneName = new OptionDefinition("zoneName",null,"EditDnsReverseZoneAllowTransfer.zoneName.argValue",true,false,"EditDnsReverseZoneAllowTransfer.zoneName.argDescription");
...
public static final OptionDefinition KEY_locale = new OptionDefinition("locale","en","locale",false,false,"locale");	
 ...
 CommandLine cmd = null;
	...
	public EditDnsReverseZoneAllowTransfer(java.util.Locale locale)
	{
		super("EditDnsReverseZoneAllowTransfer", new String[]{"messages","messagesDns"},locale);
	}
	...
	public void execute(String[] args) throws WbemSmtException {
		...
		try {
			...
			CliDataLoader loader = new EditDnsReverseZoneAllowTransferLoader();
