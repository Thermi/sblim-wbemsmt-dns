...
public class EditDnsReverseZoneAllowTransfer extends CimCommand {
	...
	//All Options that are local and defined for this command
		 ...
		 */
		public static final OptionDefinition KEY_zoneName = new OptionDefinition(null,"zoneName",null,"EditDnsReverseZoneAllowTransfer.zoneName.argValue",true,false,"EditDnsReverseZoneAllowTransfer.zoneName.argDescription");
			/**
   		 *  --useGlobalAddressMatchList
		 */
		public static final OptionDefinition KEY_useGlobalAddressMatchList = new OptionDefinition(null,"useGlobalAddressMatchList",null,null,false,false,"DnsAllowTransferForZoneDataContainer.useGlobalAddressMatchList.argDescription");
			/**
   		 *  --addressList
		 */
