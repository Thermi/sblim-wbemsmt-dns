...
public class EditDnsReverseZoneAllowTransfer extends CimCommand {
	...
	//All Options that are local and defined for this command
		 ...
		 * 
		 */
		public static final OptionDefinition KEY_zoneName = new OptionDefinition(null,"zoneName","noDefaultValue","EditDnsReverseZoneAllowTransfer.zoneName.argValue",true,false,"EditDnsReverseZoneAllowTransfer.zoneName.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_useGlobalAddressMatchList = new OptionDefinition(null,"useGlobalAddressMatchList","noDefaultValue","DnsAllowTransferForZoneDataContainer.useGlobalAddressMatchList.argValue",false,false,"DnsAllowTransferForZoneDataContainer.useGlobalAddressMatchList.argDescription");
			/**
		 * 
		 */
