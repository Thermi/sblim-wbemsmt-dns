/**
 * EditDnsReverseZoneAllowTransfer.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class EditDnsReverseZoneAllowTransfer extends CimCommand {
    ...
    public static final OptionDefinition KEY_zoneName = new OptionDefinition(null, "zoneName",
            null, "EditDnsReverseZoneAllowTransfer.zoneName.argValue", true, false,
            "EditDnsReverseZoneAllowTransfer.zoneName.argDescription");
    /**
     *  --useGlobalAddressMatchList
     */
    public static final OptionDefinition KEY_useGlobalAddressMatchList = new OptionDefinition(null,
            "useGlobalAddressMatchList", null, null, false, false,
            "DnsAllowTransferForZoneDataContainer.useGlobalAddressMatchList.argDescription");
    /**
     *  --addressList
     */
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] { KEY_zoneName,
            KEY_useGlobalAddressMatchList, KEY_addressList, KEY_removeAddress, KEY_userAddresses,
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DnsAllowTransferForZoneDataContainer.caption") }));

            CliDataLoader loader = new EditDnsReverseZoneAllowTransferLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.cli.dns.container.edit.DnsAllowTransferForZoneDataContainerImpl dc = new org.sblim.wbemsmt.cli.dns.container.edit.DnsAllowTransferForZoneDataContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dns.bl.container.edit.DnsAllowTransferForZoneDataContainer dc)
    ...
    private void setValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
        ...
        //The Buttons
        if (!pressButton(cmd, adapter, dc, dc.get_usr_UseGlobalAddressMatchList(),
