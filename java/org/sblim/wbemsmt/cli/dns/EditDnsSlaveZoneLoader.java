...
/** 
  ...
  * Contributors: 
  * 
  * Description: Loader for editing a SlaveZone
  * 
  */
...
public class EditDnsSlaveZoneLoader extends DnsDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		this.commandValues = commandValues;
				String name = CliUtil.getOption(commandValues,EditDnsSlaveZone.KEY_zoneName);
