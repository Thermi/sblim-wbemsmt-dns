/**
 * CreateDnsForwardZone.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS
...
public class CreateDnsForwardZone extends CimCommand implements ContainerUpdater {
    ...
    public static final OptionDefinition KEY_zoneName = new OptionDefinition(null, "zoneName",
            null, "DnsForwardZoneWizardPage1DataContainer.Name.argValue", true, false,
            "DnsForwardZoneWizardPage1DataContainer.Name.argDescription");
    /**
     *  --useGlobalForwarders
     */
    public static final OptionDefinition KEY_useGlobalForwarders = new OptionDefinition(null,
            ...
            "DnsForwardZoneWizardPage1DataContainer.useGlobalForwarders.argDescription");
    /**
     *  --forward
     */
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] { KEY_zoneName,
            KEY_useGlobalForwarders, KEY_forward, KEY_forwarders, KEY_removeForwarder,
            KEY_newForwarder, KEY_addForwarder, KEY_newForwarderType, };
    ...
    public void execute(CimCommandValues values) throws WbemsmtException {
        ...
        try {
            ...
            org.sblim.wbemsmt.cli.dns.wizard.CreateForwardZoneWizard wizard = new org.sblim.wbemsmt.cli.dns.wizard.CreateForwardZoneWizard(
            ...
            while (!wizard.getContainer().isLast(wizard.getContainer().getCurrentPageName())) {
                ...
                if (true == false)
                    ;
                else if (dataContainer instanceof org.sblim.wbemsmt.dns.bl.container.wizard.DnsForwardZoneWizardPage1DataContainer)
                    setCommandLineValues(
                            cmd,
                            adapter,
                            (org.sblim.wbemsmt.dns.bl.container.wizard.DnsForwardZoneWizardPage1DataContainer) dataContainer);
                else if (dataContainer instanceof org.sblim.wbemsmt.dns.bl.container.wizard.DnsForwardZoneWizardSummaryDataContainer)
                    setCommandLineValues(
                            cmd,
                            adapter,
                            (org.sblim.wbemsmt.dns.bl.container.wizard.DnsForwardZoneWizardSummaryDataContainer) dataContainer);
                else {
            ...
            if (true == false)
                ;
            else if (lastPanel instanceof org.sblim.wbemsmt.dns.bl.container.wizard.DnsForwardZoneWizardSummaryDataContainer)
                ((CreateDnsForwardZoneLoader) loader)
                        .loadTracingObject(
                                bundle,
                                adapter,
                                (org.sblim.wbemsmt.dns.bl.container.wizard.DnsForwardZoneWizardSummaryDataContainer) lastPanel);
            else {
            ...
            org.sblim.wbemsmt.cli.dns.container.edit.DnsForwardZoneDataContainerImpl dc = new org.sblim.wbemsmt.cli.dns.container.edit.DnsForwardZoneDataContainerImpl(
                    adapter);
    ...
    private void updateContainerChilds(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dns.bl.container.wizard.DnsForwardZoneWizardPage1DataContainer dc)
    ...
    private void updateContainerChilds(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dns.bl.container.wizard.DnsForwardZoneWizardSummaryDataContainer dc)
            throws WbemsmtException {
