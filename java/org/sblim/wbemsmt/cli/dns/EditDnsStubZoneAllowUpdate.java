...
public class EditDnsStubZoneAllowUpdate extends CimCommand {
	...
	//All Options that are local and defined for this command
		 ...
		 * 
		 */
		public static final OptionDefinition KEY_zoneName = new OptionDefinition(null,"zoneName","noDefaultValue","EditDnsStubZoneAllowUpdate.zoneName.argValue",true,false,"EditDnsStubZoneAllowUpdate.zoneName.argDescription");
			/**
		 * 
		 */
