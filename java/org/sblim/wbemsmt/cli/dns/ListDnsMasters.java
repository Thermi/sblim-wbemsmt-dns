/**
 * ListDnsMasters.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS OF
...
public class ListDnsMasters extends CimCommand {
    ...
    public static final OptionDefinition KEY_list = new OptionDefinition(null, "list",
            "INSTANCE_WITH_CHILDS", "ListDnsMasters.list.argValue", false, false,
            "ListDnsMasters.list.argDescription");
    /**
     * used for selection:  --mastersName
     */
    public static final OptionDefinition KEY_mastersName = new OptionDefinition(null,
            "mastersName", null, "DnsMastersForServiceDataContainer.Name.argValue", false, true,
            "DnsMastersForServiceDataContainer.Name.argDescription");
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("listing", new Object[] { bundle
                                    .getString("DnsMastersForServiceDataContainer.caption") }));

            CliDataLoader loader = new ListDnsMastersLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.cli.dns.container.edit.DnsMastersForServiceDataContainerImpl dc = new org.sblim.wbemsmt.cli.dns.container.edit.DnsMastersForServiceDataContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dns.bl.container.edit.DnsMastersForServiceDataContainer dc)
