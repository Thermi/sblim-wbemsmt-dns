...
public class EditDnsSlaveZoneAllowTransfer extends CimCommand {
	...
	//All Options that are local and defined for this command
		 ...
		 */
		public static final OptionDefinition KEY_zoneName = new OptionDefinition(null,"zoneName","noDefaultValue","EditDnsSlaveZoneAllowTransfer.zoneName.argValue",true,false,"EditDnsSlaveZoneAllowTransfer.zoneName.argDescription");
			/**
