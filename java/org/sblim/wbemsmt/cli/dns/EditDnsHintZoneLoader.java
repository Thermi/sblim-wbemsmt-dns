...
/** 
  ...
  * Contributors: 
  * 
  * Description: Loader for editing a HintZone
  * 
  */
...
public class EditDnsHintZoneLoader extends DnsDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		this.commandValues = commandValues;
				String name = CliUtil.getOption(commandValues,EditDnsHintZone.KEY_zoneName);
				selectHintZone(bundle, adapter, name);
	}
