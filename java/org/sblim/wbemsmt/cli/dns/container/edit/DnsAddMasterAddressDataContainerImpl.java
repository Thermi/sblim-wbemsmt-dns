...
public class DnsAddMasterAddressDataContainerImpl extends BaseDataContainer implements
    ...
    public DnsAddMasterAddressDataContainerImpl(AbstractBaseCimAdapter adapter)
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "DnsAddMasterAddressDataContainer.caption"));
        }
