...
public class DnsResourceRecordListItemContainerImpl extends BaseDataContainer implements
    ...
    public DnsResourceRecordListItemContainerImpl(AbstractBaseCimAdapter adapter)
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_DeleteRecord() {
        if (ic_usr_DeleteRecord == null) {
            String label = getAdapter().getBundle().getString(
                    "DnsResourceRecordListItemContainer.deleteRecord");
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.BooleanStringConverter();
            ic_usr_DeleteRecord = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_Name() {
        if (ic_Name == null) {
            String label = getAdapter().getBundle().getString(
                    "DnsResourceRecordListItemContainer.Name");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_TTL() {
        if (ic_TTL == null) {
            String label = getAdapter().getBundle().getString(
                    "DnsResourceRecordListItemContainer.TTL");
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_TTLUnit() {
        if (ic_usr_TTLUnit == null) {
            String label = getAdapter().getBundle().getString(
                    "DnsResourceRecordListItemContainer.TTLUnit");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_RemoveTTL() {
        if (ic_usr_RemoveTTL == null) {
            String label = getAdapter().getBundle().getString(
                    "DnsResourceRecordListItemContainer.removeTTL");
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_Family() {
        if (ic_Family == null) {
            String label = getAdapter().getBundle().getString(
                    "DnsResourceRecordListItemContainer.Family");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_Type() {
        if (ic_Type == null) {
            String label = getAdapter().getBundle().getString(
                    "DnsResourceRecordListItemContainer.Type");
            org.sblim.wbemsmt.tools.converter.StringArrayConverter converter = new org.sblim.wbemsmt.tools.converter.UnsignedInt16StringArrayConverter();
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_Value() {
        if (ic_Value == null) {
            String label = getAdapter().getBundle().getString(
                    "DnsResourceRecordListItemContainer.Value");
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "DnsResourceRecordListItemContainer.caption"));
        }
        ...
        if (showInstance(listOptions)) {
            if (get_usr_DeleteRecord().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_DeleteRecord())
                        .getValue();
            ...
            if (get_Family().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_Family())
                        .getValue();
                printStream.println(get_Family().getLabelText() + ": " + value);
            }
            if (get_Type().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_Type())
                        .getValue();
                printStream.println(get_Type().getLabelText() + ": " + value);
            }
            if (get_Value().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_Value())
                        .getValue();
