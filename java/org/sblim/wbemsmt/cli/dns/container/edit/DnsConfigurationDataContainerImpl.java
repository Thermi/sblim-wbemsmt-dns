...
public class DnsConfigurationDataContainerImpl extends BaseDataContainer implements
        org.sblim.wbemsmt.dns.bl.container.edit.DnsConfigurationDataContainer {
    ...
    public DnsConfigurationDataContainerImpl(AbstractBaseCimAdapter adapter)
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "DnsConfigurationDataContainer.caption"));
        }
        ...
        if (showInstance(listOptions)) {
            ...
            if (get_ConfigurationDirectory().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_ConfigurationDirectory())
                        .getValue();
                printStream.println(get_ConfigurationDirectory().getLabelText() + ": " + value);
            }
            if (get_PortNumber().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_PortNumber())
                        .getValue();
