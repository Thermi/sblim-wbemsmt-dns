...
public class DnsResourceRecordForReverseZoneWizardDataContainerImpl extends BaseDataContainer
        implements
    ...
    public DnsResourceRecordForReverseZoneWizardDataContainerImpl(AbstractBaseCimAdapter adapter)
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "DnsResourceRecordForReverseZoneWizardDataContainer.caption"));
        }
