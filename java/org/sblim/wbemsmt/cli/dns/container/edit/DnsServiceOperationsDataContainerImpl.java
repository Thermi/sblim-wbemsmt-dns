...
public class DnsServiceOperationsDataContainerImpl extends BaseDataContainer implements
    ...
    public DnsServiceOperationsDataContainerImpl(AbstractBaseCimAdapter adapter)
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "DnsServiceOperationsDataContainer.caption"));
        }
        ...
        if (showInstance(listOptions)) {
            if (get_RunAsRoot().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_RunAsRoot())
                        .getValue();
                printStream.println(get_RunAsRoot().getLabelText() + ": " + value);
            }
            if (get_Status().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_Status())
                        .getValue();
