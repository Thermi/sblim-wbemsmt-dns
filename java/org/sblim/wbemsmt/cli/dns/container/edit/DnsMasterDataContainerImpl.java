...
public class DnsMasterDataContainerImpl extends BaseDataContainer implements
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle()
                    .getString("DnsMasterDataContainer.caption"));
        }
        ...
        if (showInstance(listOptions)) {
            ...
            if (get_MasterElementType().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_MasterElementType())
                        .getValue();
                printStream.println(get_MasterElementType().getLabelText() + ": " + value);
            }
            if (get_MasterElement().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_MasterElement())
                        .getValue();
