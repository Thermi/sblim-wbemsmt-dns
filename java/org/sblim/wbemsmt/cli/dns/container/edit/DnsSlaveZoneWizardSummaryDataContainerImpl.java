 ...
 * (C) Copyright IBM Corp. 2005
  ...
  * @template: templates/cmd/containerImpl.vm
  *
  * Contributors: 
  * 
...
public class DnsSlaveZoneWizardSummaryDataContainerImpl extends BaseDataContainer implements org.sblim.wbemsmt.dns.bl.container.wizard.DnsSlaveZoneWizardSummaryDataContainer {
	...
	public DnsSlaveZoneWizardSummaryDataContainerImpl(AbstractBaseCimAdapter adapter) throws InitContainerException {
		super();
		setAdapter(adapter);
	...
	public void trace(java.io.PrintStream printStream, String listOptions, boolean title)
	{
		if (title)
		{
			printStream.println(bundle.getString("DnsSlaveZoneWizardSummaryDataContainer.caption"));
		}
