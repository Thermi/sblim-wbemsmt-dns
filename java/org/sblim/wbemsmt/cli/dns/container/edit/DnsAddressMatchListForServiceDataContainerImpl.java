...
public class DnsAddressMatchListForServiceDataContainerImpl extends BaseDataContainer implements
    ...
    public DnsAddressMatchListForServiceDataContainerImpl(AbstractBaseCimAdapter adapter)
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "DnsAddressMatchListForServiceDataContainer.caption"));
        }
