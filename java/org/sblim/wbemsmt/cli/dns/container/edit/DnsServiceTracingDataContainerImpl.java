...
public class DnsServiceTracingDataContainerImpl extends BaseDataContainer implements
        org.sblim.wbemsmt.dns.bl.container.edit.DnsServiceTracingDataContainer {
    ...
    public DnsServiceTracingDataContainerImpl(AbstractBaseCimAdapter adapter)
            throws WbemsmtException {
        super();
        setAdapter(adapter);
        icAllowNotifyAcl = new org.sblim.wbemsmt.cli.dns.container.edit.DnsAllowNotifyForServiceDataContainerImpl(
                adapter);
        icAllowQueryAcl = new org.sblim.wbemsmt.cli.dns.container.edit.DnsAllowQueryForServiceDataContainerImpl(
                adapter);
        icAllowTransferAcl = new org.sblim.wbemsmt.cli.dns.container.edit.DnsAllowTransferForServiceDataContainerImpl(
                adapter);
        icAllowRecursionAcl = new org.sblim.wbemsmt.cli.dns.container.edit.DnsAllowRecursionForServiceDataContainerImpl(
                adapter);
        icBlackholeAcl = new org.sblim.wbemsmt.cli.dns.container.edit.DnsBlackholeForServiceDataContainerImpl(
                adapter);
        icConfiguration = new org.sblim.wbemsmt.cli.dns.container.edit.DnsConfigurationDataContainerImpl(
                adapter);
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "DnsServiceTracingDataContainer.caption"));
        }
