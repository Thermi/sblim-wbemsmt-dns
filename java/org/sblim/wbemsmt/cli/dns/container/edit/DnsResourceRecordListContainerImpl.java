...
public class DnsResourceRecordListContainerImpl extends BaseDataContainer implements
        org.sblim.wbemsmt.dns.bl.container.edit.DnsResourceRecordListContainer,
    ...
    public DnsResourceRecordListContainerImpl(AbstractBaseCimAdapter adapter)
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getResourceRecordsHeader_usr_DeleteRecord() {
        if (icResourceRecordsHeader_usr_DeleteRecord == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.BooleanStringConverter();
            icResourceRecordsHeader_usr_DeleteRecord = new org.sblim.wbemsmt.tools.input.test.LabeledTestInputComponent(
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "DnsResourceRecordListContainer.caption"));
        }
        ...
        if (showInstance(listOptions)) {
            if (get_usr_SelectAll().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_SelectAll())
                        .getValue();
    ...
    public void traceChilds(java.io.PrintWriter printStream, String listOptions, boolean title) {
        ...
        printStream.println();
        printStream.println(getAdapter().getBundle().getString(
                "DnsResourceRecordListContainer.role.resourceRecords")
                + " "
