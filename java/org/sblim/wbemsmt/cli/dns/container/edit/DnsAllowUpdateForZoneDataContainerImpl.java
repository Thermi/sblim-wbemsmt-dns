...
public class DnsAllowUpdateForZoneDataContainerImpl extends BaseDataContainer implements
    ...
    public DnsAllowUpdateForZoneDataContainerImpl(AbstractBaseCimAdapter adapter)
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "DnsAllowUpdateForZoneDataContainer.caption"));
        }
