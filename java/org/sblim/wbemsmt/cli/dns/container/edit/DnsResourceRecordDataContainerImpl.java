...
public class DnsResourceRecordDataContainerImpl extends BaseDataContainer implements
    ...
    public DnsResourceRecordDataContainerImpl(AbstractBaseCimAdapter adapter)
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "DnsResourceRecordDataContainer.caption"));
        }
        ...
        if (showInstance(listOptions)) {
            ...
            if (get_Priority().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_Priority())
                        .getValue();
