...
public class DnsAllowRecursionForServiceDataContainerImpl extends BaseDataContainer implements org.sblim.wbemsmt.dns.bl.container.edit.DnsAllowRecursionForServiceDataContainer {
	...
	public DnsAllowRecursionForServiceDataContainerImpl(AbstractBaseCimAdapter adapter) throws InitContainerException {
		super();
		setAdapter(adapter);
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_AddressList() {
    		...
    		{
				String label = getAdapter().getBundle().getString("DnsAllowRecursionForServiceDataContainer.AddressList");
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_RemoveAddress() {
    		...
    		{
				String label = getAdapter().getBundle().getString("DnsAllowRecursionForServiceDataContainer.removeAddress");
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_UserAddresses() {
    		...
    		{
				String label = getAdapter().getBundle().getString("DnsAllowRecursionForServiceDataContainer.userAddresses");
				org.sblim.wbemsmt.tools.converter.StringArrayConverter converter = new org.sblim.wbemsmt.tools.converter.multiplevalue.UnsignedInt16StringArrayConverter();
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_NewAddress() {
    		...
    		{
				String label = getAdapter().getBundle().getString("DnsAllowRecursionForServiceDataContainer.newAddress");
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_AddPredefinedAddress() {
    		...
    		{
				String label = getAdapter().getBundle().getString("DnsAllowRecursionForServiceDataContainer.addPredefinedAddress");
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_AddNewAddress() {
    		...
    		{
				String label = getAdapter().getBundle().getString("DnsAllowRecursionForServiceDataContainer.addNewAddress");
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_AddressUp() {
    		...
    		{
				String label = getAdapter().getBundle().getString("DnsAllowRecursionForServiceDataContainer.addressUp");
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_AddressDown() {
    		...
    		{
				String label = getAdapter().getBundle().getString("DnsAllowRecursionForServiceDataContainer.addressDown");
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
	...
	public void trace(java.io.PrintWriter 	printStream, String listOptions, boolean title)
	{
		if (title)
		{
			printStream.println(getAdapter().getBundle().getString("DnsAllowRecursionForServiceDataContainer.caption"));
		}
