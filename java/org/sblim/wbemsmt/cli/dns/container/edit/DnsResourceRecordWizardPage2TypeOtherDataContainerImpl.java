...
public class DnsResourceRecordWizardPage2TypeOtherDataContainerImpl extends BaseDataContainer
        implements
    ...
    public DnsResourceRecordWizardPage2TypeOtherDataContainerImpl(AbstractBaseCimAdapter adapter)
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "DnsResourceRecordWizardPage2TypeOtherDataContainer.caption"));
        }
