...
public class DnsResourceRecordWizardPage1DataContainerImpl extends BaseDataContainer implements
    ...
    public DnsResourceRecordWizardPage1DataContainerImpl(AbstractBaseCimAdapter adapter)
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_Type() {
        if (ic_usr_Type == null) {
            String label = getAdapter().getBundle().getString(
                    "DnsResourceRecordWizardPage1DataContainer.Type");
            org.sblim.wbemsmt.tools.converter.StringArrayConverter converter = new org.sblim.wbemsmt.tools.converter.UnsignedInt16StringArrayConverter();
            ic_usr_Type = new org.sblim.wbemsmt.tools.input.test.LabeledTestStringArrayComponent(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Name() {
        if (ic_usr_Name == null) {
            String label = getAdapter().getBundle().getString(
                    "DnsResourceRecordWizardPage1DataContainer.Name");
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "DnsResourceRecordWizardPage1DataContainer.caption"));
        }
