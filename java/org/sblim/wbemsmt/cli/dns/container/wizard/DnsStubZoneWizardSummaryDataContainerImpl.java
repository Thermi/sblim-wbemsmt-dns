...
public class DnsStubZoneWizardSummaryDataContainerImpl extends BaseDataContainer implements
        org.sblim.wbemsmt.dns.bl.container.wizard.DnsStubZoneWizardSummaryDataContainer {
    private org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf ic_usr_Name;
    private org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf ic_usr_IpAdressses;

    public DnsStubZoneWizardSummaryDataContainerImpl(AbstractBaseCimAdapter adapter)
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Name() {
        if (ic_usr_Name == null) {
            String label = getAdapter().getBundle().getString(
                    "DnsStubZoneWizardSummaryDataContainer.Name");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_IpAdressses() {
        if (ic_usr_IpAdressses == null) {
            String label = getAdapter().getBundle().getString(
                    "DnsStubZoneWizardSummaryDataContainer.IpAdressses");
            org.sblim.wbemsmt.tools.converter.StringArrayConverter converter = new org.sblim.wbemsmt.tools.converter.UnsignedInt16StringArrayConverter();
            ic_usr_IpAdressses = new org.sblim.wbemsmt.tools.input.test.LabeledTestStringArrayComponent(
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "DnsStubZoneWizardSummaryDataContainer.caption"));
        }
        ...
        if (showInstance(listOptions)) {
            ...
            if (get_usr_IpAdressses().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_IpAdressses())
                        .getValue();
