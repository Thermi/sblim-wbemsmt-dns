...
public class DnsStubZoneWizardSummaryDataContainerImpl extends BaseDataContainer implements org.sblim.wbemsmt.dns.bl.container.wizard.DnsStubZoneWizardSummaryDataContainer
	...
	public DnsStubZoneWizardSummaryDataContainerImpl(AbstractBaseCimAdapter adapter) throws  WbemsmtException {
		super();
		setAdapter(adapter);
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Name() {
    		if (ic_usr_Name == null)
    		{
				String label = getAdapter().getBundle().getString("DnsStubZoneWizardSummaryDataContainer.Name");
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_IpAdressses() {
    		...
    		{
				String label = getAdapter().getBundle().getString("DnsStubZoneWizardSummaryDataContainer.IpAdressses");
	...
	public void trace(java.io.PrintWriter 	printStream, String listOptions, boolean title)
	{
		if (title)
		{
			printStream.println(getAdapter().getBundle().getString("DnsStubZoneWizardSummaryDataContainer.caption"));
		}
