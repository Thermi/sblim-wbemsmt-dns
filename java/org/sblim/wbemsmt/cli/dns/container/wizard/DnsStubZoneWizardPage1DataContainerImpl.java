...
public class DnsStubZoneWizardPage1DataContainerImpl extends BaseDataContainer implements
    ...
    public DnsStubZoneWizardPage1DataContainerImpl(AbstractBaseCimAdapter adapter)
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "DnsStubZoneWizardPage1DataContainer.caption"));
        }
