...
public class DnsMasterZoneWizardSummaryDataContainerImpl extends BaseDataContainer implements
        org.sblim.wbemsmt.dns.bl.container.wizard.DnsMasterZoneWizardSummaryDataContainer {
    ...
    public DnsMasterZoneWizardSummaryDataContainerImpl(AbstractBaseCimAdapter adapter)
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Name() {
        if (ic_usr_Name == null) {
            String label = getAdapter().getBundle().getString(
                    "DnsMasterZoneWizardSummaryDataContainer.Name");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Server() {
        if (ic_usr_Server == null) {
            String label = getAdapter().getBundle().getString(
                    "DnsMasterZoneWizardSummaryDataContainer.Server");
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_IpAdress() {
        if (ic_usr_IpAdress == null) {
            String label = getAdapter().getBundle().getString(
                    "DnsMasterZoneWizardSummaryDataContainer.IpAdress");
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Contact() {
        if (ic_usr_Contact == null) {
            String label = getAdapter().getBundle().getString(
                    "DnsMasterZoneWizardSummaryDataContainer.Contact");
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "DnsMasterZoneWizardSummaryDataContainer.caption"));
        }
        ...
        if (showInstance(listOptions)) {
            ...
            if (get_usr_Server().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_Server())
                        .getValue();
                printStream.println(get_usr_Server().getLabelText() + ": " + value);
            }
            if (get_usr_IpAdress().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_IpAdress())
                        .getValue();
                printStream.println(get_usr_IpAdress().getLabelText() + ": " + value);
            }
            if (get_usr_Contact().isVisible()) {
                Object value = ((org.sblim.wbemsmt.tools.input.test.TestInputComponentIf) get_usr_Contact())
                        .getValue();
