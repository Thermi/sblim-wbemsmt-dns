...
public class DnsMasterZoneWizardPage1DataContainerImpl extends BaseDataContainer implements
    ...
    public DnsMasterZoneWizardPage1DataContainerImpl(AbstractBaseCimAdapter adapter)
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "DnsMasterZoneWizardPage1DataContainer.caption"));
        }
