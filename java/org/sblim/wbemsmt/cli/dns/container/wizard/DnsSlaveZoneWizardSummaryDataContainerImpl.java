...
public class DnsSlaveZoneWizardSummaryDataContainerImpl extends BaseDataContainer implements
    ...
    public DnsSlaveZoneWizardSummaryDataContainerImpl(AbstractBaseCimAdapter adapter)
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Name() {
        if (ic_usr_Name == null) {
            String label = getAdapter().getBundle().getString(
                    "DnsSlaveZoneWizardSummaryDataContainer.Name");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_IpAdressses() {
        if (ic_usr_IpAdressses == null) {
            String label = getAdapter().getBundle().getString(
                    "DnsSlaveZoneWizardSummaryDataContainer.IpAdressses");
    ...
    public void trace(java.io.PrintWriter printStream, String listOptions, boolean title) {
        if (title) {
            printStream.println(getAdapter().getBundle().getString(
                    "DnsSlaveZoneWizardSummaryDataContainer.caption"));
        }
