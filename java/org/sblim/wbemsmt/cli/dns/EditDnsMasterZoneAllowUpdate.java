...
public class EditDnsMasterZoneAllowUpdate extends CimCommand {
	...
	//All Options that are local and defined for this command
		 ...
		 * 
		 */
		public static final OptionDefinition KEY_zoneName = new OptionDefinition(null,"zoneName","noDefaultValue","EditDnsMasterZoneAllowUpdate.zoneName.argValue",true,false,"EditDnsMasterZoneAllowUpdate.zoneName.argDescription");
			/**
		 * 
		 */
