/**
 * EditDnsServiceAllowTransfer.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class EditDnsServiceAllowTransfer extends CimCommand {
                            ...
                            "\n"
                                    + bundle
                                            .getString(
                                                    "editing",
                                                    new Object[] { bundle
                                                            .getString("DnsAllowTransferForServiceDataContainer.caption") }));

            CliDataLoader loader = new EditDnsServiceAllowTransferLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.cli.dns.container.edit.DnsAllowTransferForServiceDataContainerImpl dc = new org.sblim.wbemsmt.cli.dns.container.edit.DnsAllowTransferForServiceDataContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dns.bl.container.edit.DnsAllowTransferForServiceDataContainer dc)
