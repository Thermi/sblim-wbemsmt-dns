/**
 * ListDnsResourceRecord.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class ListDnsResourceRecord extends CimCommand {
    ...
    public static final OptionDefinition KEY_zoneName = new OptionDefinition(null, "zoneName",
            null, "ListDnsResourceRecord.zoneName.argValue", true, false,
            "ListDnsResourceRecord.zoneName.argDescription");
    /**
    ...
    public static final OptionDefinition KEY_recordNameToSelect = new OptionDefinition(null,
            "recordNameToSelect", null, "ListDnsResourceRecord.recordNameToSelect.argValue", true,
            false, "ListDnsResourceRecord.recordNameToSelect.argDescription");
    /**
    ...
    public static final OptionDefinition KEY_recordTypeToSelect = new OptionDefinition(null,
            "recordTypeToSelect", null, "ListDnsResourceRecord.recordTypeToSelect.argValue", true,
            false, "ListDnsResourceRecord.recordTypeToSelect.argDescription");
    /**
    ...
    public static final OptionDefinition KEY_recordValueToSelect = new OptionDefinition(null,
            "recordValueToSelect", null, "ListDnsResourceRecord.recordValueToSelect.argValue",
            true, false, "ListDnsResourceRecord.recordValueToSelect.argDescription");
    /**
    ...
    public static final OptionDefinition KEY_mxPriorityToSelect = new OptionDefinition(null,
            "mxPriorityToSelect", null, "ListDnsResourceRecord.mxPriorityToSelect.argValue", true,
            false, "ListDnsResourceRecord.mxPriorityToSelect.argDescription");
    /**
    ...
    public static final OptionDefinition KEY_list = new OptionDefinition(null, "list",
            "INSTANCE_WITH_CHILDS", "ListDnsResourceRecord.list.argValue", false, false,
            "ListDnsResourceRecord.list.argDescription");
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] { KEY_zoneName,
            ...
            KEY_mxPriorityToSelect, KEY_list, };
