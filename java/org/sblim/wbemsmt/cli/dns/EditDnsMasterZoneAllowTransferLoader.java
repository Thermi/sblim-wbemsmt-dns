...
/** 
  * EditDnsMasterZoneAllowTransferLoader.java
  *
...
public class EditDnsMasterZoneAllowTransferLoader extends DnsDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
			...
			throws WbemsmtException {
				...
				String name = CliUtil.getOption(commandValues,EditDnsMasterZoneAllowTransfer.KEY_zoneName);
