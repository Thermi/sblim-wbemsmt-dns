...
public class EditDnsServiceAllowQuery extends CimCommand {
		 ...
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_hostname = new OptionDefinition("hostname",null,"EditDnsServiceAllowQuery.hostname.argValue",true,false,"EditDnsServiceAllowQuery.hostname.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_port = new OptionDefinition("port","5988","EditDnsServiceAllowQuery.port.argValue",false,false,"EditDnsServiceAllowQuery.port.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_namespace = new OptionDefinition("namespace","/root/cimv2","EditDnsServiceAllowQuery.namespace.argValue",false,false,"EditDnsServiceAllowQuery.namespace.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_user = new OptionDefinition("user",null,"EditDnsServiceAllowQuery.user.argValue",true,false,"EditDnsServiceAllowQuery.user.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_password = new OptionDefinition("password",null,"EditDnsServiceAllowQuery.password.argValue",true,false,"EditDnsServiceAllowQuery.password.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_publickeyfile = new OptionDefinition("publickeyfile","none","EditDnsServiceAllowQuery.publickeyfile.argValue",false,false,"EditDnsServiceAllowQuery.publickeyfile.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_privatekeyfile = new OptionDefinition("privatekeyfile","none","EditDnsServiceAllowQuery.privatekeyfile.argValue",false,false,"EditDnsServiceAllowQuery.privatekeyfile.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_dnsServiceName = new OptionDefinition("dnsServiceName",null,"EditDnsServiceAllowQuery.dnsServiceName.argValue",true,false,"EditDnsServiceAllowQuery.dnsServiceName.argDescription");
...
public static final OptionDefinition KEY_locale = new OptionDefinition("locale","en","locale",false,false,"locale");	
 ...
 CommandLine cmd = null;
	...
	public void execute(String[] args) throws WbemSmtException {
		...
		System.out.println("\n" + bundle.getString("editing",new Object[]{bundle.getString("DnsAllowQueryForServiceDataContainer.caption")}));
		try {
			...
			org.sblim.wbemsmt.cli.dns.container.edit.DnsAllowQueryForServiceDataContainerImpl dc = new org.sblim.wbemsmt.cli.dns.container.edit.DnsAllowQueryForServiceDataContainerImpl(adapter);
			...
			System.out.println("\n" + bundle.getString("edited", new Object[]{bundle.getString("DnsAllowQueryForServiceDataContainer.caption")}));
	 ...
	 **/
	private void setKeyValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dns.bl.container.edit.DnsAllowQueryForServiceDataContainer dc) throws WbemSmtException {
    	    				    				    				    				    				    				    				    					}	
	
	/**
	 * Set all Values that are not read-Only
	 **/
	private void setValues(CommandLine cmd,AbstractBaseCimAdapter adapter, org.sblim.wbemsmt.dns.bl.container.edit.DnsAllowQueryForServiceDataContainer dc) throws WbemSmtException {
