/**
 * ListDnsZone.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS OF THE
...
public class ListDnsZone extends CimCommand {
    ...
    public static final OptionDefinition KEY_list = new OptionDefinition(null, "list",
            "INSTANCE_WITH_CHILDS", "ListDnsZone.list.argValue", false, false,
            "ListDnsZone.list.argDescription");
    /**
     * used for selection:  --zoneName
     */
    public static final OptionDefinition KEY_zoneName = new OptionDefinition(null, "zoneName",
            null, "DnsZoneTracingContainer.Name.argValue", false, true,
            "DnsZoneTracingContainer.Name.argDescription");
    ...
    public void execute(CimCommandValues values) throws WbemsmtException {
        ...
        try {
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("listing", new Object[] { bundle
                                    .getString("DnsZoneTracingContainer.caption") }));

            CliDataLoader loader = new ListDnsZoneLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.cli.dns.container.edit.DnsZoneTracingContainerImpl dc = new org.sblim.wbemsmt.cli.dns.container.edit.DnsZoneTracingContainerImpl(
                    adapter);
            ...
            for (int i = 0; i < count; i++) {
                org.sblim.wbemsmt.cli.dns.container.edit.DnsResourceRecordDataContainerImpl child = new org.sblim.wbemsmt.cli.dns.container.edit.DnsResourceRecordDataContainerImpl(
                        adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dns.bl.container.edit.DnsZoneTracingContainer dc)
