...
public class EditDnsReverseZone extends CimCommand {
		 ...
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_hostname = new OptionDefinition("hostname",null,"EditDnsReverseZone.hostname.argValue",true,false,"EditDnsReverseZone.hostname.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_port = new OptionDefinition("port","5988","EditDnsReverseZone.port.argValue",false,false,"EditDnsReverseZone.port.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_namespace = new OptionDefinition("namespace","/root/cimv2","EditDnsReverseZone.namespace.argValue",false,false,"EditDnsReverseZone.namespace.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_user = new OptionDefinition("user",null,"EditDnsReverseZone.user.argValue",true,false,"EditDnsReverseZone.user.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_password = new OptionDefinition("password",null,"EditDnsReverseZone.password.argValue",true,false,"EditDnsReverseZone.password.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_publickeyfile = new OptionDefinition("publickeyfile","none","EditDnsReverseZone.publickeyfile.argValue",false,false,"EditDnsReverseZone.publickeyfile.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_privatekeyfile = new OptionDefinition("privatekeyfile","none","EditDnsReverseZone.privatekeyfile.argValue",false,false,"EditDnsReverseZone.privatekeyfile.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_dnsServiceName = new OptionDefinition("dnsServiceName",null,"EditDnsReverseZone.dnsServiceName.argValue",true,false,"EditDnsReverseZone.dnsServiceName.argDescription");
	
			/**
		 * 
		 */
		public static final OptionDefinition KEY_zoneFile = new OptionDefinition("zoneFile",null,"DnsReverseZoneDataContainer.ZoneFile.argValue",false,false,"DnsReverseZoneDataContainer.ZoneFile.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_useGlobalForwarders = new OptionDefinition("useGlobalForwarders",null,null,false,false,"DnsReverseZoneDataContainer.useGlobalForwarders.argDescription");
			/**
		 * 
		 */
