  ...
  * Contributors: 
  * 
  * Description: Loader for creating a StubZone
  * 
  */
...
public class CreateDnsStubZoneLoader extends DnsDataLoader {
	...
	public void loadTracingObject(WbemSmtResourceBundle bundle, AbstractBaseCimAdapter adapter, DnsStubZoneWizardSummaryDataContainer container) throws ObjectNotFoundException {

		String name = (String) container.get_usr_Name().getConvertedControlValue();
		selectStubZone(bundle, adapter, name);
