...
public class ListDnsServiceStatus extends CimCommand {
	...
	//All Options that are local and defined for this command
		 ...
		 */
		public static final OptionDefinition KEY_list = new OptionDefinition(null,"list","INSTANCE_WITH_CHILDS","ListDnsServiceStatus.list.argValue",false,false,"ListDnsServiceStatus.list.argDescription");
