/**
 * ListDnsServiceStatus.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS
...
public class ListDnsServiceStatus extends CimCommand {
    ...
    public static final OptionDefinition KEY_list = new OptionDefinition(null, "list",
            "INSTANCE_WITH_CHILDS", "ListDnsServiceStatus.list.argValue", false, false,
            "ListDnsServiceStatus.list.argDescription");
