...
/** 
  ...
  * Contributors: 
  * 
  * Description: Loader for editing a ReverseZone
  * 
  */
...
public class EditDnsReverseZoneLoader extends DnsDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		this.commandValues = commandValues;
				String name = CliUtil.getOption(commandValues,EditDnsReverseZone.KEY_zoneName);
