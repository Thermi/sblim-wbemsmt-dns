...
/** 
  * EditDnsStubZoneAllowQueryLoader.java
  *
  ...
  * Contributors: 
  * 
  * Description: Loader for editing a zone's AllowQuery ACL
  * 
  */
...
public class EditDnsStubZoneAllowQueryLoader extends DnsDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		this.commandValues = commandValues;
				String name = CliUtil.getOption(commandValues,EditDnsStubZoneAllowQuery.KEY_zoneName);
