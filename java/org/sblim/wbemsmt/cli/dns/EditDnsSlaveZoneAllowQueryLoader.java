...
/** 
  * EditDnsSlaveZoneAllowQueryLoader.java
  *
...
public class EditDnsSlaveZoneAllowQueryLoader extends DnsDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		this.commandValues = commandValues;
				String name = CliUtil.getOption(commandValues,EditDnsSlaveZoneAllowQuery.KEY_zoneName);
