...
/** 
  * EditDnsStubZoneAllowUpdateLoader.java
  *
  ...
  * Contributors: 
  * 
  * Description: Loader for editing a zone's AllowUpdate ACL
  * 
  */
...
public class EditDnsStubZoneAllowUpdateLoader extends DnsDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		this.commandValues = commandValues;
				String name = CliUtil.getOption(commandValues,EditDnsStubZoneAllowUpdate.KEY_zoneName);
