...
/** 
  * DeleteDnsReverseZoneLoader.java
  *
  ...
  * Contributors: 
  * 
  * Description: Loader for deleting a ReverseZone
  * 
  */
...
public class DeleteDnsReverseZoneLoader extends DnsDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		this.commandValues = commandValues;
				String name = CliUtil.getOption(commandValues,DeleteDnsReverseZone.KEY_zoneName);
