/** 
  * EditDnsReverseZoneAllowQuery.java
  *
...
public class EditDnsReverseZoneAllowQuery extends CimCommand {

			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_hostname = new OptionDefinition("hostname",null,"EditDnsReverseZoneAllowQuery.hostname.argValue",true,false,"EditDnsReverseZoneAllowQuery.hostname.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_port = new OptionDefinition("port","5988","EditDnsReverseZoneAllowQuery.port.argValue",false,false,"EditDnsReverseZoneAllowQuery.port.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_namespace = new OptionDefinition("namespace","/root/cimv2","EditDnsReverseZoneAllowQuery.namespace.argValue",false,false,"EditDnsReverseZoneAllowQuery.namespace.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_user = new OptionDefinition("user",null,"EditDnsReverseZoneAllowQuery.user.argValue",true,false,"EditDnsReverseZoneAllowQuery.user.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_password = new OptionDefinition("password",null,"EditDnsReverseZoneAllowQuery.password.argValue",true,false,"EditDnsReverseZoneAllowQuery.password.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_publickeyfile = new OptionDefinition("publickeyfile","none","EditDnsReverseZoneAllowQuery.publickeyfile.argValue",false,false,"EditDnsReverseZoneAllowQuery.publickeyfile.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_privatekeyfile = new OptionDefinition("privatekeyfile","none","EditDnsReverseZoneAllowQuery.privatekeyfile.argValue",false,false,"EditDnsReverseZoneAllowQuery.privatekeyfile.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_dnsServiceName = new OptionDefinition("dnsServiceName",null,"EditDnsReverseZoneAllowQuery.dnsServiceName.argValue",true,false,"EditDnsReverseZoneAllowQuery.dnsServiceName.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_zoneName = new OptionDefinition("zoneName",null,"EditDnsReverseZoneAllowQuery.zoneName.argValue",true,false,"EditDnsReverseZoneAllowQuery.zoneName.argDescription");
...
public static final OptionDefinition KEY_locale = new OptionDefinition("locale","en","locale",false,false,"locale");	
 ...
 CommandLine cmd = null;
	...
	public EditDnsReverseZoneAllowQuery(java.util.Locale locale)
	{
		super("EditDnsReverseZoneAllowQuery", new String[]{"messages","messagesDns"},locale);
	}
	...
	public void execute(String[] args) throws WbemSmtException {
		...
		try {
			...
			CliDataLoader loader = new EditDnsReverseZoneAllowQueryLoader();
