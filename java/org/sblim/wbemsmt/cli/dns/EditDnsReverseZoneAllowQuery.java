...
public class EditDnsReverseZoneAllowQuery extends CimCommand {
	...
	//All Options that are local and defined for this command
		 ...
		 * 
		 */
		public static final OptionDefinition KEY_zoneName = new OptionDefinition(null,"zoneName","noDefaultValue","EditDnsReverseZoneAllowQuery.zoneName.argValue",true,false,"EditDnsReverseZoneAllowQuery.zoneName.argDescription");
			/**
		 * 
		 */
