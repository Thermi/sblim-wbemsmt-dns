/**
 * EditDnsReverseZoneAllowQuery.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class EditDnsReverseZoneAllowQuery extends CimCommand {
    ...
    public static final OptionDefinition KEY_zoneName = new OptionDefinition(null, "zoneName",
            null, "EditDnsReverseZoneAllowQuery.zoneName.argValue", true, false,
            "EditDnsReverseZoneAllowQuery.zoneName.argDescription");
    /**
    ...
    public static final OptionDefinition KEY_useGlobalAddressMatchList = new OptionDefinition(null,
            ...
            "DnsAllowQueryForZoneDataContainer.useGlobalAddressMatchList.argDescription");
    /**
     *  --addressList
     */
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DnsAllowQueryForZoneDataContainer.caption") }));

            CliDataLoader loader = new EditDnsReverseZoneAllowQueryLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.cli.dns.container.edit.DnsAllowQueryForZoneDataContainerImpl dc = new org.sblim.wbemsmt.cli.dns.container.edit.DnsAllowQueryForZoneDataContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dns.bl.container.edit.DnsAllowQueryForZoneDataContainer dc)
