/** 
  * EditDnsStubZoneAllowQuery.java
  *
...
public class EditDnsStubZoneAllowQuery extends CimCommand {

			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_hostname = new OptionDefinition("hostname",null,"EditDnsStubZoneAllowQuery.hostname.argValue",true,false,"EditDnsStubZoneAllowQuery.hostname.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_port = new OptionDefinition("port","5988","EditDnsStubZoneAllowQuery.port.argValue",false,false,"EditDnsStubZoneAllowQuery.port.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_namespace = new OptionDefinition("namespace","/root/cimv2","EditDnsStubZoneAllowQuery.namespace.argValue",false,false,"EditDnsStubZoneAllowQuery.namespace.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_user = new OptionDefinition("user",null,"EditDnsStubZoneAllowQuery.user.argValue",true,false,"EditDnsStubZoneAllowQuery.user.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_password = new OptionDefinition("password",null,"EditDnsStubZoneAllowQuery.password.argValue",true,false,"EditDnsStubZoneAllowQuery.password.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_publickeyfile = new OptionDefinition("publickeyfile","none","EditDnsStubZoneAllowQuery.publickeyfile.argValue",false,false,"EditDnsStubZoneAllowQuery.publickeyfile.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_privatekeyfile = new OptionDefinition("privatekeyfile","none","EditDnsStubZoneAllowQuery.privatekeyfile.argValue",false,false,"EditDnsStubZoneAllowQuery.privatekeyfile.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_dnsServiceName = new OptionDefinition("dnsServiceName",null,"EditDnsStubZoneAllowQuery.dnsServiceName.argValue",true,false,"EditDnsStubZoneAllowQuery.dnsServiceName.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_zoneName = new OptionDefinition("zoneName",null,"EditDnsStubZoneAllowQuery.zoneName.argValue",true,false,"EditDnsStubZoneAllowQuery.zoneName.argDescription");
...
public static final OptionDefinition KEY_locale = new OptionDefinition("locale","en","locale",false,false,"locale");	
 ...
 CommandLine cmd = null;
	...
	public EditDnsStubZoneAllowQuery(java.util.Locale locale)
	{
		super("EditDnsStubZoneAllowQuery", new String[]{"messages","messagesDns"},locale);
	}
	...
	public void execute(String[] args) throws WbemSmtException {
		...
		try {
			...
			CliDataLoader loader = new EditDnsStubZoneAllowQueryLoader();
