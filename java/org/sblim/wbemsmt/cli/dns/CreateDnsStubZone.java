...
public class CreateDnsStubZone extends CimCommand implements ContainerUpdater {
	...
	//All Options that are local and defined for this command
   		 ...
   		 * required,  --zoneName
		 */
		public static final OptionDefinition KEY_zoneName = new OptionDefinition(null,"zoneName",null,"DnsStubZoneWizardPage1DataContainer.Name.argValue",true,false,"DnsStubZoneWizardPage1DataContainer.Name.argDescription");
			/**
   		 *  --masters
		 */
