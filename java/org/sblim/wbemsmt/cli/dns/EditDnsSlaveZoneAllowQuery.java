...
public class EditDnsSlaveZoneAllowQuery extends CimCommand {
	...
	//All Options that are local and defined for this command
		 ...
		 */
		public static final OptionDefinition KEY_zoneName = new OptionDefinition(null,"zoneName",null,"EditDnsSlaveZoneAllowQuery.zoneName.argValue",true,false,"EditDnsSlaveZoneAllowQuery.zoneName.argDescription");
			/**
