/** 
  * EditDnsSlaveZoneAllowQuery.java
  *
...
public class EditDnsSlaveZoneAllowQuery extends CimCommand {

			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_hostname = new OptionDefinition("hostname",null,"EditDnsSlaveZoneAllowQuery.hostname.argValue",true,false,"EditDnsSlaveZoneAllowQuery.hostname.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_port = new OptionDefinition("port","5988","EditDnsSlaveZoneAllowQuery.port.argValue",false,false,"EditDnsSlaveZoneAllowQuery.port.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_namespace = new OptionDefinition("namespace","/root/cimv2","EditDnsSlaveZoneAllowQuery.namespace.argValue",false,false,"EditDnsSlaveZoneAllowQuery.namespace.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_user = new OptionDefinition("user",null,"EditDnsSlaveZoneAllowQuery.user.argValue",true,false,"EditDnsSlaveZoneAllowQuery.user.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_password = new OptionDefinition("password",null,"EditDnsSlaveZoneAllowQuery.password.argValue",true,false,"EditDnsSlaveZoneAllowQuery.password.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_publickeyfile = new OptionDefinition("publickeyfile","none","EditDnsSlaveZoneAllowQuery.publickeyfile.argValue",false,false,"EditDnsSlaveZoneAllowQuery.publickeyfile.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_privatekeyfile = new OptionDefinition("privatekeyfile","none","EditDnsSlaveZoneAllowQuery.privatekeyfile.argValue",false,false,"EditDnsSlaveZoneAllowQuery.privatekeyfile.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_dnsServiceName = new OptionDefinition("dnsServiceName",null,"EditDnsSlaveZoneAllowQuery.dnsServiceName.argValue",true,false,"EditDnsSlaveZoneAllowQuery.dnsServiceName.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_zoneName = new OptionDefinition("zoneName",null,"EditDnsSlaveZoneAllowQuery.zoneName.argValue",true,false,"EditDnsSlaveZoneAllowQuery.zoneName.argDescription");
...
public static final OptionDefinition KEY_locale = new OptionDefinition("locale","en","locale",false,false,"locale");	
 ...
 CommandLine cmd = null;
	...
	public EditDnsSlaveZoneAllowQuery(java.util.Locale locale)
	{
		super("EditDnsSlaveZoneAllowQuery", new String[]{"messages","messagesDns"},locale);
	}
	...
	public void execute(String[] args) throws WbemSmtException {
		...
		try {
			...
			CliDataLoader loader = new EditDnsSlaveZoneAllowQueryLoader();
