...
/** 
  * EditDnsReverseZoneAllowUpdateLoader.java
  *
...
public class EditDnsReverseZoneAllowUpdateLoader extends DnsDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		this.commandValues = commandValues;
				String name = CliUtil.getOption(commandValues,EditDnsReverseZoneAllowUpdate.KEY_zoneName);
