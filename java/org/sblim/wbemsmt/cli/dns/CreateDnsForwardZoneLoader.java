 /** 
  * CreateDnsForwardZoneLoader.java
  *
  ...
  * Contributors: 
  * 
  * Description: Loader for creating a ForwardZone
  * 
  */
...
public class CreateDnsForwardZoneLoader extends DnsDataLoader {
	...
	public void loadTracingObject(WbemSmtResourceBundle bundle, AbstractBaseCimAdapter adapter, DnsForwardZoneWizardSummaryDataContainer container) throws ObjectNotFoundException {

		String name = (String) container.get_usr_Name().getConvertedControlValue();
		selectForwardZone(bundle, adapter, name);
