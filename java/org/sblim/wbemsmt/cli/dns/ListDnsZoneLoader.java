...
/** 
  ...
  * Contributors: 
  * 
  * Description: Loader for listing a MasterZone
  * 
  */
...
public class ListDnsZoneLoader extends DnsDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		this.commandValues = commandValues;
				String name = CliUtil.getOption(commandValues,ListDnsZone.KEY_zoneName);
				selectZone(bundle, adapter, name, false);
	}
}
