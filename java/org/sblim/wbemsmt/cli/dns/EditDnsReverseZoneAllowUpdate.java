/**
 * EditDnsReverseZoneAllowUpdate.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class EditDnsReverseZoneAllowUpdate extends CimCommand {
    ...
    public static final OptionDefinition KEY_zoneName = new OptionDefinition(null, "zoneName",
            null, "EditDnsReverseZoneAllowUpdate.zoneName.argValue", true, false,
            "EditDnsReverseZoneAllowUpdate.zoneName.argDescription");
    /**
     *  --addressList
     */
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DnsAllowUpdateForZoneDataContainer.caption") }));

            CliDataLoader loader = new EditDnsReverseZoneAllowUpdateLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.cli.dns.container.edit.DnsAllowUpdateForZoneDataContainerImpl dc = new org.sblim.wbemsmt.cli.dns.container.edit.DnsAllowUpdateForZoneDataContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dns.bl.container.edit.DnsAllowUpdateForZoneDataContainer dc)
