/**
 * EditDnsServiceConfiguration.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class EditDnsServiceConfiguration extends CimCommand {
    ...
    public static final OptionDefinition KEY_configurationFile = new OptionDefinition(null,
            "configurationFile", null, "DnsConfigurationDataContainer.ConfigurationFile.argValue",
            false, false, "DnsConfigurationDataContainer.ConfigurationFile.argDescription");
    /**
     *  --configurationDirectory
     */
    public static final OptionDefinition KEY_configurationDirectory = new OptionDefinition(null,
            "configurationDirectory", null,
            "DnsConfigurationDataContainer.ConfigurationDirectory.argValue", false, false,
            "DnsConfigurationDataContainer.ConfigurationDirectory.argDescription");
    /**
     *  --portNumber
     */
    public static final OptionDefinition KEY_portNumber = new OptionDefinition(null, "portNumber",
            null, "DnsConfigurationDataContainer.PortNumber.argValue", false, false,
            "DnsConfigurationDataContainer.PortNumber.argDescription");
    /**
     *  --removeDirectory
     */
    public static final OptionDefinition KEY_removeDirectory = new OptionDefinition(null,
            "removeDirectory", null, null, false, false,
            "DnsConfigurationDataContainer.removeDirectory.argDescription");
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] {
            KEY_configurationFile, KEY_configurationDirectory, KEY_portNumber, KEY_removeDirectory, };
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DnsConfigurationDataContainer.caption") }));

            CliDataLoader loader = new EditDnsServiceConfigurationLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.cli.dns.container.edit.DnsConfigurationDataContainerImpl dc = new org.sblim.wbemsmt.cli.dns.container.edit.DnsConfigurationDataContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dns.bl.container.edit.DnsConfigurationDataContainer dc)
    ...
    private void setValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
        ...
        //The Buttons
        if (!pressButton(cmd, adapter, dc, dc.get_usr_RemoveDirectory(), KEY_removeDirectory))
            return;
    }
