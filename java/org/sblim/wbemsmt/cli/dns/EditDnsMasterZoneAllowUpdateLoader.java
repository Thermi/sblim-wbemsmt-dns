...
/** 
  * EditDnsMasterZoneAllowUpdateLoader.java
  *
...
public class EditDnsMasterZoneAllowUpdateLoader extends DnsDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
			...
			throws WbemsmtException {
				...
				String name = CliUtil.getOption(commandValues,EditDnsMasterZoneAllowUpdate.KEY_zoneName);
