...
public class EditDnsServiceAllowNotify extends CimCommand {
		 ...
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_hostname = new OptionDefinition("hostname",null,"EditDnsServiceAllowNotify.hostname.argValue",true,false,"EditDnsServiceAllowNotify.hostname.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_port = new OptionDefinition("port","5988","EditDnsServiceAllowNotify.port.argValue",false,false,"EditDnsServiceAllowNotify.port.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_namespace = new OptionDefinition("namespace","/root/cimv2","EditDnsServiceAllowNotify.namespace.argValue",false,false,"EditDnsServiceAllowNotify.namespace.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_user = new OptionDefinition("user",null,"EditDnsServiceAllowNotify.user.argValue",true,false,"EditDnsServiceAllowNotify.user.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_password = new OptionDefinition("password",null,"EditDnsServiceAllowNotify.password.argValue",true,false,"EditDnsServiceAllowNotify.password.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_publickeyfile = new OptionDefinition("publickeyfile","none","EditDnsServiceAllowNotify.publickeyfile.argValue",false,false,"EditDnsServiceAllowNotify.publickeyfile.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_privatekeyfile = new OptionDefinition("privatekeyfile","none","EditDnsServiceAllowNotify.privatekeyfile.argValue",false,false,"EditDnsServiceAllowNotify.privatekeyfile.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_dnsServiceName = new OptionDefinition("dnsServiceName",null,"EditDnsServiceAllowNotify.dnsServiceName.argValue",true,false,"EditDnsServiceAllowNotify.dnsServiceName.argDescription");
