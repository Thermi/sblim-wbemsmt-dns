/**
 * EditDnsServiceAllowNotify.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class EditDnsServiceAllowNotify extends CimCommand {
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DnsAllowNotifyForServiceDataContainer.caption") }));

            CliDataLoader loader = new EditDnsServiceAllowNotifyLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.cli.dns.container.edit.DnsAllowNotifyForServiceDataContainerImpl dc = new org.sblim.wbemsmt.cli.dns.container.edit.DnsAllowNotifyForServiceDataContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dns.bl.container.edit.DnsAllowNotifyForServiceDataContainer dc)
