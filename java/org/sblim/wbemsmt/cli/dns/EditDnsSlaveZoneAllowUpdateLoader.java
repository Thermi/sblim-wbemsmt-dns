...
/** 
  * EditDnsSlaveZoneAllowUpdateLoader.java
  *
...
public class EditDnsSlaveZoneAllowUpdateLoader extends DnsDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		this.commandValues = commandValues;
				String name = CliUtil.getOption(commandValues,EditDnsSlaveZoneAllowUpdate.KEY_zoneName);
