...
/** 
  * EditDnsStubZoneAllowTransferLoader.java
  *
...
public class EditDnsStubZoneAllowTransferLoader extends DnsDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		this.commandValues = commandValues;
				String name = CliUtil.getOption(commandValues,EditDnsStubZoneAllowTransfer.KEY_zoneName);
