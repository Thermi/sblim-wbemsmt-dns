/**
 * MasterWizard.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS OF THE
...
public class MasterWizard extends CliWizardBase implements IPageWizardAdapter {

    static Logger logger = Logger.getLogger(MasterWizard.class.getName());
    ...
    public MasterWizard(final org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter) {
        ...
        this.container = new org.sblim.wbemsmt.dns.wizard.MasterWizardContainer(adapter,
                new org.sblim.wbemsmt.dns.wizard.MasterWizardContainerPanels() {
                    public DataContainer getPage1() throws WbemsmtException {
                        DataContainer dc = new org.sblim.wbemsmt.cli.dns.container.wizard.DnsMastersWizardPage1DataContainerImpl(
                                adapter);
                        return dc;
                    }

                    public DataContainer getSummary() throws WbemsmtException {
                        DataContainer dc = new org.sblim.wbemsmt.cli.dns.container.wizard.DnsMastersWizardSummaryDataContainerImpl(
                                adapter);
                        return dc;
                    }
                });
