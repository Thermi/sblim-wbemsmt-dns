        ...
        this.container = new org.sblim.wbemsmt.dns.wizard.AddressMatchListWizardContainer(adapter,
                new org.sblim.wbemsmt.dns.wizard.AddressMatchListWizardContainerPanels() {
                    public DataContainer getPage1() throws WbemsmtException {
                        DataContainer dc = new org.sblim.wbemsmt.cli.dns.container.wizard.DnsAddressMatchListWizardPage1DataContainerImpl(
                                adapter);
                        return dc;
                    }

                    public DataContainer getSummary() throws WbemsmtException {
                        DataContainer dc = new org.sblim.wbemsmt.cli.dns.container.wizard.DnsAddressMatchListWizardSummaryDataContainerImpl(
                                adapter);
                        return dc;
                    }
                });
