...
public class CreateForwardZoneWizard extends CliWizardBase implements IPageWizardAdapter {

    static Logger logger = Logger.getLogger(CreateForwardZoneWizard.class.getName());
        ...
        this.container = new org.sblim.wbemsmt.dns.wizard.CreateForwardZoneWizardContainer(adapter,
                new org.sblim.wbemsmt.dns.wizard.CreateForwardZoneWizardContainerPanels() {
                    public DataContainer getMain() throws WbemsmtException {
                        DataContainer dc = new org.sblim.wbemsmt.cli.dns.container.wizard.DnsForwardZoneWizardPage1DataContainerImpl(
                                adapter);
                        return dc;
                    }

                    public DataContainer getOverview() throws WbemsmtException {
                        DataContainer dc = new org.sblim.wbemsmt.cli.dns.container.wizard.DnsForwardZoneWizardSummaryDataContainerImpl(
                                adapter);
                        return dc;
                    }
                });
