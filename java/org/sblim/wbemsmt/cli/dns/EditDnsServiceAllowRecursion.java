/**
 * EditDnsServiceAllowRecursion.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class EditDnsServiceAllowRecursion extends CimCommand {
                            ...
                            "\n"
                                    + bundle
                                            .getString(
                                                    "editing",
                                                    new Object[] { bundle
                                                            .getString("DnsAllowRecursionForServiceDataContainer.caption") }));

            CliDataLoader loader = new EditDnsServiceAllowRecursionLoader();
            loader.load(bundle, adapter, commandValues);

            org.sblim.wbemsmt.cli.dns.container.edit.DnsAllowRecursionForServiceDataContainerImpl dc = new org.sblim.wbemsmt.cli.dns.container.edit.DnsAllowRecursionForServiceDataContainerImpl(
                    adapter);
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dns.bl.container.edit.DnsAllowRecursionForServiceDataContainer dc)
