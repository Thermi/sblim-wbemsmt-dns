/** 
  * EditDnsStubZoneAllowTransfer.java
  *
...
public class EditDnsStubZoneAllowTransfer extends CimCommand {

			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_hostname = new OptionDefinition("hostname",null,"EditDnsStubZoneAllowTransfer.hostname.argValue",true,false,"EditDnsStubZoneAllowTransfer.hostname.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_port = new OptionDefinition("port","5988","EditDnsStubZoneAllowTransfer.port.argValue",false,false,"EditDnsStubZoneAllowTransfer.port.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_namespace = new OptionDefinition("namespace","/root/cimv2","EditDnsStubZoneAllowTransfer.namespace.argValue",false,false,"EditDnsStubZoneAllowTransfer.namespace.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_user = new OptionDefinition("user",null,"EditDnsStubZoneAllowTransfer.user.argValue",true,false,"EditDnsStubZoneAllowTransfer.user.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_password = new OptionDefinition("password",null,"EditDnsStubZoneAllowTransfer.password.argValue",true,false,"EditDnsStubZoneAllowTransfer.password.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_publickeyfile = new OptionDefinition("publickeyfile","none","EditDnsStubZoneAllowTransfer.publickeyfile.argValue",false,false,"EditDnsStubZoneAllowTransfer.publickeyfile.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_privatekeyfile = new OptionDefinition("privatekeyfile","none","EditDnsStubZoneAllowTransfer.privatekeyfile.argValue",false,false,"EditDnsStubZoneAllowTransfer.privatekeyfile.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_GLOBAL_dnsServiceName = new OptionDefinition("dnsServiceName",null,"EditDnsStubZoneAllowTransfer.dnsServiceName.argValue",true,false,"EditDnsStubZoneAllowTransfer.dnsServiceName.argDescription");
			/**
		 * 
		 */
		public static final OptionDefinition KEY_zoneName = new OptionDefinition("zoneName",null,"EditDnsStubZoneAllowTransfer.zoneName.argValue",true,false,"EditDnsStubZoneAllowTransfer.zoneName.argDescription");
...
public static final OptionDefinition KEY_locale = new OptionDefinition("locale","en","locale",false,false,"locale");	
 ...
 CommandLine cmd = null;
	...
	public EditDnsStubZoneAllowTransfer(java.util.Locale locale)
	{
		super("EditDnsStubZoneAllowTransfer", new String[]{"messages","messagesDns"},locale);
	}
	...
	public void execute(String[] args) throws WbemSmtException {
		...
		try {
			...
			CliDataLoader loader = new EditDnsStubZoneAllowTransferLoader();
