 /** 
  * ListDnsAddressMatchListLoader.java
  *
  ...
  * Contributors: 
  * 
  * Description: Loader for listing addressMatchlists
  * 
  */
...
public class ListDnsAddressMatchListLoader extends DnsDataLoader {

	/**
	 * 
	 */
	public ListDnsAddressMatchListLoader() {
		super();
	}
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		String listname = CliUtil.getOption(commandValues,ListDnsAddressMatchList.KEY_matchListName);
		selectAddressMatchList(bundle, adapter, listname);
	}
