/**
 * EditDnsResourceRecord.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class EditDnsResourceRecord extends CimCommand {
    ...
    public static final OptionDefinition KEY_zoneName = new OptionDefinition(null, "zoneName",
            null, "EditDnsResourceRecord.zoneName.argValue", true, false,
            "EditDnsResourceRecord.zoneName.argDescription");
    /**
     * required, used for selection:  --recordNameToSelect
     */
    public static final OptionDefinition KEY_recordNameToSelect = new OptionDefinition(null,
            "recordNameToSelect", null, "EditDnsResourceRecord.recordNameToSelect.argValue", true,
            false, "EditDnsResourceRecord.recordNameToSelect.argDescription");
    /**
     * required, used for selection:  --recordTypeToSelect
     */
    public static final OptionDefinition KEY_recordTypeToSelect = new OptionDefinition(null,
            "recordTypeToSelect", null, "EditDnsResourceRecord.recordTypeToSelect.argValue", true,
            false, "EditDnsResourceRecord.recordTypeToSelect.argDescription");
    /**
     * required, used for selection:  --recordValueToSelect
     */
    public static final OptionDefinition KEY_recordValueToSelect = new OptionDefinition(null,
            "recordValueToSelect", null, "EditDnsResourceRecord.recordValueToSelect.argValue",
            true, false, "EditDnsResourceRecord.recordValueToSelect.argDescription");
    /**
     * required, used for selection:  --mxPriorityToSelect
     */
    public static final OptionDefinition KEY_mxPriorityToSelect = new OptionDefinition(null,
            "mxPriorityToSelect", null, "EditDnsResourceRecord.mxPriorityToSelect.argValue", true,
            false, "EditDnsResourceRecord.mxPriorityToSelect.argDescription");
    /**
     *  --recordName
     */
    public static final OptionDefinition KEY_recordName = new OptionDefinition(null, "recordName",
            null, "DnsResourceRecordDataContainer.Name.argValue", false, false,
            "DnsResourceRecordDataContainer.Name.argDescription");
    /**
     *  --recordType
     */
    public static final OptionDefinition KEY_recordType = new OptionDefinition(null, "recordType",
            null, "DnsResourceRecordDataContainer.Type.argValue", false, false,
            "DnsResourceRecordDataContainer.Type.argDescription");
    /**
     *  --recordFamily
     */
    public static final OptionDefinition KEY_recordFamily = new OptionDefinition(null,
            "recordFamily", null, "DnsResourceRecordDataContainer.Family.argValue", false, false,
            "DnsResourceRecordDataContainer.Family.argDescription");
    /**
     *  --recordValue
     */
    public static final OptionDefinition KEY_recordValue = new OptionDefinition(null,
            "recordValue", null, "DnsResourceRecordDataContainer.Value.argValue", false, false,
            "DnsResourceRecordDataContainer.Value.argDescription");
    /**
     *  --mxPriority
     */
    public static final OptionDefinition KEY_mxPriority = new OptionDefinition(null, "mxPriority",
            null, "DnsResourceRecordDataContainer.Priority.argValue", false, false,
            "DnsResourceRecordDataContainer.Priority.argDescription");
    /**
     *  --ttl
     */
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] { KEY_zoneName,
            KEY_recordNameToSelect, KEY_recordTypeToSelect, KEY_recordValueToSelect,
            KEY_mxPriorityToSelect, KEY_recordName, KEY_recordType, KEY_recordFamily,
            KEY_recordValue, KEY_mxPriority, KEY_ttl, KEY_ttlUnit, KEY_removeTTL, };
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DnsResourceRecordDataContainer.caption") }));
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dns.bl.container.edit.DnsResourceRecordDataContainer dc)
