...
/** 
  * EditDnsMasterZoneAllowQueryLoader.java
  *
...
public class EditDnsMasterZoneAllowQueryLoader extends DnsDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		this.commandValues = commandValues;
				String name = CliUtil.getOption(commandValues,EditDnsMasterZoneAllowQuery.KEY_zoneName);
