/**
 * EditDnsSlaveZone.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS OF
...
public class EditDnsSlaveZone extends CimCommand {
    ...
    public static final OptionDefinition KEY_zoneFile = new OptionDefinition(null, "zoneFile",
            null, "DnsSlaveZoneDataContainer.ZoneFile.argValue", false, false,
            "DnsSlaveZoneDataContainer.ZoneFile.argDescription");
    /**
     *  --useGlobalForwarders
     */
    public static final OptionDefinition KEY_useGlobalForwarders = new OptionDefinition(null,
            ...
            "DnsSlaveZoneDataContainer.useGlobalForwarders.argDescription");
    /**
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] { KEY_zoneFile,
            ...
            KEY_removeForwarder, KEY_newForwarder, KEY_addForwarder, KEY_newForwarderType,
            ...
            values.getOut().println(
                    "\n"
                            + bundle.getString("editing", new Object[] { bundle
                                    .getString("DnsSlaveZoneDataContainer.caption") }));
    ...
    private void setKeyValues(CommandLine cmd, AbstractBaseCimAdapter adapter,
            org.sblim.wbemsmt.dns.bl.container.edit.DnsSlaveZoneDataContainer dc)
