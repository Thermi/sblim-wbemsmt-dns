...
/** 
  * DeleteDnsForwardZoneLoader.java
  *
  ...
  * Contributors: 
  * 
  * Description: Loader for deleting a ForwardZone
  * 
  */
...
public class DeleteDnsForwardZoneLoader extends DnsDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		this.commandValues = commandValues;
				String name = CliUtil.getOption(commandValues,DeleteDnsForwardZone.KEY_zoneName);
