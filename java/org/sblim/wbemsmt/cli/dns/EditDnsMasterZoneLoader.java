...
/** 
  ...
  * Contributors: 
  * 
  * Description: Loader for editing a MasterZone
  * 
  */
...
public class EditDnsMasterZoneLoader extends DnsDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
			...
			throws WbemsmtException {
				...
				String name = CliUtil.getOption(commandValues,EditDnsMasterZone.KEY_zoneName);
