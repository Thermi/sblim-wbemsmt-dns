/**
 * DeleteDnsAddressMatchList.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class DeleteDnsAddressMatchList extends CimCommand {
    ...
    private static final OptionDefinition[] LOCAL_OPTIONS = new OptionDefinition[] { KEY_matchListName, };
