...
/** 
  * EditDnsStubZoneAllowNotifyLoader.java
  *
  ...
  * Contributors: 
  * 
  * Description: Loader for editing a zone's AllowNotify ACL
  * 
  */
...
public class EditDnsStubZoneAllowNotifyLoader extends DnsDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		this.commandValues = commandValues;
				String name = CliUtil.getOption(commandValues,EditDnsStubZoneAllowNotify.KEY_zoneName);
