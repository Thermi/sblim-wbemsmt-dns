...
/** 
  * EditDnsReverseZoneAllowQueryLoader.java
  *
...
public class EditDnsReverseZoneAllowQueryLoader extends DnsDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		this.commandValues = commandValues;
				String name = CliUtil.getOption(commandValues,EditDnsReverseZoneAllowQuery.KEY_zoneName);
