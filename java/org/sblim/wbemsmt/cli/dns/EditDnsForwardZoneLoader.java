...
/** 
  ...
  * Contributors: 
  * 
  * Description: Loader for editing a ForwardZone
  * 
  */
...
public class EditDnsForwardZoneLoader extends DnsDataLoader {
	...
	public void load(WbemSmtResourceBundle bundle,
		...
		this.commandValues = commandValues;
				String name = CliUtil.getOption(commandValues,EditDnsForwardZone.KEY_zoneName);
