...
public class DnsResourceRecordWizardPage2TypeOtherDataContainerImpl extends
        org.sblim.wbemsmt.tools.wizard.jsf.WizardBasePanel
        implements
        org.sblim.wbemsmt.dns.bl.container.wizard.DnsResourceRecordWizardPage2TypeOtherDataContainer {
    private org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf ic_usr_Value;

    public DnsResourceRecordWizardPage2TypeOtherDataContainerImpl(
        ...
        super(adapter, bindingPrefix, "DnsResourceRecordWizardPage2TypeOtherDataContainer.caption",
                "DnsResourceRecordWizardPage2TypeOtherDataContainer.subTitle", false);

        addComponent((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputComponent) get_usr_Value());

        setFooter(getPanelForCustomLayout(),
                "DnsResourceRecordWizardPage2TypeOtherDataContainer.footerText");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Value() {
        if (ic_usr_Value == null) {
            String label = bundle
                    .getString("DnsResourceRecordWizardPage2TypeOtherDataContainer.Value");
