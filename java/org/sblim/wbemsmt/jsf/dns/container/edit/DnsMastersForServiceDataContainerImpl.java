...
public class DnsMastersForServiceDataContainerImpl extends
    ...
    public DnsMastersForServiceDataContainerImpl(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_AddPredefinedMaster() {
        if (ic_usr_AddPredefinedMaster == null) {
            String label = bundle
                    .getString("DnsMastersForServiceDataContainer.addPredefinedMaster");
    ...
    public void reload() {
        ...
        if (ic_usr_RemoveMasterEntry != null) {
            ic_usr_RemoveMasterEntry.setLabelText(bundle
                    .getString("DnsMastersForServiceDataContainer.removeMasterEntry"));
        }
        if (ic_usr_NewMasterEntry != null) {
            ic_usr_NewMasterEntry.setLabelText(bundle
                    .getString("DnsMastersForServiceDataContainer.newMasterEntry"));
        }
        if (ic_usr_AddNewMasterEntry != null) {
            ic_usr_AddNewMasterEntry.setLabelText(bundle
                    .getString("DnsMastersForServiceDataContainer.addNewMasterEntry"));
        }
        if (ic_usr_AddPredefinedMaster != null) {
        ...
        if (ic_usr_PredefinedMasters != null) {
            ic_usr_PredefinedMasters.setLabelText(bundle
                    .getString("DnsMastersForServiceDataContainer.predefinedMasters"));
        }
        if (ic_Name != null) {
