...
public class DnsSlaveZoneDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.dns.bl.container.edit.DnsSlaveZoneDataContainer {
    ...
    public DnsSlaveZoneDataContainerImpl(org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter,
    ...
    public void reload() {
        ...
        if (ic_usr_RemoveForwarder != null) {
            ic_usr_RemoveForwarder.setLabelText(bundle
                    .getString("DnsSlaveZoneDataContainer.removeForwarder"));
        }
        if (ic_usr_NewForwarder != null) {
            ic_usr_NewForwarder.setLabelText(bundle
                    .getString("DnsSlaveZoneDataContainer.newForwarder"));
        }
        if (ic_usr_AddForwarder != null) {
            ic_usr_AddForwarder.setLabelText(bundle
                    .getString("DnsSlaveZoneDataContainer.addForwarder"));
        }
        if (ic_usr_NewForwarderType != null) {
            ic_usr_NewForwarderType.setLabelText(bundle
                    .getString("DnsSlaveZoneDataContainer.newForwarderType"));
        }
        if (ic_Masters != null) {
        ...
        if (ic_usr_RemoveMasterEntry != null) {
            ic_usr_RemoveMasterEntry.setLabelText(bundle
                    .getString("DnsSlaveZoneDataContainer.removeMasterEntry"));
        }
        if (ic_usr_NewMasterEntry != null) {
            ic_usr_NewMasterEntry.setLabelText(bundle
                    .getString("DnsSlaveZoneDataContainer.newMasterEntry"));
        }
        if (ic_usr_AddNewMasterEntry != null) {
            ic_usr_AddNewMasterEntry.setLabelText(bundle
                    .getString("DnsSlaveZoneDataContainer.addNewMasterEntry"));
        }
        if (ic_usr_AddPredefinedMaster != null) {
            ic_usr_AddPredefinedMaster.setLabelText(bundle
                    .getString("DnsSlaveZoneDataContainer.addPredefinedMaster"));
        }
        if (ic_usr_PredefinedMasters != null) {
            ic_usr_PredefinedMasters.setLabelText(bundle
                    .getString("DnsSlaveZoneDataContainer.predefinedMasters"));
        }
        if (ic_TTL != null) {
        ...
        if (ic_usr_UseGlobalForwarders != null) {
            ic_usr_UseGlobalForwarders.setLabelText(bundle
                    .getString("DnsSlaveZoneDataContainer.useGlobalForwarders"));
        }
    }
