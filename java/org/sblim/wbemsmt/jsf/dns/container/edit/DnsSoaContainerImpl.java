...
public class DnsSoaContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements
    ...
    public DnsSoaContainerImpl(org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter,
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_Refresh() {
        if (ic_Refresh == null) {
            ...
            boolean readOnly = false;
            ic_Refresh = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_NegativeCachingTTL() {
        if (ic_NegativeCachingTTL == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_NegativeCachingTTL = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_SetSerialNumber() {
        if (ic_usr_SetSerialNumber == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_SetSerialNumber = new org.sblim.wbemsmt.tools.input.jsf.JSFButtonComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public void reload() {
        ...
        if (ic_NegativeCachingTTL != null) {
            ic_NegativeCachingTTL.setLabelText(bundle
                    .getString("DnsSoaContainer.NegativeCachingTTL"));
        }
        if (ic_usr_TTLUnit != null) {
            ic_usr_TTLUnit.setLabelText(bundle.getString("DnsSoaContainer.TTLUnit"));
        }
        if (ic_usr_SetSerialNumber != null) {
            ic_usr_SetSerialNumber
                    .setLabelText(bundle.getString("DnsSoaContainer.setSerialNumber"));
        }
    }
