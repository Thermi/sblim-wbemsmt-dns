/** 
  * DnsAllowUpdateForZoneDataContainerImpl.java
  *
  * 
...
public class DnsAllowUpdateForZoneDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements org.sblim.wbemsmt.dns.bl.container.edit.DnsAllowUpdateForZoneDataContainer
	{
			...
			DnsAllowUpdateForZoneDataContainerImplLayouter layouter = null;
		
		public DnsAllowUpdateForZoneDataContainerImplLayouter getLayouter()
		{
			return layouter;
		}	
	
	public DnsAllowUpdateForZoneDataContainerImpl(org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter,String expressionPrefix) throws WbemsmtException  {

			
				super(adapter,expressionPrefix, "DnsAllowUpdateForZoneDataContainer.caption",false);
				
				
		
				
    			
    				layouter = new DnsAllowUpdateForZoneDataContainerImplLayouter();
			//layout is done in the edit-method of the Editbean
			//layouter.layout(getPanelForCustomLayout(),this,bundle);
				
		setFooter(getPanelForCustomLayout(),"DnsAllowUpdateForZoneDataContainer.footerText");
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_AddressList() {
    		...
    		{
				String label = bundle.getString("DnsAllowUpdateForZoneDataContainer.AddressList");
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_RemoveAddress() {
    		...
    		{
				String label = bundle.getString("DnsAllowUpdateForZoneDataContainer.removeAddress");
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_UserAddresses() {
    		...
    		{
				String label = bundle.getString("DnsAllowUpdateForZoneDataContainer.userAddresses");
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_NewAddress() {
    		...
    		{
				String label = bundle.getString("DnsAllowUpdateForZoneDataContainer.newAddress");
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_AddPredefinedAddress() {
    		...
    		{
				String label = bundle.getString("DnsAllowUpdateForZoneDataContainer.addPredefinedAddress");
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_AddNewAddress() {
    		...
    		{
				String label = bundle.getString("DnsAllowUpdateForZoneDataContainer.addNewAddress");
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_AddressUp() {
    		...
    		{
				String label = bundle.getString("DnsAllowUpdateForZoneDataContainer.addressUp");
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_AddressDown() {
    		...
    		{
				String label = bundle.getString("DnsAllowUpdateForZoneDataContainer.addressDown");
	...
	public void reload()
	{
		super.reload();
	    		if (ic_AddressList != null)
    		{
				ic_AddressList.setLabelText(bundle.getString("DnsAllowUpdateForZoneDataContainer.AddressList"));
    		}
	    		if (ic_usr_RemoveAddress != null)
    		{
				ic_usr_RemoveAddress.setLabelText(bundle.getString("DnsAllowUpdateForZoneDataContainer.removeAddress"));
    		}
	    		if (ic_usr_UserAddresses != null)
    		{
				ic_usr_UserAddresses.setLabelText(bundle.getString("DnsAllowUpdateForZoneDataContainer.userAddresses"));
    		}
	    		if (ic_usr_NewAddress != null)
    		{
				ic_usr_NewAddress.setLabelText(bundle.getString("DnsAllowUpdateForZoneDataContainer.newAddress"));
    		}
	    		if (ic_usr_AddPredefinedAddress != null)
    		{
				ic_usr_AddPredefinedAddress.setLabelText(bundle.getString("DnsAllowUpdateForZoneDataContainer.addPredefinedAddress"));
    		}
	    		if (ic_usr_AddNewAddress != null)
    		{
				ic_usr_AddNewAddress.setLabelText(bundle.getString("DnsAllowUpdateForZoneDataContainer.addNewAddress"));
    		}
	    		if (ic_usr_AddressUp != null)
    		{
				ic_usr_AddressUp.setLabelText(bundle.getString("DnsAllowUpdateForZoneDataContainer.addressUp"));
    		}
	    		if (ic_usr_AddressDown != null)
    		{
				ic_usr_AddressDown.setLabelText(bundle.getString("DnsAllowUpdateForZoneDataContainer.addressDown"));
    		}
		}
