...
public class DnsAddressMatchListForServiceDataContainerImpl extends
        org.sblim.wbemsmt.tools.jsf.EditBasePanel implements
        org.sblim.wbemsmt.dns.bl.container.edit.DnsAddressMatchListForServiceDataContainer {
    ...
    public DnsAddressMatchListForServiceDataContainerImpl(
            org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter, String bindingPrefix)
            throws WbemsmtException {

        super(adapter, bindingPrefix, "DnsAddressMatchListForServiceDataContainer.caption", false);

        layouter = new DnsAddressMatchListForServiceDataContainerImplLayouter();
        //layout is done in the edit-method of the Editbean
        //layouter.layout(getPanelForCustomLayout(),this,bundle);

        setFooter(getPanelForCustomLayout(),
                "DnsAddressMatchListForServiceDataContainer.footerText");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_AddressList() {
        if (ic_AddressList == null) {
            String label = bundle
                    .getString("DnsAddressMatchListForServiceDataContainer.AddressList");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_RemoveAddress() {
        if (ic_usr_RemoveAddress == null) {
            String label = bundle
                    .getString("DnsAddressMatchListForServiceDataContainer.removeAddress");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_UserAddresses() {
        if (ic_usr_UserAddresses == null) {
            String label = bundle
                    .getString("DnsAddressMatchListForServiceDataContainer.userAddresses");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_NewAddress() {
        if (ic_usr_NewAddress == null) {
            String label = bundle
                    .getString("DnsAddressMatchListForServiceDataContainer.newAddress");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_AddPredefinedAddress() {
        if (ic_usr_AddPredefinedAddress == null) {
            String label = bundle
                    .getString("DnsAddressMatchListForServiceDataContainer.addPredefinedAddress");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_AddNewAddress() {
        if (ic_usr_AddNewAddress == null) {
            String label = bundle
                    .getString("DnsAddressMatchListForServiceDataContainer.addNewAddress");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_AddressDown() {
        if (ic_usr_AddressDown == null) {
            String label = bundle
                    .getString("DnsAddressMatchListForServiceDataContainer.addressDown");
    ...
    public void reload() {
        ...
        if (ic_usr_AddressUp != null) {
            ic_usr_AddressUp.setLabelText(bundle
                    .getString("DnsAddressMatchListForServiceDataContainer.addressUp"));
        }
        if (ic_usr_AddressDown != null) {
        ...
        if (ic_Name != null) {
            ic_Name.setLabelText(bundle
                    .getString("DnsAddressMatchListForServiceDataContainer.Name"));
        }
    }
