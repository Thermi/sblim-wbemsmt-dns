...
public class DnsReverseZoneDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements org.sblim.wbemsmt.dns.bl.container.edit.DnsReverseZoneDataContainer
	...
	public DnsReverseZoneDataContainerImpl(org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter,String expressionPrefix) throws WbemsmtException  {

			
				super(adapter,expressionPrefix, "DnsReverseZoneDataContainer.caption",false);
	...
	public void reload()
	{
		super.reload();
	    		...
	    		if (ic_Forwarders != null)
    		{
	    		...
	    		if (ic_usr_RemoveForwarder != null)
    		{
				ic_usr_RemoveForwarder.setLabelText(bundle.getString("DnsReverseZoneDataContainer.removeForwarder"));
    		}
	    		if (ic_usr_NewForwarder != null)
    		{
				ic_usr_NewForwarder.setLabelText(bundle.getString("DnsReverseZoneDataContainer.newForwarder"));
    		}
	    		if (ic_usr_AddForwarder != null)
    		{
				ic_usr_AddForwarder.setLabelText(bundle.getString("DnsReverseZoneDataContainer.addForwarder"));
    		}
	    		if (ic_usr_NewForwarderType != null)
    		{
				ic_usr_NewForwarderType.setLabelText(bundle.getString("DnsReverseZoneDataContainer.newForwarderType"));
    		}
	    		if (ic_TTL != null)
    		{
	    		...
	    		if (ic_usr_TTLUnit != null)
    		{
	    		...
	    		if (ic_usr_RemoveTTL != null)
    		{
				ic_usr_RemoveTTL.setLabelText(bundle.getString("DnsReverseZoneDataContainer.removeTTL"));
    		}
	    		if (ic_ZoneFile != null)
    		{
	    		...
	    		if (ic_usr_UseGlobalForwarders != null)
    		{
				ic_usr_UseGlobalForwarders.setLabelText(bundle.getString("DnsReverseZoneDataContainer.useGlobalForwarders"));
    		}
		}
