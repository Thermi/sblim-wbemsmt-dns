...
public class DnsForwardersForServiceDataContainerImpl extends
    ...
    public DnsForwardersForServiceDataContainerImpl(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_NewForwarderType() {
        if (ic_usr_NewForwarderType == null) {
            String label = bundle
                    .getString("DnsForwardersForServiceDataContainer.newForwarderType");
    ...
    public void reload() {
        ...
        if (ic_Forward != null) {
            ic_Forward.setLabelText(bundle
                    .getString("DnsForwardersForServiceDataContainer.Forward"));
        }
        if (ic_Forwarders != null) {
            ic_Forwarders.setLabelText(bundle
                    .getString("DnsForwardersForServiceDataContainer.Forwarders"));
        }
        if (ic_usr_RemoveForwarder != null) {
            ic_usr_RemoveForwarder.setLabelText(bundle
                    .getString("DnsForwardersForServiceDataContainer.removeForwarder"));
        }
        if (ic_usr_NewForwarder != null) {
            ic_usr_NewForwarder.setLabelText(bundle
                    .getString("DnsForwardersForServiceDataContainer.newForwarder"));
        }
        if (ic_usr_AddForwarder != null) {
            ic_usr_AddForwarder.setLabelText(bundle
                    .getString("DnsForwardersForServiceDataContainer.addForwarder"));
        }
        if (ic_usr_NewForwarderType != null) {
