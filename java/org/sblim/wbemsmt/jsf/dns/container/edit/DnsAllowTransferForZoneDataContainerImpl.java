...
public class DnsAllowTransferForZoneDataContainerImpl extends
    ...
    public DnsAllowTransferForZoneDataContainerImpl(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_AddPredefinedAddress() {
        if (ic_usr_AddPredefinedAddress == null) {
            String label = bundle
                    .getString("DnsAllowTransferForZoneDataContainer.addPredefinedAddress");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_UseGlobalAddressMatchList() {
        if (ic_usr_UseGlobalAddressMatchList == null) {
            String label = bundle
                    .getString("DnsAllowTransferForZoneDataContainer.useGlobalAddressMatchList");
            String binding = bindingPrefix + "_usr_UseGlobalAddressMatchList.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_UseGlobalAddressMatchList = new org.sblim.wbemsmt.tools.input.jsf.JSFButtonComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public void reload() {
        ...
        if (ic_AddressList != null) {
            ic_AddressList.setLabelText(bundle
                    .getString("DnsAllowTransferForZoneDataContainer.AddressList"));
        }
        if (ic_usr_RemoveAddress != null) {
            ic_usr_RemoveAddress.setLabelText(bundle
                    .getString("DnsAllowTransferForZoneDataContainer.removeAddress"));
        }
        if (ic_usr_UserAddresses != null) {
            ic_usr_UserAddresses.setLabelText(bundle
                    .getString("DnsAllowTransferForZoneDataContainer.userAddresses"));
        }
        if (ic_usr_NewAddress != null) {
            ic_usr_NewAddress.setLabelText(bundle
                    .getString("DnsAllowTransferForZoneDataContainer.newAddress"));
        }
        if (ic_usr_AddPredefinedAddress != null) {
        ...
        if (ic_usr_AddNewAddress != null) {
            ic_usr_AddNewAddress.setLabelText(bundle
                    .getString("DnsAllowTransferForZoneDataContainer.addNewAddress"));
        }
        if (ic_usr_AddressUp != null) {
            ic_usr_AddressUp.setLabelText(bundle
                    .getString("DnsAllowTransferForZoneDataContainer.addressUp"));
        }
        if (ic_usr_AddressDown != null) {
            ic_usr_AddressDown.setLabelText(bundle
                    .getString("DnsAllowTransferForZoneDataContainer.addressDown"));
        }
        if (ic_usr_UseGlobalAddressMatchList != null) {
            ic_usr_UseGlobalAddressMatchList.setLabelText(bundle
                    .getString("DnsAllowTransferForZoneDataContainer.useGlobalAddressMatchList"));
        }
    }
