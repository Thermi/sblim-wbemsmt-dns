...
public class DnsForwardZoneDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.dns.bl.container.edit.DnsForwardZoneDataContainer {
    ...
    public DnsForwardZoneDataContainerImpl(org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter,
    ...
    public void reload() {
        ...
        if (ic_usr_RemoveForwarder != null) {
            ic_usr_RemoveForwarder.setLabelText(bundle
                    .getString("DnsForwardZoneDataContainer.removeForwarder"));
        }
        if (ic_usr_NewForwarder != null) {
            ic_usr_NewForwarder.setLabelText(bundle
                    .getString("DnsForwardZoneDataContainer.newForwarder"));
        }
        if (ic_usr_AddForwarder != null) {
            ic_usr_AddForwarder.setLabelText(bundle
                    .getString("DnsForwardZoneDataContainer.addForwarder"));
        }
        if (ic_usr_NewForwarderType != null) {
            ic_usr_NewForwarderType.setLabelText(bundle
                    .getString("DnsForwardZoneDataContainer.newForwarderType"));
        }
        if (ic_usr_UseGlobalForwarders != null) {
            ic_usr_UseGlobalForwarders.setLabelText(bundle
                    .getString("DnsForwardZoneDataContainer.useGlobalForwarders"));
        }
    }
