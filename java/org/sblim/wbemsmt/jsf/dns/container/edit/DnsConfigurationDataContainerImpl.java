...
public class DnsConfigurationDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.dns.bl.container.edit.DnsConfigurationDataContainer {
    ...
    public DnsConfigurationDataContainerImpl(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_ConfigurationDirectory() {
        if (ic_ConfigurationDirectory == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_ConfigurationDirectory = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_PortNumber() {
        if (ic_PortNumber == null) {
            ...
            boolean readOnly = false;
            ic_PortNumber = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_RemoveDirectory() {
        if (ic_usr_RemoveDirectory == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_RemoveDirectory = new org.sblim.wbemsmt.tools.input.jsf.JSFButtonComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public void reload() {
        ...
        if (ic_ConfigurationFile != null) {
            ic_ConfigurationFile.setLabelText(bundle
                    .getString("DnsConfigurationDataContainer.ConfigurationFile"));
        }
        if (ic_ConfigurationDirectory != null) {
            ic_ConfigurationDirectory.setLabelText(bundle
                    .getString("DnsConfigurationDataContainer.ConfigurationDirectory"));
        }
        if (ic_PortNumber != null) {
            ic_PortNumber
                    .setLabelText(bundle.getString("DnsConfigurationDataContainer.PortNumber"));
        }
        if (ic_usr_RemoveDirectory != null) {
            ic_usr_RemoveDirectory.setLabelText(bundle
                    .getString("DnsConfigurationDataContainer.removeDirectory"));
        }
    }
