...
public class DnsAllowNotifyForServiceDataContainerImpl extends
    ...
    public DnsAllowNotifyForServiceDataContainerImpl(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_AddPredefinedAddress() {
        if (ic_usr_AddPredefinedAddress == null) {
            String label = bundle
                    .getString("DnsAllowNotifyForServiceDataContainer.addPredefinedAddress");
    ...
    public void reload() {
        ...
        if (ic_AddressList != null) {
            ic_AddressList.setLabelText(bundle
                    .getString("DnsAllowNotifyForServiceDataContainer.AddressList"));
        }
        if (ic_usr_RemoveAddress != null) {
            ic_usr_RemoveAddress.setLabelText(bundle
                    .getString("DnsAllowNotifyForServiceDataContainer.removeAddress"));
        }
        if (ic_usr_UserAddresses != null) {
            ic_usr_UserAddresses.setLabelText(bundle
                    .getString("DnsAllowNotifyForServiceDataContainer.userAddresses"));
        }
        if (ic_usr_NewAddress != null) {
            ic_usr_NewAddress.setLabelText(bundle
                    .getString("DnsAllowNotifyForServiceDataContainer.newAddress"));
        }
        if (ic_usr_AddPredefinedAddress != null) {
        ...
        if (ic_usr_AddNewAddress != null) {
            ic_usr_AddNewAddress.setLabelText(bundle
                    .getString("DnsAllowNotifyForServiceDataContainer.addNewAddress"));
        }
        if (ic_usr_AddressUp != null) {
            ic_usr_AddressUp.setLabelText(bundle
                    .getString("DnsAllowNotifyForServiceDataContainer.addressUp"));
        }
        if (ic_usr_AddressDown != null) {
            ic_usr_AddressDown.setLabelText(bundle
                    .getString("DnsAllowNotifyForServiceDataContainer.addressDown"));
        }
    }
