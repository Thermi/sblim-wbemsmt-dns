...
public class DnsMasterZoneDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.dns.bl.container.edit.DnsMasterZoneDataContainer {
    ...
    public DnsMasterZoneDataContainerImpl(org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter,
    ...
    public void reload() {
        ...
        if (ic_usr_RemoveForwarder != null) {
            ic_usr_RemoveForwarder.setLabelText(bundle
                    .getString("DnsMasterZoneDataContainer.removeForwarder"));
        }
        if (ic_usr_NewForwarder != null) {
            ic_usr_NewForwarder.setLabelText(bundle
                    .getString("DnsMasterZoneDataContainer.newForwarder"));
        }
        if (ic_usr_AddForwarder != null) {
            ic_usr_AddForwarder.setLabelText(bundle
                    .getString("DnsMasterZoneDataContainer.addForwarder"));
        }
        if (ic_usr_NewForwarderType != null) {
            ic_usr_NewForwarderType.setLabelText(bundle
                    .getString("DnsMasterZoneDataContainer.newForwarderType"));
        }
        if (ic_TTL != null) {
        ...
        if (ic_usr_UseGlobalForwarders != null) {
            ic_usr_UseGlobalForwarders.setLabelText(bundle
                    .getString("DnsMasterZoneDataContainer.useGlobalForwarders"));
        }
    }
