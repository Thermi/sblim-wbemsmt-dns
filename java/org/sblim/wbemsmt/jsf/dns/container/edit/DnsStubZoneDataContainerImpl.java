...
public class DnsStubZoneDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel
        implements org.sblim.wbemsmt.dns.bl.container.edit.DnsStubZoneDataContainer {
    ...
    public DnsStubZoneDataContainerImpl(org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter,
    ...
    public void reload() {
        ...
        if (ic_usr_RemoveForwarder != null) {
            ic_usr_RemoveForwarder.setLabelText(bundle
                    .getString("DnsStubZoneDataContainer.removeForwarder"));
        }
        if (ic_usr_NewForwarder != null) {
            ic_usr_NewForwarder.setLabelText(bundle
                    .getString("DnsStubZoneDataContainer.newForwarder"));
        }
        if (ic_usr_AddForwarder != null) {
            ic_usr_AddForwarder.setLabelText(bundle
                    .getString("DnsStubZoneDataContainer.addForwarder"));
        }
        if (ic_usr_NewForwarderType != null) {
            ic_usr_NewForwarderType.setLabelText(bundle
                    .getString("DnsStubZoneDataContainer.newForwarderType"));
        }
        if (ic_Name != null) {
        ...
        if (ic_usr_RemoveMasterEntry != null) {
            ic_usr_RemoveMasterEntry.setLabelText(bundle
                    .getString("DnsStubZoneDataContainer.removeMasterEntry"));
        }
        if (ic_usr_NewMasterEntry != null) {
            ic_usr_NewMasterEntry.setLabelText(bundle
                    .getString("DnsStubZoneDataContainer.newMasterEntry"));
        }
        if (ic_usr_AddNewMasterEntry != null) {
            ic_usr_AddNewMasterEntry.setLabelText(bundle
                    .getString("DnsStubZoneDataContainer.addNewMasterEntry"));
        }
        if (ic_usr_AddPredefinedMaster != null) {
            ic_usr_AddPredefinedMaster.setLabelText(bundle
                    .getString("DnsStubZoneDataContainer.addPredefinedMaster"));
        }
        if (ic_usr_PredefinedMasters != null) {
            ic_usr_PredefinedMasters.setLabelText(bundle
                    .getString("DnsStubZoneDataContainer.predefinedMasters"));
        }
        if (ic_TTL != null) {
        ...
        if (ic_usr_UseGlobalForwarders != null) {
            ic_usr_UseGlobalForwarders.setLabelText(bundle
                    .getString("DnsStubZoneDataContainer.useGlobalForwarders"));
        }
    }
