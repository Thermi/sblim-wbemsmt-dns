...
public class DnsAllowQueryForZoneDataContainerImpl extends
    ...
    public DnsAllowQueryForZoneDataContainerImpl(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_AddPredefinedAddress() {
        if (ic_usr_AddPredefinedAddress == null) {
            String label = bundle
                    .getString("DnsAllowQueryForZoneDataContainer.addPredefinedAddress");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_UseGlobalAddressMatchList() {
        if (ic_usr_UseGlobalAddressMatchList == null) {
            String label = bundle
                    .getString("DnsAllowQueryForZoneDataContainer.useGlobalAddressMatchList");
    ...
    public void reload() {
        ...
        if (ic_AddressList != null) {
            ic_AddressList.setLabelText(bundle
                    .getString("DnsAllowQueryForZoneDataContainer.AddressList"));
        }
        if (ic_usr_RemoveAddress != null) {
            ic_usr_RemoveAddress.setLabelText(bundle
                    .getString("DnsAllowQueryForZoneDataContainer.removeAddress"));
        }
        if (ic_usr_UserAddresses != null) {
            ic_usr_UserAddresses.setLabelText(bundle
                    .getString("DnsAllowQueryForZoneDataContainer.userAddresses"));
        }
        if (ic_usr_NewAddress != null) {
            ic_usr_NewAddress.setLabelText(bundle
                    .getString("DnsAllowQueryForZoneDataContainer.newAddress"));
        }
        if (ic_usr_AddPredefinedAddress != null) {
        ...
        if (ic_usr_AddNewAddress != null) {
            ic_usr_AddNewAddress.setLabelText(bundle
                    .getString("DnsAllowQueryForZoneDataContainer.addNewAddress"));
        }
        if (ic_usr_AddressUp != null) {
            ic_usr_AddressUp.setLabelText(bundle
                    .getString("DnsAllowQueryForZoneDataContainer.addressUp"));
        }
        if (ic_usr_AddressDown != null) {
            ic_usr_AddressDown.setLabelText(bundle
                    .getString("DnsAllowQueryForZoneDataContainer.addressDown"));
        }
        if (ic_usr_UseGlobalAddressMatchList != null) {
