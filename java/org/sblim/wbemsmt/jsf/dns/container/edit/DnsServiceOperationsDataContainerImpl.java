...
public class DnsServiceOperationsDataContainerImpl extends
        org.sblim.wbemsmt.tools.jsf.EditBasePanel implements
        org.sblim.wbemsmt.dns.bl.container.edit.DnsServiceOperationsDataContainer {
    ...
    public DnsServiceOperationsDataContainerImpl(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_RunAsRoot() {
        if (ic_RunAsRoot == null) {
            ...
            ic_RunAsRoot = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Restart() {
        if (ic_usr_Restart == null) {
            ...
            ic_usr_Restart = new org.sblim.wbemsmt.tools.input.jsf.JSFButtonComponent(parent,
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_invoke_Start() {
        if (ic_invoke_Start == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_invoke_Start = new org.sblim.wbemsmt.tools.input.jsf.JSFButtonComponent(parent,
                    label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_invoke_Stop() {
        if (ic_invoke_Stop == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_invoke_Stop = new org.sblim.wbemsmt.tools.input.jsf.JSFButtonComponent(parent,
                    label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_Status() {
        if (ic_Status == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = true;
            ic_Status = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(parent,
                    label, binding, converter, readOnly);
            ;
        }
    ...
    public void reload() {
        super.reload();
        if (ic_RunAsRoot != null) {
            ic_RunAsRoot.setLabelText(bundle
                    .getString("DnsServiceOperationsDataContainer.RunAsRoot"));
        }
        if (ic_usr_Restart != null) {
            ic_usr_Restart.setLabelText(bundle
                    .getString("DnsServiceOperationsDataContainer.restart"));
        }
        if (ic_invoke_Start != null) {
            ic_invoke_Start.setLabelText(bundle
                    .getString("DnsServiceOperationsDataContainer.start"));
        }
        if (ic_invoke_Stop != null) {
