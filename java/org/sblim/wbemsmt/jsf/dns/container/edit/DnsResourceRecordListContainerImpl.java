...
public class DnsResourceRecordListContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements org.sblim.wbemsmt.dns.bl.container.edit.DnsResourceRecordListContainer
			, org.sblim.wbemsmt.dns.bl.container.edit.DnsResourceRecordListItemContainerHeader		
	{
    		...
    		private org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf ic_usr_Delete;
				...
				private java.util.List<DnsResourceRecordListItemContainer> icResourceRecords = new java.util.ArrayList<DnsResourceRecordListItemContainer>();
	...
	public DnsResourceRecordListContainerImpl(org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter,String expressionPrefix) throws WbemsmtException  {

			
				super(adapter,expressionPrefix, "DnsResourceRecordListContainer.caption",false);
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_SelectAll() {
    		if (ic_usr_SelectAll == null)
    		{
				...
				String binding = expressionPrefix + "_usr_SelectAll.item";
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Delete() {
    		if (ic_usr_Delete == null)
    		{
				...
				String binding = expressionPrefix + "_usr_Delete.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
	...
	*/
	public java.util.List<DnsResourceRecordListItemContainer> getResourceRecordsForUI()
	{
				
		List<DnsResourceRecordListItemContainer> result = new ArrayList<DnsResourceRecordListItemContainer>();
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getResourceRecordsHeader_usr_DeleteRecord() {
    		if (icResourceRecordsHeader_usr_DeleteRecord == null)
    		{
				...
				String binding = expressionPrefix + "resourceRecordsHeader_usr_DeleteRecord.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
				...
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFCheckboxComponent)icResourceRecordsHeader_usr_DeleteRecord).setOrientation( org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT );    		}
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getResourceRecordsHeader_Value() {
    		if (icResourceRecordsHeader_Value == null)
    		{
				...
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent)icResourceRecordsHeader_Value).setOrientation( org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT );    		}
	...
	public void countAndCreateChildren() throws WbemsmtException {
    			...
    			try
		{
			int count = adapter.count("resourceRecords",org.sblim.wbemsmt.dns.bl.container.edit.DnsResourceRecordListItemContainer.class, this);
	        if (count != resourceRecordsCount)
	        {
	           resourceRecordsCount = count;
	           clearResourceRecords();
			   for (int i=0; i < count ; i++) {
	    			addResourceRecords(new org.sblim.wbemsmt.jsf.dns.container.edit.DnsResourceRecordListItemContainer_AsResourceRecords_InDnsResourceRecordListContainerImpl((org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter)adapter,expressionPrefix, i));
			   }
	        }
	...
	public void copyFrom(DataContainer sourceContainer) throws WbemsmtException
	{
    	    		   ...
    	    		   List<DnsResourceRecordListItemContainer> targetListForResourceRecords = getResourceRecords();
    		   List<DnsResourceRecordListItemContainer> sourceListForResourceRecords = source.getResourceRecords();
