...
public class DnsZoneTracingContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements org.sblim.wbemsmt.dns.bl.container.edit.DnsZoneTracingContainer {
	...
	public void addResourceRecords(org.sblim.wbemsmt.jsf.dns.container.edit.DnsResourceRecordDataContainer_AsResourceRecords_InDnsZoneTracingContainerImpl child) {
	...
	public void clearResourceRecords() {
		...
		getResourceRecordsPanel().getInputFieldContainer().getChildren().clear();
					...
					((LabeledJSFInputComponent)getResourceRecords_PriorityHeader()).getDependentChildFields().clear();
			}
