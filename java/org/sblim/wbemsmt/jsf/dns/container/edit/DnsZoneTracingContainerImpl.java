...
public class DnsZoneTracingContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements org.sblim.wbemsmt.dns.bl.container.edit.DnsZoneTracingContainer
			, org.sblim.wbemsmt.dns.bl.container.edit.DnsResourceRecordDataContainerHeader		
	{
    		...
    		private org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf ic_usr_NegativeCaching_TTLUnit;
				...
				private java.util.List<DnsResourceRecordDataContainer> icResourceRecords = new java.util.ArrayList<DnsResourceRecordDataContainer>();
	...
	public DnsZoneTracingContainerImpl(org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter,String expressionPrefix) throws WbemsmtException  {

			
				super(adapter,expressionPrefix, "DnsZoneTracingContainer.caption",false);
    		...
    		icAllowTransferAcl 
				= new org.sblim.wbemsmt.jsf.dns.container.edit.DnsAllowTransferForZoneDataContainerImpl((org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter)org.sblim.wbemsmt.bl.adapter.CimAdapterFactory.getInstance()
                         				   .getAdapter(org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter.class,javax.faces.context.FacesContext.getCurrentInstance(),adapter.getCimClient())
					                     ,childBindingPrefix);
    				childBindingPrefix = this.expressionPrefix + "allowUpdateAcl.";
    		icAllowUpdateAcl 
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_ResourceRecordFile() {
    		if (ic_ResourceRecordFile == null)
    		{
				...
				String binding = expressionPrefix + "_ResourceRecordFile.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = true;
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_MasterAddresses() {
    		if (ic_usr_MasterAddresses == null)
    		{
				...
				String binding = expressionPrefix + "_usr_MasterAddresses.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = true;
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_TTLUnit() {
    		if (ic_TTLUnit == null)
    		{
				...
				String binding = expressionPrefix + "_TTLUnit.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.UnsignedInt16StringConverter();
				boolean readOnly = true;
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_NegativeCaching_TTL() {
    		if (ic_NegativeCaching_TTL == null)
    		{
				...
				String binding = expressionPrefix + "_NegativeCaching_TTL.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DoubleStringConverter();
				boolean readOnly = true;
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_NegativeCaching_TTLUnit() {
    		if (ic_usr_NegativeCaching_TTLUnit == null)
    		{
				...
				String binding = expressionPrefix + "_usr_NegativeCaching_TTLUnit.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.UnsignedInt16StringConverter();
				boolean readOnly = true;
		...
		*/
				public java.util.List<DnsResourceRecordDataContainer> getResourceRecords()
				{
		...
		public MultiLinePanel getResourceRecordsPanel()
		{
			...
			{
  			   resourceRecordsPanel = new ResourceRecordsPanel(adapter,expressionPrefix, // the prefix for binding values
							  "#{" +  expressionPrefix + "resourceRecordsPanel", // binding for Title
		...
		{
			public ResourceRecordsPanel(AbstractBaseCimAdapter adapter, String expressionPrefix, String bindigForTitle, String keyForTitle, int cols) {
				super(adapter, expressionPrefix, bindigForTitle, keyForTitle, "resourceRecords", cols);
			}
	...
	private void addResourceRecords(org.sblim.wbemsmt.jsf.dns.container.edit.DnsResourceRecordDataContainer_AsResourceRecords_InDnsZoneTracingContainerImpl child) {
	...
	*/
	public java.util.List<DnsResourceRecordDataContainer> getResourceRecordsForUI()
	{
				
		List<DnsResourceRecordDataContainer> result = new ArrayList<DnsResourceRecordDataContainer>();
		result.addAll(icResourceRecords);
		
		while (result.size() < MIN_TABLE_LENGTH)
		{
			try {
				org.sblim.wbemsmt.jsf.dns.container.edit.DnsResourceRecordDataContainer_AsResourceRecords_InDnsZoneTracingContainerImpl item = new org.sblim.wbemsmt.jsf.dns.container.edit.DnsResourceRecordDataContainer_AsResourceRecords_InDnsZoneTracingContainerImpl((org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter)adapter,expressionPrefix, result.size());
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getResourceRecordsHeader_TTL() {
    		if (icResourceRecordsHeader_TTL == null)
    		{
				...
				String binding = expressionPrefix + "resourceRecordsHeader_TTL.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				...
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent)icResourceRecordsHeader_TTL).setOrientation( org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT );    		}
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getResourceRecordsHeader_usr_TTLUnit() {
    		if (icResourceRecordsHeader_usr_TTLUnit == null)
    		{
				...
				String binding = expressionPrefix + "resourceRecordsHeader_usr_TTLUnit.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.UnsignedInt16StringConverter();
				boolean readOnly = false;
				...
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFComboBoxComponent)icResourceRecordsHeader_usr_TTLUnit).setOrientation( org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT );    		}
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getResourceRecordsHeader_usr_RemoveTTL() {
    		if (icResourceRecordsHeader_usr_RemoveTTL == null)
    		{
				...
				String binding = expressionPrefix + "resourceRecordsHeader_usr_RemoveTTL.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
				...
				((org.sblim.wbemsmt.tools.input.jsf.JSFButtonComponent)icResourceRecordsHeader_usr_RemoveTTL).setOrientation( org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT );    		}
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getResourceRecordsHeader_Name() {
    		if (icResourceRecordsHeader_Name == null)
    		{
				...
				String binding = expressionPrefix + "resourceRecordsHeader_Name.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
				...
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent)icResourceRecordsHeader_Name).setOrientation( org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT );    		}
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getResourceRecordsHeader_Type() {
    		if (icResourceRecordsHeader_Type == null)
    		{
				...
				String binding = expressionPrefix + "resourceRecordsHeader_Type.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.UnsignedInt16StringConverter();
				boolean readOnly = false;
				...
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFComboBoxComponent)icResourceRecordsHeader_Type).setOrientation( org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT );    		}
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getResourceRecordsHeader_Family() {
    		if (icResourceRecordsHeader_Family == null)
    		{
				...
				String binding = expressionPrefix + "resourceRecordsHeader_Family.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				...
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFComboBoxComponent)icResourceRecordsHeader_Family).setOrientation( org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT );    		}
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getResourceRecordsHeader_Value() {
    		if (icResourceRecordsHeader_Value == null)
    		{
				...
				String binding = expressionPrefix + "resourceRecordsHeader_Value.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
				...
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent)icResourceRecordsHeader_Value).setOrientation( org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT );    		}
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getResourceRecordsHeader_Priority() {
    		if (icResourceRecordsHeader_Priority == null)
    		{
				...
				String binding = expressionPrefix + "resourceRecordsHeader_Priority.item";
				logger.fine("Using binding " + binding);
				org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
				org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
				boolean readOnly = false;
    			icResourceRecordsHeader_Priority = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(parent,label,binding,converter, readOnly);
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent)icResourceRecordsHeader_Priority).setOrientation( org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT );    		}
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent)icResourceRecordsHeader_Priority).setHeader(true);
	...
	public void countAndCreateChildren() throws WbemsmtException {
    			...
    			try
		{
			int count = adapter.count("resourceRecords",org.sblim.wbemsmt.dns.bl.container.edit.DnsResourceRecordDataContainer.class, this);
	        if (count != resourceRecordsCount)
	        {
	           resourceRecordsCount = count;
	           clearResourceRecords();
			   for (int i=0; i < count ; i++) {
	    			addResourceRecords(new org.sblim.wbemsmt.jsf.dns.container.edit.DnsResourceRecordDataContainer_AsResourceRecords_InDnsZoneTracingContainerImpl((org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter)adapter,expressionPrefix, i));
			   }
	        }
	...
	public void copyFrom(DataContainer sourceContainer) throws WbemsmtException
	{
    	    		   ...
    	    		   List<DnsResourceRecordDataContainer> targetListForResourceRecords = getResourceRecords();
    		   List<DnsResourceRecordDataContainer> sourceListForResourceRecords = source.getResourceRecords();
