...
public class DnsMasterDataContainerImpl extends org.sblim.wbemsmt.tools.jsf.EditBasePanel implements
        org.sblim.wbemsmt.dns.bl.container.edit.DnsMasterDataContainer {
    ...
    public DnsMasterDataContainerImpl(org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter,
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_MasterElementType() {
        if (ic_MasterElementType == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_MasterElementType = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_MasterElement() {
        if (ic_MasterElement == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_MasterElement = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
            ;
        }
    ...
    public void reload() {
        ...
        if (ic_MasterElementType != null) {
            ic_MasterElementType.setLabelText(bundle
                    .getString("DnsMasterDataContainer.MasterElementType"));
        }
        if (ic_MasterElement != null) {
