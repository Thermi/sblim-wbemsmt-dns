...
public class DnsResourceRecordWizardPage2TypeMxDataContainerImpl extends
    ...
    public DnsResourceRecordWizardPage2TypeMxDataContainerImpl(
        ...
        super(adapter, bindingPrefix, "DnsResourceRecordWizardPage2TypeMxDataContainer.caption",
                "DnsResourceRecordWizardPage2TypeMxDataContainer.subTitle", false);
        ...
        setFooter(getPanelForCustomLayout(),
                "DnsResourceRecordWizardPage2TypeMxDataContainer.footerText");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Value() {
        if (ic_usr_Value == null) {
            String label = bundle
                    .getString("DnsResourceRecordWizardPage2TypeMxDataContainer.Value");
            String binding = bindingPrefix + "_usr_Value.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Value = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Priority() {
        if (ic_usr_Priority == null) {
            String label = bundle
                    .getString("DnsResourceRecordWizardPage2TypeMxDataContainer.Priority");
            String binding = bindingPrefix + "_usr_Priority.item";
            logger.fine("Using binding " + binding);
            org.sblim.wbemsmt.bl.adapter.DataContainer parent = this;
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = false;
            ic_usr_Priority = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputFieldComponent(
                    parent, label, binding, converter, readOnly);
