...
public class DnsStubZoneWizardSummaryDataContainerImpl extends
    ...
    public DnsStubZoneWizardSummaryDataContainerImpl(
            org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter, String bindingPrefix)
            throws WbemsmtException {

        super(adapter, bindingPrefix, "DnsStubZoneWizardSummaryDataContainer.caption",
                "DnsStubZoneWizardSummaryDataContainer.subTitle", false);
    ...
    public void reload() {
        ...
        if (ic_usr_Name != null) {
            ic_usr_Name
                    .setLabelText(bundle.getString("DnsStubZoneWizardSummaryDataContainer.Name"));
        }
        if (ic_usr_IpAdressses != null) {
            ic_usr_IpAdressses.setLabelText(bundle
                    .getString("DnsStubZoneWizardSummaryDataContainer.IpAdressses"));
        }
    }
