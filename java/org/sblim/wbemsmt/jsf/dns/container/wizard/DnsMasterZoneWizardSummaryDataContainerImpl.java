...
public class DnsMasterZoneWizardSummaryDataContainerImpl extends
    ...
    public DnsMasterZoneWizardSummaryDataContainerImpl(
        ...
        super(adapter, bindingPrefix, "DnsMasterZoneWizardSummaryDataContainer.caption",
                "DnsMasterZoneWizardSummaryDataContainer.subTitle", false);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Server() {
        if (ic_usr_Server == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = true;
            ic_usr_Server = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(parent,
                    label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_IpAdress() {
        if (ic_usr_IpAdress == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = true;
            ic_usr_IpAdress = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Contact() {
        if (ic_usr_Contact == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = true;
            ic_usr_Contact = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(parent,
                    label, binding, converter, readOnly);
            ;
        }
    ...
    public void reload() {
        ...
        if (ic_usr_Name != null) {
            ic_usr_Name.setLabelText(bundle
                    .getString("DnsMasterZoneWizardSummaryDataContainer.Name"));
        }
        if (ic_usr_Server != null) {
            ic_usr_Server.setLabelText(bundle
                    .getString("DnsMasterZoneWizardSummaryDataContainer.Server"));
        }
        if (ic_usr_IpAdress != null) {
            ic_usr_IpAdress.setLabelText(bundle
                    .getString("DnsMasterZoneWizardSummaryDataContainer.IpAdress"));
        }
        if (ic_usr_Contact != null) {
            ic_usr_Contact.setLabelText(bundle
                    .getString("DnsMasterZoneWizardSummaryDataContainer.Contact"));
        }
    }
