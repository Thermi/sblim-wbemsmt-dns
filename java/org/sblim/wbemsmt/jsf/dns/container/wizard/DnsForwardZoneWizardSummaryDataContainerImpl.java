	...
	public DnsForwardZoneWizardSummaryDataContainerImpl(org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter,String bindingPrefix) throws InitContainerException  {
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_NewForwarder() {
    		...
    		{
				String label = bundle.getString("DnsForwardZoneWizardSummaryDataContainer.newForwarder");
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_NewForwarderType() {
    		...
    		{
				String label = bundle.getString("DnsForwardZoneWizardSummaryDataContainer.newForwarderType");
	...
	public void reload()
	{
		super.reload();
	    		...
	    		if (ic_Forwarders != null)
    		{
	    		...
	    		if (ic_usr_RemoveForwarder != null)
    		{
				ic_usr_RemoveForwarder.setLabelText(bundle.getString("DnsForwardZoneWizardSummaryDataContainer.removeForwarder"));
    		}
	    		if (ic_usr_NewForwarder != null)
    		{
				ic_usr_NewForwarder.setLabelText(bundle.getString("DnsForwardZoneWizardSummaryDataContainer.newForwarder"));
    		}
	    		if (ic_usr_AddForwarder != null)
    		{
				ic_usr_AddForwarder.setLabelText(bundle.getString("DnsForwardZoneWizardSummaryDataContainer.addForwarder"));
    		}
	    		if (ic_usr_NewForwarderType != null)
    		{
				ic_usr_NewForwarderType.setLabelText(bundle.getString("DnsForwardZoneWizardSummaryDataContainer.newForwarderType"));
    		}
	    		if (ic_usr_Name != null)
    		{
