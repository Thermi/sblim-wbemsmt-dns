...
public class DnsReverseZoneWizardSummaryDataContainerImpl extends org.sblim.wbemsmt.tools.wizard.jsf.WizardBasePanel implements org.sblim.wbemsmt.dns.bl.container.wizard.DnsReverseZoneWizardSummaryDataContainer
	...
	public DnsReverseZoneWizardSummaryDataContainerImpl(org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter,String expressionPrefix) throws WbemsmtException  {

			
				super(adapter,expressionPrefix, "DnsReverseZoneWizardSummaryDataContainer.caption","DnsReverseZoneWizardSummaryDataContainer.subTitle",false);
	...
	private void addResourceRecords(org.sblim.wbemsmt.jsf.dns.container.edit.DnsResourceRecordForReverseZoneWizardDataContainer_AsResourceRecords_InDnsReverseZoneWizardSummaryDataContainerImpl child) {
	...
	*/
	public java.util.List<DnsResourceRecordForReverseZoneWizardDataContainer> getResourceRecordsForUI()
	{
				
		List<DnsResourceRecordForReverseZoneWizardDataContainer> result = new ArrayList<DnsResourceRecordForReverseZoneWizardDataContainer>();
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getResourceRecordsHeader_Name() {
    		if (icResourceRecordsHeader_Name == null)
    		{
				...
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent)icResourceRecordsHeader_Name).setOrientation( org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT );    		}
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseHeaderComponentIf getResourceRecordsHeader_Type() {
    		if (icResourceRecordsHeader_Type == null)
    		{
				...
				((org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent)icResourceRecordsHeader_Type).setOrientation( org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf.LEFT );    		}
	...
	public void countAndCreateChildren() throws WbemsmtException {
    			...
    			try
		{
			int count = adapter.count("resourceRecords",org.sblim.wbemsmt.dns.bl.container.wizard.DnsResourceRecordForReverseZoneWizardDataContainer.class, this);
	        if (count != resourceRecordsCount)
	        {
	           resourceRecordsCount = count;
	           clearResourceRecords();
			   for (int i=0; i < count ; i++) {
	    			addResourceRecords(new org.sblim.wbemsmt.jsf.dns.container.edit.DnsResourceRecordForReverseZoneWizardDataContainer_AsResourceRecords_InDnsReverseZoneWizardSummaryDataContainerImpl((org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter)adapter,expressionPrefix, i));
			   }
	        }
