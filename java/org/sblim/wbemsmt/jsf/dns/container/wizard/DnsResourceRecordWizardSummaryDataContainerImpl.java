...
public class DnsResourceRecordWizardSummaryDataContainerImpl extends
    ...
    public DnsResourceRecordWizardSummaryDataContainerImpl(
        ...
        super(adapter, bindingPrefix, "DnsResourceRecordWizardSummaryDataContainer.caption",
                "DnsResourceRecordWizardSummaryDataContainer.subTitle", false);
        ...
        setFooter(getPanelForCustomLayout(),
                "DnsResourceRecordWizardSummaryDataContainer.footerText");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Value() {
        if (ic_usr_Value == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = true;
            ic_usr_Value = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(parent,
                    label, binding, converter, readOnly);
            ;
        }
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_Priority() {
        if (ic_usr_Priority == null) {
            ...
            org.sblim.wbemsmt.tools.converter.Converter converter = new org.sblim.wbemsmt.tools.converter.test.DummyConverter();
            boolean readOnly = true;
            ic_usr_Priority = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFLabelComponent(
    ...
    public void reload() {
        ...
        if (ic_usr_Name != null) {
            ic_usr_Name.setLabelText(bundle
                    .getString("DnsResourceRecordWizardSummaryDataContainer.Name"));
        }
        if (ic_usr_Type != null) {
            ic_usr_Type.setLabelText(bundle
                    .getString("DnsResourceRecordWizardSummaryDataContainer.Type"));
        }
        if (ic_usr_Value != null) {
            ic_usr_Value.setLabelText(bundle
                    .getString("DnsResourceRecordWizardSummaryDataContainer.Value"));
        }
        if (ic_usr_Priority != null) {
            ic_usr_Priority.setLabelText(bundle
                    .getString("DnsResourceRecordWizardSummaryDataContainer.Priority"));
        }
    }
