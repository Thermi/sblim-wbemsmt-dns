/** 
  * DnsMastersWizardSummaryDataContainerImpl.java
  *
  * 
...
public class DnsMastersWizardSummaryDataContainerImpl extends org.sblim.wbemsmt.tools.wizard.jsf.WizardBasePanel implements org.sblim.wbemsmt.dns.bl.container.wizard.DnsMastersWizardSummaryDataContainer
	{
	...
	public DnsMastersWizardSummaryDataContainerImpl(org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter,String expressionPrefix) throws WbemsmtException  {

			
				super(adapter,expressionPrefix, "DnsMastersWizardSummaryDataContainer.caption","DnsMastersWizardSummaryDataContainer.subTitle",false);
		...
		setFooter(getPanelForCustomLayout(),"DnsMastersWizardSummaryDataContainer.footerText");
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_Name() {
    		if (ic_Name == null)
    		{
				String label = bundle.getString("DnsMastersWizardSummaryDataContainer.Name");
		...
		*/
		...
		public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_AddressList() {
    		...
    		{
				String label = bundle.getString("DnsMastersWizardSummaryDataContainer.AddressList");
	...
	public void reload()
	{
		super.reload();
	    		if (ic_Name != null)
    		{
				ic_Name.setLabelText(bundle.getString("DnsMastersWizardSummaryDataContainer.Name"));
    		}
	    		if (ic_AddressList != null)
    		{
				ic_AddressList.setLabelText(bundle.getString("DnsMastersWizardSummaryDataContainer.AddressList"));
    		}
		}
