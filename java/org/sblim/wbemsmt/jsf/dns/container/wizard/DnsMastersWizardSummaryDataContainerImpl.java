...
public class DnsMastersWizardSummaryDataContainerImpl extends
        org.sblim.wbemsmt.tools.wizard.jsf.WizardBasePanel implements
        org.sblim.wbemsmt.dns.bl.container.wizard.DnsMastersWizardSummaryDataContainer {
    private org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf ic_Name;
    private org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf ic_AddressList;

    public DnsMastersWizardSummaryDataContainerImpl(
        ...
        super(adapter, bindingPrefix, "DnsMastersWizardSummaryDataContainer.caption",
                "DnsMastersWizardSummaryDataContainer.subTitle", false);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_AddressList() {
        if (ic_AddressList == null) {
            ...
            boolean readOnly = true;
            ic_AddressList = new org.sblim.wbemsmt.tools.input.jsf.LabeledJSFListComponent(parent,
    ...
    public void reload() {
        ...
        if (ic_AddressList != null) {
            ic_AddressList.setLabelText(bundle
                    .getString("DnsMastersWizardSummaryDataContainer.AddressList"));
        }
    }
