...
public class DnsSlaveZoneWizardPage1DataContainerImpl extends
        org.sblim.wbemsmt.tools.wizard.jsf.WizardBasePanel implements
        org.sblim.wbemsmt.dns.bl.container.wizard.DnsSlaveZoneWizardPage1DataContainer {
    ...
    public DnsSlaveZoneWizardPage1DataContainerImpl(
        ...
        super(adapter, bindingPrefix, "DnsSlaveZoneWizardPage1DataContainer.caption",
                "DnsSlaveZoneWizardPage1DataContainer.subTitle", false);
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_RemoveMasterEntry() {
        if (ic_usr_RemoveMasterEntry == null) {
            String label = bundle
                    .getString("DnsSlaveZoneWizardPage1DataContainer.removeMasterEntry");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_AddNewMasterEntry() {
        if (ic_usr_AddNewMasterEntry == null) {
            String label = bundle
                    .getString("DnsSlaveZoneWizardPage1DataContainer.addNewMasterEntry");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_AddPredefinedMaster() {
        if (ic_usr_AddPredefinedMaster == null) {
            String label = bundle
                    .getString("DnsSlaveZoneWizardPage1DataContainer.addPredefinedMaster");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_PredefinedMasters() {
        if (ic_usr_PredefinedMasters == null) {
            String label = bundle
                    .getString("DnsSlaveZoneWizardPage1DataContainer.predefinedMasters");
    ...
    public void reload() {
        super.reload();
        if (ic_Masters != null) {
            ic_Masters.setLabelText(bundle
                    .getString("DnsSlaveZoneWizardPage1DataContainer.masters"));
        }
        if (ic_usr_RemoveMasterEntry != null) {
        ...
        if (ic_usr_NewMasterEntry != null) {
            ic_usr_NewMasterEntry.setLabelText(bundle
                    .getString("DnsSlaveZoneWizardPage1DataContainer.newMasterEntry"));
        }
        if (ic_usr_AddNewMasterEntry != null) {
