...
public class DnsAddressMatchListWizardSummaryDataContainerImpl extends
    ...
    public DnsAddressMatchListWizardSummaryDataContainerImpl(
        ...
        super(adapter, bindingPrefix, "DnsAddressMatchListWizardSummaryDataContainer.caption",
                "DnsAddressMatchListWizardSummaryDataContainer.subTitle", false);
        ...
        setFooter(getPanelForCustomLayout(),
                "DnsAddressMatchListWizardSummaryDataContainer.footerText");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_AddressList() {
        if (ic_AddressList == null) {
            String label = bundle
                    .getString("DnsAddressMatchListWizardSummaryDataContainer.AddressList");
    ...
    public void reload() {
        ...
        if (ic_Name != null) {
            ic_Name.setLabelText(bundle
                    .getString("DnsAddressMatchListWizardSummaryDataContainer.Name"));
        }
        if (ic_AddressList != null) {
