...
public class DnsAddressMatchListWizardPage1DataContainerImpl extends
    ...
    public DnsAddressMatchListWizardPage1DataContainerImpl(
        ...
        super(adapter, bindingPrefix, "DnsAddressMatchListWizardPage1DataContainer.caption",
                "DnsAddressMatchListWizardPage1DataContainer.subTitle", false);
        ...
        setFooter(getPanelForCustomLayout(),
                "DnsAddressMatchListWizardPage1DataContainer.footerText");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_AddressList() {
        if (ic_AddressList == null) {
            String label = bundle
                    .getString("DnsAddressMatchListWizardPage1DataContainer.AddressList");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_RemoveAddress() {
        if (ic_usr_RemoveAddress == null) {
            String label = bundle
                    .getString("DnsAddressMatchListWizardPage1DataContainer.removeAddress");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledStringArrayInputComponentIf get_usr_UserAddresses() {
        if (ic_usr_UserAddresses == null) {
            String label = bundle
                    .getString("DnsAddressMatchListWizardPage1DataContainer.userAddresses");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_NewAddress() {
        if (ic_usr_NewAddress == null) {
            String label = bundle
                    .getString("DnsAddressMatchListWizardPage1DataContainer.newAddress");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_AddPredefinedAddress() {
        if (ic_usr_AddPredefinedAddress == null) {
            String label = bundle
                    .getString("DnsAddressMatchListWizardPage1DataContainer.addPredefinedAddress");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_AddNewAddress() {
        if (ic_usr_AddNewAddress == null) {
            String label = bundle
                    .getString("DnsAddressMatchListWizardPage1DataContainer.addNewAddress");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_AddressUp() {
        if (ic_usr_AddressUp == null) {
            String label = bundle
                    .getString("DnsAddressMatchListWizardPage1DataContainer.addressUp");
    ...
    public org.sblim.wbemsmt.tools.input.LabeledBaseInputComponentIf get_usr_AddressDown() {
        if (ic_usr_AddressDown == null) {
            String label = bundle
                    .getString("DnsAddressMatchListWizardPage1DataContainer.addressDown");
    ...
    public void reload() {
        ...
        if (ic_Name != null) {
            ic_Name.setLabelText(bundle
                    .getString("DnsAddressMatchListWizardPage1DataContainer.Name"));
        }
    }
