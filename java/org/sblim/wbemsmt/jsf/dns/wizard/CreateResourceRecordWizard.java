...
public class CreateResourceRecordWizard extends JSFWizardBase implements IPageWizardAdapter {
    ...
    org.sblim.wbemsmt.jsf.dns.container.wizard.DnsResourceRecordWizardPage1DataContainerImpl panel1 = null;
    org.sblim.wbemsmt.jsf.dns.container.wizard.DnsResourceRecordWizardSummaryDataContainerImpl panel2 = null;
    org.sblim.wbemsmt.jsf.dns.container.edit.DnsResourceRecordWizardPage2TypeMxDataContainerImpl panel3 = null;
    org.sblim.wbemsmt.jsf.dns.container.edit.DnsResourceRecordWizardPage2TypeOtherDataContainerImpl panel4 = null;
    ...
    public CreateResourceRecordWizard(final org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter) {
        super(adapter, ResourceBundleManager.getResourceBundle(new String[] { "messages",
                ...
                .getCurrentLocale()), "CreateResourceRecordWizard.title");
        ...
        this.container = new org.sblim.wbemsmt.dns.wizard.CreateResourceRecordWizardContainer(
                ...
                new org.sblim.wbemsmt.dns.wizard.CreateResourceRecordWizardContainerPanels() {
                    ...
                    public DataContainer getMain() throws WbemsmtException {
                        ...
                        try {
                            panel1 = new org.sblim.wbemsmt.jsf.dns.container.wizard.DnsResourceRecordWizardPage1DataContainerImpl(
                                    adapter, binding);
                            ...
                            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
                                    "Cannot process Wizard createResourceRecordWizard", e);
                        }
                    }
                    ...
                    public DataContainer getOverview() throws WbemsmtException {
                        ...
                        try {
                            panel2 = new org.sblim.wbemsmt.jsf.dns.container.wizard.DnsResourceRecordWizardSummaryDataContainerImpl(
                                    adapter, binding);
                    ...
                    public DataContainer getTypeMx() throws WbemsmtException {
                        ...
                        try {
                            panel3 = new org.sblim.wbemsmt.jsf.dns.container.edit.DnsResourceRecordWizardPage2TypeMxDataContainerImpl(
                                    adapter, binding);
                    ...
                    public DataContainer getTypeOther() throws WbemsmtException {
                        ...
                        try {
                            panel4 = new org.sblim.wbemsmt.jsf.dns.container.edit.DnsResourceRecordWizardPage2TypeOtherDataContainerImpl(
                                    adapter, binding);
    ...
    public void countAndCreateChilds(DataContainer dataContainer) throws WbemsmtException {
        ...
        if (dataContainer instanceof org.sblim.wbemsmt.jsf.dns.container.wizard.DnsResourceRecordWizardSummaryDataContainerImpl) {
            //update the child objects
            try {
        ...
        if (dataContainer instanceof org.sblim.wbemsmt.jsf.dns.container.edit.DnsResourceRecordWizardPage2TypeMxDataContainerImpl) {
            //update the child objects
            try {
        ...
        if (dataContainer instanceof org.sblim.wbemsmt.jsf.dns.container.edit.DnsResourceRecordWizardPage2TypeOtherDataContainerImpl) {
            //update the child objects
            try {
    ...
    public String getFinishText() {
        return bundle.getString("CreateResourceRecordWizard.finishText", bundle
                .getString("wizard.finishText"));
    }

    public String getJavaScriptWaitStatement() {
        String text = bundle.getString("CreateResourceRecordWizard.createWaitText", bundle
