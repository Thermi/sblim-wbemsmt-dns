...
public class MasterWizard extends JSFWizardBase implements IPageWizardAdapter {
    ...
    public MasterWizard(final org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter) {
        super(adapter, ResourceBundleManager.getResourceBundle(new String[] { "messages",
                ...
                .getCurrentLocale()), "MasterWizard.title");
        ...
        this.container = new org.sblim.wbemsmt.dns.wizard.MasterWizardContainer(adapter,
                new org.sblim.wbemsmt.dns.wizard.MasterWizardContainerPanels() {
                    ...
                    public DataContainer getPage1() throws WbemsmtException {
                        ...
                        try {
                            panel1 = new org.sblim.wbemsmt.jsf.dns.container.wizard.DnsMastersWizardPage1DataContainerImpl(
                                    adapter, binding);
                            ...
                            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
                                    "Cannot process Wizard MasterWizard", e);
                        }
                    }
                    ...
                    public DataContainer getSummary() throws WbemsmtException {
                        ...
                        try {
                            panel2 = new org.sblim.wbemsmt.jsf.dns.container.wizard.DnsMastersWizardSummaryDataContainerImpl(
                                    adapter, binding);
    ...
    public String getJavaScriptWaitStatement() {
        String text = bundle.getString("MasterWizard.createWaitText", bundle
