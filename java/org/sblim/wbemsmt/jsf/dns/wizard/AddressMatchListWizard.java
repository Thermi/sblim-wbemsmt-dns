		...
		this.container = new org.sblim.wbemsmt.dns.wizard.AddressMatchListWizardContainer (adapter,new org.sblim.wbemsmt.dns.wizard.AddressMatchListWizardContainerPanels()
 			{
					...
					public Object getPage1() throws WbemSmtException
					{
						...
						try
						{
							    						panel1= new org.sblim.wbemsmt.jsf.dns.container.wizard.DnsAddressMatchListWizardPage1DataContainerImpl(adapter,binding);
						...
						{
							throw new WbemSmtException("Cannot process Wizard AddressMatchListWizard",e);
						}
    				}
            						//update the child objects
					...
					public Object getSummary() throws WbemSmtException
					{
						...
						try
						{
							    						panel2= new org.sblim.wbemsmt.jsf.dns.container.wizard.DnsAddressMatchListWizardSummaryDataContainerImpl(adapter,binding);
   ...
   //Workaround for a bug within myFaces - Everytime a new panel is created the childs are created also
	...
	public void countAndCreateChilds(DataContainer dataContainer) throws UpdateControlsException {
            						if (dataContainer instanceof org.sblim.wbemsmt.jsf.dns.container.wizard.DnsAddressMatchListWizardPage1DataContainerImpl)
					{
						...
						{
							throw new UpdateControlsException("Cannot process Wizard AddressMatchListWizard",e);
						}
    				}
