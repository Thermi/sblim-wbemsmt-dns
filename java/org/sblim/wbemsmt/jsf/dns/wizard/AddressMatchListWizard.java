/**
 * AddressMatchListWizard.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class AddressMatchListWizard extends JSFWizardBase implements IPageWizardAdapter {
    ...
    org.sblim.wbemsmt.jsf.dns.container.wizard.DnsAddressMatchListWizardPage1DataContainerImpl panel1 = null;
    org.sblim.wbemsmt.jsf.dns.container.wizard.DnsAddressMatchListWizardSummaryDataContainerImpl panel2 = null;
    ...
    public AddressMatchListWizard(final org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter) {
        super(adapter, ResourceBundleManager.getResourceBundle(new String[] { "messages",
                ...
                .getCurrentLocale()), "AddressMatchListWizard.title");
        this.adapter = adapter;
        this.container = new org.sblim.wbemsmt.dns.wizard.AddressMatchListWizardContainer(adapter,
                new org.sblim.wbemsmt.dns.wizard.AddressMatchListWizardContainerPanels() {
                    ...
                    public DataContainer getPage1() throws WbemsmtException {
                        ...
                        try {
                            panel1 = new org.sblim.wbemsmt.jsf.dns.container.wizard.DnsAddressMatchListWizardPage1DataContainerImpl(
                                    adapter, binding);
                            ...
                            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
                                    "Cannot process Wizard AddressMatchListWizard", e);
                        }
                    }
                    ...
                    public DataContainer getSummary() throws WbemsmtException {
                        ...
                        try {
                            panel2 = new org.sblim.wbemsmt.jsf.dns.container.wizard.DnsAddressMatchListWizardSummaryDataContainerImpl(
                                    adapter, binding);
    ...
    public void countAndCreateChilds(DataContainer dataContainer) throws WbemsmtException {
        ...
        if (dataContainer instanceof org.sblim.wbemsmt.jsf.dns.container.wizard.DnsAddressMatchListWizardSummaryDataContainerImpl) {
            //update the child objects
            try {
    ...
    public String getFinishText() {
        return bundle.getString("AddressMatchListWizard.finishText", bundle
                .getString("wizard.finishText"));
    }

    public String getJavaScriptWaitStatement() {
        String text = bundle.getString("AddressMatchListWizard.createWaitText", bundle
