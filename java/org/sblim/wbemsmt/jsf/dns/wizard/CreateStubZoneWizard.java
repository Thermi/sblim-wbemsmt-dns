/**
 * CreateStubZoneWizard.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS
 ...
 *            Karnam<prkarnam@in.ibm.com> Description: Wizard for StubZones generated Class
 */
...
public class CreateStubZoneWizard extends JSFWizardBase implements IPageWizardAdapter {
    ...
    org.sblim.wbemsmt.jsf.dns.container.wizard.DnsStubZoneWizardPage1DataContainerImpl panel1 = null;
    org.sblim.wbemsmt.jsf.dns.container.wizard.DnsStubZoneWizardSummaryDataContainerImpl panel2 = null;
    ...
    public CreateStubZoneWizard(final org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter) {
        super(adapter, ResourceBundleManager.getResourceBundle(new String[] { "messages",
                ...
                .getCurrentLocale()), "CreateStubZoneWizard.title");
        ...
        this.container = new org.sblim.wbemsmt.dns.wizard.CreateStubZoneWizardContainer(adapter,
                new org.sblim.wbemsmt.dns.wizard.CreateStubZoneWizardContainerPanels() {
                    ...
                    public DataContainer getMain() throws WbemsmtException {
                        ...
                        try {
                            panel1 = new org.sblim.wbemsmt.jsf.dns.container.wizard.DnsStubZoneWizardPage1DataContainerImpl(
                                    adapter, binding);
                            ...
                            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
                                    "Cannot process Wizard createStubZoneWizard", e);
                        }
                    }
                    ...
                    public DataContainer getOverview() throws WbemsmtException {
                        ...
                        try {
                            panel2 = new org.sblim.wbemsmt.jsf.dns.container.wizard.DnsStubZoneWizardSummaryDataContainerImpl(
                                    adapter, binding);
    ...
    public void countAndCreateChilds(DataContainer dataContainer) throws WbemsmtException {
        if (dataContainer instanceof org.sblim.wbemsmt.jsf.dns.container.wizard.DnsStubZoneWizardPage1DataContainerImpl) {
            //update the child objects
            try {
        ...
        if (dataContainer instanceof org.sblim.wbemsmt.jsf.dns.container.wizard.DnsStubZoneWizardSummaryDataContainerImpl) {
            //update the child objects
            try {
    ...
    public String getFinishText() {
        return bundle.getString("CreateStubZoneWizard.finishText", bundle
                .getString("wizard.finishText"));
    }

    public String getJavaScriptWaitStatement() {
        String text = bundle.getString("CreateStubZoneWizard.createWaitText", bundle
