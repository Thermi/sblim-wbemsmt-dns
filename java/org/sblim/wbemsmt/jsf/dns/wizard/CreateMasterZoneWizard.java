		...
		this.container = new org.sblim.wbemsmt.dns.wizard.CreateMasterZoneWizardContainer (adapter,new org.sblim.wbemsmt.dns.wizard.CreateMasterZoneWizardContainerPanels()
 			{
					...
					public Object getMain() throws WbemSmtException
					{
						...
						try
						{
							    						panel1= new org.sblim.wbemsmt.jsf.dns.container.wizard.DnsMasterZoneWizardPage1DataContainerImpl(adapter,binding);
						...
						{
							throw new WbemSmtException("Cannot process Wizard createMasterZoneWizard",e);
						}
    				}
            						//update the child objects
					...
					public Object getOverview() throws WbemSmtException
					{
						...
						try
						{
							    						panel2= new org.sblim.wbemsmt.jsf.dns.container.wizard.DnsMasterZoneWizardSummaryDataContainerImpl(adapter,binding);
   ...
   //Workaround for a bug within myFaces - Everytime a new panel is created the childs are created also
	...
	public void countAndCreateChilds(DataContainer dataContainer) throws UpdateControlsException {
            						if (dataContainer instanceof org.sblim.wbemsmt.jsf.dns.container.wizard.DnsMasterZoneWizardPage1DataContainerImpl)
					{
						...
						{
							throw new UpdateControlsException("Cannot process Wizard createMasterZoneWizard",e);
						}
    				}
	...
	{
		String text = bundle.getString("CreateMasterZoneWizard.createWaitText",bundle.getString("wizard.createWaitText"));
