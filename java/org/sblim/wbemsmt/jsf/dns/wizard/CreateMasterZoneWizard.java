/**
 * CreateMasterZoneWizard.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
 ...
 *            Karnam<prkarnam@in.ibm.com> Description: Wizard for MasterZones generated Class
 */
...
public class CreateMasterZoneWizard extends JSFWizardBase implements IPageWizardAdapter {

    private org.sblim.wbemsmt.dns.wizard.CreateMasterZoneWizardContainer container = null;

    String binding = "objectActionController.currentWizard.currentPanel.";

    org.sblim.wbemsmt.jsf.dns.container.wizard.DnsMasterZoneWizardPage1DataContainerImpl panel1 = null;
    org.sblim.wbemsmt.jsf.dns.container.wizard.DnsMasterZoneWizardSummaryDataContainerImpl panel2 = null;
    ...
    public CreateMasterZoneWizard(final org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter) {
        super(adapter, ResourceBundleManager.getResourceBundle(new String[] { "messages",
                ...
                .getCurrentLocale()), "CreateMasterZoneWizard.title");
        this.adapter = adapter;
        this.container = new org.sblim.wbemsmt.dns.wizard.CreateMasterZoneWizardContainer(adapter,
                new org.sblim.wbemsmt.dns.wizard.CreateMasterZoneWizardContainerPanels() {
                    ...
                    public DataContainer getMain() throws WbemsmtException {
                        ...
                        try {
                            panel1 = new org.sblim.wbemsmt.jsf.dns.container.wizard.DnsMasterZoneWizardPage1DataContainerImpl(
                                    adapter, binding);
                            ...
                            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
                                    "Cannot process Wizard createMasterZoneWizard", e);
                        }
                    }
                    ...
                    public DataContainer getOverview() throws WbemsmtException {
                        ...
                        try {
                            panel2 = new org.sblim.wbemsmt.jsf.dns.container.wizard.DnsMasterZoneWizardSummaryDataContainerImpl(
                                    adapter, binding);
    ...
    public void countAndCreateChilds(DataContainer dataContainer) throws WbemsmtException {
        ...
        if (dataContainer instanceof org.sblim.wbemsmt.jsf.dns.container.wizard.DnsMasterZoneWizardSummaryDataContainerImpl) {
            //update the child objects
            try {
    ...
    public String getFinishText() {
        return bundle.getString("CreateMasterZoneWizard.finishText", bundle
                .getString("wizard.finishText"));
    }

    public String getJavaScriptWaitStatement() {
        String text = bundle.getString("CreateMasterZoneWizard.createWaitText", bundle
