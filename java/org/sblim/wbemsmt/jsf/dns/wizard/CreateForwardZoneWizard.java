/**
 * CreateForwardZoneWizard.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
 ...
 *            Karnam<prkarnam@in.ibm.com> Description: Wizard forForwardZones generated Class
 */
...
public class CreateForwardZoneWizard extends JSFWizardBase implements IPageWizardAdapter {
    ...
    public CreateForwardZoneWizard(final org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter) {
        super(adapter, ResourceBundleManager.getResourceBundle(new String[] { "messages",
                ...
                .getCurrentLocale()), "CreateForwardZoneWizard.title");
        this.adapter = adapter;
        this.container = new org.sblim.wbemsmt.dns.wizard.CreateForwardZoneWizardContainer(adapter,
                new org.sblim.wbemsmt.dns.wizard.CreateForwardZoneWizardContainerPanels() {
                    ...
                    public DataContainer getMain() throws WbemsmtException {
                        ...
                        try {
                            panel1 = new org.sblim.wbemsmt.jsf.dns.container.wizard.DnsForwardZoneWizardPage1DataContainerImpl(
                                    adapter, binding);
                            ...
                            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
                                    "Cannot process Wizard createForwardZoneWizard", e);
                        }
                    }
                    ...
                    public DataContainer getOverview() throws WbemsmtException {
                        ...
                        try {
                            panel2 = new org.sblim.wbemsmt.jsf.dns.container.wizard.DnsForwardZoneWizardSummaryDataContainerImpl(
                                    adapter, binding);
                            ...
                            panel2.getLayouter().layout(panel2.getPanelForCustomLayout(), panel2,
                                    bundle);
    ...
    public String getFinishText() {
        return bundle.getString("CreateForwardZoneWizard.finishText", bundle
                .getString("wizard.finishText"));
    }

    public String getJavaScriptWaitStatement() {
        String text = bundle.getString("CreateForwardZoneWizard.createWaitText", bundle
