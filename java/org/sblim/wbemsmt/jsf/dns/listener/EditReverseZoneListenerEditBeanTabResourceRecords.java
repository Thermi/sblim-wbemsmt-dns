/**
 * EditReverseZoneListenerEditBeanTabResourceRecords.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE
...
public class EditReverseZoneListenerEditBeanTabResourceRecords extends EditBean {

    private org.sblim.wbemsmt.jsf.dns.container.edit.DnsResourceRecordListContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public EditReverseZoneListenerEditBeanTabResourceRecords() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container DnsResourceRecordListContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        expressionPrefix = "objectActionController.editBeans['TabResourceRecords'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.jsf.dns.container.edit.DnsResourceRecordListContainerImpl(
        ...
        {
            HtmlPanelGrid childPanel = currentEditContainer1.getResourceRecordsPanel()
                    .getOuterPanel();
            childPanel.setId(org.sblim.wbemsmt.tools.input.jsf.LabeledJSFInputComponent
                    .asJsfId("editResourceRecordsChild_resourceRecords"));
        ...
        addFooter(panel, "objectActionController.editBeans['TabResourceRecords'].");
