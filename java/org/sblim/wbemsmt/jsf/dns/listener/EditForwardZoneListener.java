/**
 * EditForwardZoneListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class EditForwardZoneListener extends JsfEditListener {
    ...
    public String processEvent(TaskLauncherTreeNodeEvent event) throws WbemsmtException {
        ...
        helpManager.setCurrentTopic("dns", "EditForwardZoneListener");
        ...
        bean = new org.sblim.wbemsmt.jsf.dns.listener.EditForwardZoneListenerEditBeanFieldTab();
        editBeans.add(bean);
        bean.edit(treeNode);
