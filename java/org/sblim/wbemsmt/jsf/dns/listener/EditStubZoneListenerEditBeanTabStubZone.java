/**
 * EditStubZoneListenerEditBeanTabStubZone.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS
...
public class EditStubZoneListenerEditBeanTabStubZone extends EditBean {

    private org.sblim.wbemsmt.jsf.dns.container.edit.DnsStubZoneDataContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public EditStubZoneListenerEditBeanTabStubZone() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container DnsStubZoneDataContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        expressionPrefix = "objectActionController.editBeans['TabStubZone'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.jsf.dns.container.edit.DnsStubZoneDataContainerImpl(
        ...
        addFooter(panel, "objectActionController.editBeans['TabStubZone'].");
