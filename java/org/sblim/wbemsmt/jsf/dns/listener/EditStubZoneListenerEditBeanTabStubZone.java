/** 
  * EditStubZoneListenerEditBeanTabStubZone.java
  *
...
public class EditStubZoneListenerEditBeanTabStubZone extends EditBean {
		...
		public void edit(ITaskLauncherTreeNode treeNode) throws ObjectNotFoundException, UpdateControlsException, CountException, InitContainerException
		{
			...
			UIPanel panelToAdd= null;
				...
				bindingPrefix = "objectActionController.editBeans['TabStubZone'].containers[0].";
				

				//create cotainner
    			currentEditContainer1 = new org.sblim.wbemsmt.jsf.dns.container.edit.DnsStubZoneDataContainerImpl(adapter1,bindingPrefix);
