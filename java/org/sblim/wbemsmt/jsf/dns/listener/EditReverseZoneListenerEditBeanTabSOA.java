/** 
  * EditReverseZoneListenerEditBeanTabSOA.java
  *
...
public class EditReverseZoneListenerEditBeanTabSOA extends EditBean {
		...
		public void edit(ITaskLauncherTreeNode treeNode) throws ObjectNotFoundException, UpdateControlsException, CountException, InitContainerException
		{
			...
			UIPanel panelToAdd= null;
				...
				bindingPrefix = "objectActionController.editBeans['TabSOA'].containers[0].";
				

				//create cotainner
    			currentEditContainer1 = new org.sblim.wbemsmt.jsf.dns.container.edit.DnsSoaContainerImpl(adapter1,bindingPrefix);
