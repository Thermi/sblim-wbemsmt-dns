/**
 * EditReverseZoneListenerEditBeanTabSOA.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED
...
public class EditReverseZoneListenerEditBeanTabSOA extends EditBean {

    private org.sblim.wbemsmt.jsf.dns.container.edit.DnsSoaContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public EditReverseZoneListenerEditBeanTabSOA() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container DnsSoaContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        selector.select(treeNode, adapter1, "editSOA");

        adapter1.setActiveModule(AbstractBaseCimAdapter.ACTIVE_EDIT);

        //ADD THE FIELDS FOR CONTAINER DnsSoaContainer in EditPanel ${editPanel.getId()}

        expressionPrefix = "objectActionController.editBeans['TabSOA'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.jsf.dns.container.edit.DnsSoaContainerImpl(
        ...
        addFooter(panel, "objectActionController.editBeans['TabSOA'].");
