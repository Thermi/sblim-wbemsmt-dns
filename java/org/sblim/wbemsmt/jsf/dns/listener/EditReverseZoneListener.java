/**
 * EditReverseZoneListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class EditReverseZoneListener extends JsfEditListener {
    ...
    public String processEvent(TaskLauncherTreeNodeEvent event) throws WbemsmtException {
        ...
        helpManager.setCurrentTopic("dns", "EditReverseZoneListener");
        ...
        //ADD THE CONTAINERS IN TAB TabReverseZone			
        bean = new org.sblim.wbemsmt.jsf.dns.listener.EditReverseZoneListenerEditBeanTabReverseZone();
        editBeans.add(bean);
        bean.edit(treeNode);
        oac.addEditBean("TabReverseZone", bean);
        bundleKey = "tab.TabReverseZone";
        tabbedPane.addTab("TabReverseZone", bundleKey, bean.getPanel());

        //ADD THE CONTAINERS IN TAB TabAcl			
        bean = new org.sblim.wbemsmt.jsf.dns.listener.EditReverseZoneListenerEditBeanTabAcl();
        editBeans.add(bean);
        bean.edit(treeNode);
        ...
        bean = new org.sblim.wbemsmt.jsf.dns.listener.EditReverseZoneListenerEditBeanTabSOA();
        editBeans.add(bean);
        bean.edit(treeNode);
        ...
        bean = new org.sblim.wbemsmt.jsf.dns.listener.EditReverseZoneListenerEditBeanTabResourceRecords();
        editBeans.add(bean);
        bean.edit(treeNode);
