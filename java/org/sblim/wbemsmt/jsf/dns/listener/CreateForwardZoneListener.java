/** 
  * CreateForwardZoneListener.java
  *
...
public class CreateForwardZoneListener extends TaskLauncherContextMenuEventListenerImpl {
	...
	public String processEvent(TaskLauncherTreeNodeEvent event) throws org.sblim.wbemsmt.exception.WbemSmtException {
		...
		if (selector.execute())
		{
			...
			org.sblim.wbemsmt.jsf.dns.wizard.CreateForwardZoneWizard wizard = new org.sblim.wbemsmt.jsf.dns.wizard.CreateForwardZoneWizard(adapter);
