/**
 * CreateForwardZoneListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class CreateForwardZoneListener extends TaskLauncherContextMenuEventListenerImpl {
    ...
    public String processEvent(TaskLauncherTreeNodeEvent event) throws WbemsmtException {
        ...
        helpManager.setCurrentTopic("dns", "CreateForwardZoneListener");
        ...
        TaskLauncherTreeNodeSelectorForCreate selector = new org.sblim.wbemsmt.dns.listener.CreateForwardZoneListenerSelector();
        selector.select(treeNode, adapter, "createForwardZone");

        if (selector.execute()) {
            adapter = (org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter) selector.getAdapter();

            org.sblim.wbemsmt.jsf.dns.wizard.CreateForwardZoneWizard wizard = new org.sblim.wbemsmt.jsf.dns.wizard.CreateForwardZoneWizard(
                    adapter);
