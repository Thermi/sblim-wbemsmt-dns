/**
 * CreateMastersListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class CreateMastersListener extends TaskLauncherContextMenuEventListenerImpl {
    ...
    public String processEvent(TaskLauncherTreeNodeEvent event) throws WbemsmtException {
        ...
        helpManager.setCurrentTopic("dns", "CreateMastersListener");
        ...
        TaskLauncherTreeNodeSelectorForCreate selector = new org.sblim.wbemsmt.dns.listener.CreateMastersListenerSelector();
        selector.select(treeNode, adapter, "createMaster");

        if (selector.execute()) {
            adapter = (org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter) selector.getAdapter();

            org.sblim.wbemsmt.jsf.dns.wizard.MasterWizard wizard = new org.sblim.wbemsmt.jsf.dns.wizard.MasterWizard(
                    adapter);
