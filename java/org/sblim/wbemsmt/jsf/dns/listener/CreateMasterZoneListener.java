...
public class CreateMasterZoneListener extends TaskLauncherContextMenuEventListenerImpl {
    ...
    public String processEvent(TaskLauncherTreeNodeEvent event) throws WbemsmtException {
        ...
        helpManager.setCurrentTopic("dns", "CreateMasterZoneListener");
        ...
        if (selector.execute()) {
            ...
            org.sblim.wbemsmt.jsf.dns.wizard.CreateMasterZoneWizard wizard = new org.sblim.wbemsmt.jsf.dns.wizard.CreateMasterZoneWizard(
                    adapter);
