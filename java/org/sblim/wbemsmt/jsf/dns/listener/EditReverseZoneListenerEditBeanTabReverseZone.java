/** 
  * EditReverseZoneListenerEditBeanTabReverseZone.java
  *
...
public class EditReverseZoneListenerEditBeanTabReverseZone extends EditBean {
		...
		public void edit(ITaskLauncherTreeNode treeNode) throws ObjectNotFoundException, UpdateControlsException, CountException, InitContainerException
		{
			...
			org.sblim.wbem.client.CIMClient cimClient = null;
				...
				bindingPrefix = "objectActionController.editBeans['TabReverseZone'].containers[0].";

				//create cotainner
    			currentEditContainer1 = new org.sblim.wbemsmt.jsf.dns.container.edit.DnsReverseZoneDataContainerImpl(adapter1,bindingPrefix);
