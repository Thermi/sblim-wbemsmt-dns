...
public class EditServiceListenerEditBeanTabOperations extends EditBean {
		...
		private org.sblim.wbemsmt.jsf.dns.container.edit.DnsServiceOperationsDataContainerImpl currentEditContainer1;
		...
		public String save() throws ValidationException, ObjectSaveException
		{
			saveResult = new MessageList();
					...
					//Saving Container DnsServiceOperationsDataContainer
		...
		public void edit(ITaskLauncherTreeNode treeNode) throws ObjectNotFoundException, UpdateControlsException, CountException, InitContainerException
		{
			...
			org.sblim.wbem.client.CIMClient cimClient = null;
				...
				selector.select(treeNode,adapter1,"editDnsServiceStatus");

				
				
				//ADD THE FIELDS FOR CONTAINER DnsServiceOperationsDataContainer in EditPanel ${editPanel.getId()}
				
				
				bindingPrefix = "objectActionController.editBeans['TabOperations'].containers[0].";

				//create cotainner
    			currentEditContainer1 = new org.sblim.wbemsmt.jsf.dns.container.edit.DnsServiceOperationsDataContainerImpl(adapter1,bindingPrefix);
