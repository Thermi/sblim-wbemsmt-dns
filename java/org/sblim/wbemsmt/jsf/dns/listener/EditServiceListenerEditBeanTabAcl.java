...
public class EditServiceListenerEditBeanTabAcl extends EditBean {
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        adapter5 = (org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter) CimAdapterFactory.getInstance()
                .getAdapter(org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter.class,
                        FacesContext.getCurrentInstance(), cimClient);
        ...
        currentEditContainer5.getLayouter().layout(currentEditContainer5.getPanelForCustomLayout(),
                currentEditContainer5, bundle);
