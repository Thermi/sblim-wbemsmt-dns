/** 
  * EditAddressMatchListListenerEditBeanFieldTab.java
  *
...
public class EditAddressMatchListListenerEditBeanFieldTab extends EditBean {
		...
		public void edit(ITaskLauncherTreeNode treeNode) throws ObjectNotFoundException, UpdateControlsException, CountException, InitContainerException
		{
			...
			org.sblim.wbem.client.CIMClient cimClient = null;
				...
				//create cotainner
    			currentEditContainer1 = new org.sblim.wbemsmt.jsf.dns.container.edit.DnsAddressMatchListForServiceDataContainerImpl(adapter1,bindingPrefix);
