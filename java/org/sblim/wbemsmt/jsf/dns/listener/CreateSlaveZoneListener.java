/**
 * CreateSlaveZoneListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class CreateSlaveZoneListener extends TaskLauncherContextMenuEventListenerImpl {
    ...
    public String processEvent(TaskLauncherTreeNodeEvent event) throws WbemsmtException {
        ...
        helpManager.setCurrentTopic("dns", "CreateSlaveZoneListener");
        ...
        TaskLauncherTreeNodeSelectorForCreate selector = new org.sblim.wbemsmt.dns.listener.CreateSlaveZoneListenerSelector();
        selector.select(treeNode, adapter, "createSlaveZone");

        if (selector.execute()) {
            adapter = (org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter) selector.getAdapter();

            org.sblim.wbemsmt.jsf.dns.wizard.CreateSlaveZoneWizard wizard = new org.sblim.wbemsmt.jsf.dns.wizard.CreateSlaveZoneWizard(
                    adapter);
