/** 
  * EditMasterZoneListenerEditBeanTabMasterZone.java
  *
...
public class EditMasterZoneListenerEditBeanTabMasterZone extends EditBean {
		...
		public void edit(ITaskLauncherTreeNode treeNode) throws ObjectNotFoundException, UpdateControlsException, CountException, InitContainerException
		{
			...
			org.sblim.wbem.client.CIMClient cimClient = null;
				...
				bindingPrefix = "objectActionController.editBeans['TabMasterZone'].containers[0].";

				//create cotainner
    			currentEditContainer1 = new org.sblim.wbemsmt.jsf.dns.container.edit.DnsMasterZoneDataContainerImpl(adapter1,bindingPrefix);
