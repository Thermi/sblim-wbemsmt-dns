/**
 * EditMastersListenerEditBeanFieldTab.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED
...
public class EditMastersListenerEditBeanFieldTab extends EditBean {

    private org.sblim.wbemsmt.jsf.dns.container.edit.DnsMastersForServiceDataContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public EditMastersListenerEditBeanFieldTab() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container DnsMastersForServiceDataContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.jsf.dns.container.edit.DnsMastersForServiceDataContainerImpl(
