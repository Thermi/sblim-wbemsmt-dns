 ...
 * (C) Copyright IBM Corp. 2005
  ...
  * @template: templates/jsf/editListener.vm
  *
  * Contributors: 
  * 
  * Description: 
...
public class EditResourceRecordListener extends TaskLauncherContextMenuEventListenerImpl implements EditListener {
	...
	public String processEvent(TaskLauncherTreeNodeEvent event) throws WbemSmtException {
			...
			EditBean bean = null;
    			...
    			bean = new org.sblim.wbemsmt.jsf.dns.listener.EditResourceRecordListenerEditBeanFieldTab();
				editBeans.add(bean);
    			bean.edit(treeNode);
