/**
 * DeleteAddressMatchListListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class DeleteAddressMatchListListener extends JsfDeleteListener {
    ...
    public String processEvent(TaskLauncherTreeNodeEvent event) throws WbemsmtException {
        ...
        selector.select(treeNode, adapter, "deleteAddressMatchList");
