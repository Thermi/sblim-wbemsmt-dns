/**
 * EditServiceListenerEditBeanTabConfiguration.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS
...
public class EditServiceListenerEditBeanTabConfiguration extends EditBean {

    private org.sblim.wbemsmt.jsf.dns.container.edit.DnsConfigurationDataContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter1 = null;

    private org.sblim.wbemsmt.jsf.dns.container.edit.DnsForwardersForServiceDataContainerImpl currentEditContainer2;

    private org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter2 = null;

    private HtmlPanelGrid panel;

    public EditServiceListenerEditBeanTabConfiguration() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container DnsConfigurationDataContainer
        ...
        //Saving Container DnsForwardersForServiceDataContainer
        if (!saveResult.hasErrors()) {
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        expressionPrefix = "objectActionController.editBeans['TabConfiguration'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.jsf.dns.container.edit.DnsConfigurationDataContainerImpl(
        ...
        expressionPrefix = "objectActionController.editBeans['TabConfiguration'].containers[1].";

        //create cotainner
        currentEditContainer2 = new org.sblim.wbemsmt.jsf.dns.container.edit.DnsForwardersForServiceDataContainerImpl(
