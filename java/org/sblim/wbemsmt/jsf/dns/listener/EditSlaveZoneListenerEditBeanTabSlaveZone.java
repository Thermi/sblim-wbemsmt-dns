/**
 * EditSlaveZoneListenerEditBeanTabSlaveZone.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS
...
public class EditSlaveZoneListenerEditBeanTabSlaveZone extends EditBean {

    private org.sblim.wbemsmt.jsf.dns.container.edit.DnsSlaveZoneDataContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public EditSlaveZoneListenerEditBeanTabSlaveZone() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container DnsSlaveZoneDataContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        expressionPrefix = "objectActionController.editBeans['TabSlaveZone'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.jsf.dns.container.edit.DnsSlaveZoneDataContainerImpl(
