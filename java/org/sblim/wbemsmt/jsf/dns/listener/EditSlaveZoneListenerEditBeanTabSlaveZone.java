/** 
  * EditSlaveZoneListenerEditBeanTabSlaveZone.java
  *
...
public class EditSlaveZoneListenerEditBeanTabSlaveZone extends EditBean {
		...
		public void edit(ITaskLauncherTreeNode treeNode) throws ObjectNotFoundException, UpdateControlsException, CountException, InitContainerException
		{
			...
			UIPanel panelToAdd= null;
				...
				bindingPrefix = "objectActionController.editBeans['TabSlaveZone'].containers[0].";
				

				//create cotainner
    			currentEditContainer1 = new org.sblim.wbemsmt.jsf.dns.container.edit.DnsSlaveZoneDataContainerImpl(adapter1,bindingPrefix);
