/**
 * EditForwardZoneListenerEditBeanFieldTab.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS
...
public class EditForwardZoneListenerEditBeanFieldTab extends EditBean {

    private org.sblim.wbemsmt.jsf.dns.container.edit.DnsForwardZoneDataContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public EditForwardZoneListenerEditBeanFieldTab() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container DnsForwardZoneDataContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.jsf.dns.container.edit.DnsForwardZoneDataContainerImpl(
