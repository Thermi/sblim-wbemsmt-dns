/** 
  * EditHintZoneListenerEditBeanTabHintZone.java
  *
...
public class EditHintZoneListenerEditBeanTabHintZone extends EditBean {
		...
		public void edit(ITaskLauncherTreeNode treeNode) throws ObjectNotFoundException, UpdateControlsException, CountException, InitContainerException
		{
			...
			UIPanel panelToAdd= null;
				...
				bindingPrefix = "objectActionController.editBeans['TabHintZone'].containers[0].";
				

				//create cotainner
    			currentEditContainer1 = new org.sblim.wbemsmt.jsf.dns.container.edit.DnsHintZoneDataContainerImpl(adapter1,bindingPrefix);
