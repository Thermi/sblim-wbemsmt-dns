/**
 * EditHintZoneListenerEditBeanTabHintZone.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS
...
public class EditHintZoneListenerEditBeanTabHintZone extends EditBean {

    private org.sblim.wbemsmt.jsf.dns.container.edit.DnsHintZoneDataContainerImpl currentEditContainer1;

    private org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter adapter1 = null;

    private HtmlPanelGrid panel;

    public EditHintZoneListenerEditBeanTabHintZone() {
    ...
    public String save() throws WbemsmtException {
        ...
        //Saving Container DnsHintZoneDataContainer
    ...
    public void edit(ITaskLauncherTreeNode treeNode) throws WbemsmtException {
        ...
        selector.select(treeNode, adapter1, "editHintZone");

        adapter1.setActiveModule(AbstractBaseCimAdapter.ACTIVE_EDIT);

        //ADD THE FIELDS FOR CONTAINER DnsHintZoneDataContainer in EditPanel ${editPanel.getId()}

        expressionPrefix = "objectActionController.editBeans['TabHintZone'].containers[0].";

        //create cotainner
        currentEditContainer1 = new org.sblim.wbemsmt.jsf.dns.container.edit.DnsHintZoneDataContainerImpl(
        ...
        addFooter(panel, "objectActionController.editBeans['TabHintZone'].");
