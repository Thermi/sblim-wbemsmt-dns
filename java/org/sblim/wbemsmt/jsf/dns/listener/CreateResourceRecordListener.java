/**
 * CreateResourceRecordListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class CreateResourceRecordListener extends TaskLauncherContextMenuEventListenerImpl {
    ...
    public String processEvent(TaskLauncherTreeNodeEvent event) throws WbemsmtException {
        ...
        helpManager.setCurrentTopic("dns", "CreateResourceRecordListener");
        ...
        TaskLauncherTreeNodeSelectorForCreate selector = new org.sblim.wbemsmt.dns.listener.CreateResourceRecordListenerSelector();
        selector.select(treeNode, adapter, "createResourceRecord");

        if (selector.execute()) {
            adapter = (org.sblim.wbemsmt.dns.bl.adapter.DnsCimAdapter) selector.getAdapter();

            org.sblim.wbemsmt.jsf.dns.wizard.CreateResourceRecordWizard wizard = new org.sblim.wbemsmt.jsf.dns.wizard.CreateResourceRecordWizard(
                    adapter);
