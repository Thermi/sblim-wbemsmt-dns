...
public class StubZone extends MasterZone implements Zone {
	 ...
	 * 
	 */
	public StubZone(final Linux_DnsStubZone fco,final DnsCimAdapter adapter) throws ModelLoadException {
		this(adapter);
		this.fco = fco;
	...
	public String getName() {
		return getStubZone().get_Name();
	}

	public MessageList save(DnsStubZoneDataContainer container)throws ObjectSaveException {
	...
	public void updateModel(DnsStubZoneDataContainer container) throws ModelUpdateException {
	...
	public MessageList revert(DnsStubZoneDataContainer container) throws ObjectRevertException {
		try {
