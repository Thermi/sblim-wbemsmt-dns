  ...
  * Contributors: 
  * 
  * Description: wrapper for a Linux_DnsStubZone
  * 
  */
...
public class StubZone extends MasterZone implements Zone {
	 ...
	 * 
	 */
	public StubZone(final Linux_DnsStubZone fco,final DnsCimAdapter adapter) throws WbemsmtException {
		this(adapter);
		this.fco = fco;
	 ...
	 * 
	 */
	public StubZone(DnsCimAdapter adapter) {
		super(adapter);
	 ...
	 * @return
	 */
	public Linux_DnsStubZone getStubZone() {
		return fco;
	}
	...
	public String getName() {
		return getStubZone().get_key_Name();
	}

	public MessageList save(DnsStubZoneDataContainer container)throws WbemsmtException {
        ...
        fco = (Linux_DnsStubZone) adapter.getFcoHelper().save(fco,container.getAdapter().getCimClient());
	...
	public void updateControls(DnsStubZoneDataContainer container) throws WbemsmtException {
	...
	public void updateModel(DnsStubZoneDataContainer container) throws WbemsmtException {
	...
	public MessageList revert(DnsStubZoneDataContainer container) throws WbemsmtException {
		fco = (Linux_DnsStubZone) adapter.getFcoHelper().reload(fco, adapter.getCimClient());
		return null;
	}
