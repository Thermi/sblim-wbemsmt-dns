...
public class Linux_DnsAllowNotifyForZoneHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DnsAllowNotifyForZone.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DnsAllowNotifyForZone.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DnsAllowNotifyForZone.");
                        resultArrayList.add(new Linux_DnsAllowNotifyForZone(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DnsAllowNotifyForZone.");
                        resultArrayList.add(new Linux_DnsAllowNotifyForZone(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DnsAllowNotifyForZone.");
                        resultArrayList.add(new Linux_DnsAllowNotifyForZone(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DnsAllowNotifyForZone getInstance(WBEMClient client,
    ...
    public final static Linux_DnsAllowNotifyForZone getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_DnsAllowNotifyForZone.PROPERTY_GROUPCOMPONENT_LINUX_DNSZONE.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_DnsAllowNotifyForZone.PROPERTY_PARTCOMPONENT_LINUX_DNSADDRESSMATCHLIST.NAME,
     ...
     *
     */
    public final static Linux_DnsAllowNotifyForZone createInstance(WBEMClient client,
            Linux_DnsAllowNotifyForZone dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DnsAllowNotifyForZone newDataInstance = Linux_DnsAllowNotifyForZoneHelper
     ...
     */
    public final static Linux_DnsAllowNotifyForZone modifyInstance(WBEMClient client,
            Linux_DnsAllowNotifyForZone dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DnsAllowNotifyForZone dataInstance2 = Linux_DnsAllowNotifyForZoneHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_DnsAllowNotifyForZone dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DnsAllowNotifyForZone.getPackages());
    }
