...
public class Linux_DnsAllowUpdateForZoneHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DnsAllowUpdateForZone.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DnsAllowUpdateForZone.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DnsAllowUpdateForZone.");
                        resultArrayList.add(new Linux_DnsAllowUpdateForZone(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DnsAllowUpdateForZone.");
                        resultArrayList.add(new Linux_DnsAllowUpdateForZone(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DnsAllowUpdateForZone.");
                        resultArrayList.add(new Linux_DnsAllowUpdateForZone(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DnsAllowUpdateForZone getInstance(WBEMClient client,
    ...
    public final static Linux_DnsAllowUpdateForZone getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_DnsAllowUpdateForZone.PROPERTY_GROUPCOMPONENT_LINUX_DNSZONE.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_DnsAllowUpdateForZone.PROPERTY_PARTCOMPONENT_LINUX_DNSADDRESSMATCHLIST.NAME,
     ...
     *
     */
    public final static Linux_DnsAllowUpdateForZone createInstance(WBEMClient client,
            Linux_DnsAllowUpdateForZone dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DnsAllowUpdateForZone newDataInstance = Linux_DnsAllowUpdateForZoneHelper
     ...
     */
    public final static Linux_DnsAllowUpdateForZone modifyInstance(WBEMClient client,
            Linux_DnsAllowUpdateForZone dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DnsAllowUpdateForZone dataInstance2 = Linux_DnsAllowUpdateForZoneHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_DnsAllowUpdateForZone dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DnsAllowUpdateForZone.getPackages());
    }
