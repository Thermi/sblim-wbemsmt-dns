...
public final class Linux_DnsServiceConfigurationHelper {
	...
	*/	
	public final static Linux_DnsServiceConfiguration getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_DnsServiceConfigurationHelper.getInstance(cimClient, new Linux_DnsServiceConfiguration(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_DnsServiceConfiguration getInstance(CIMClient cimClient, Linux_DnsServiceConfiguration dataInstance) {
		...
		return Linux_DnsServiceConfigurationHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_DnsServiceConfiguration getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			...
			{
				dataInstance = new Linux_DnsServiceConfiguration(cimObjectPath, cimInstance);
			}
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = Linux_DnsServiceConfiguration.getPackages();
	...
	*/	
	public final static Linux_DnsServiceConfiguration createInstance(CIMClient cimClient, Linux_DnsServiceConfiguration dataInstance, boolean notifyDifferencies){ 
		...
		Linux_DnsServiceConfiguration newDataInstance = null;
		try {
			newDataInstance = Linux_DnsServiceConfigurationHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_DnsServiceConfiguration modifyInstance(CIMClient cimClient, Linux_DnsServiceConfiguration dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_DnsServiceConfigurationHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_DnsServiceConfiguration dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_DnsServiceConfiguration dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_DnsServiceConfiguration.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_DnsServiceConfiguration.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_DnsServiceConfiguration.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_DnsServiceConfiguration.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_DnsServiceConfiguration.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
