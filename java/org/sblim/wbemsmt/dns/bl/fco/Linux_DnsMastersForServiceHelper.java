/** 
  * Linux_DnsMastersForServiceHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_DnsMastersForService
  *    
  * 
  * generated Class
  * @see Linux_DnsMastersForService
  */
...
public class Linux_DnsMastersForServiceHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_DnsMastersForService or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_DnsMastersForService.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_DnsMastersForService.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_DnsMastersForService or the subclasses if deep == true
    */        
    public final static List<Linux_DnsMastersForService> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_DnsMastersForService> resultArrayList = new ArrayList<Linux_DnsMastersForService>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_DnsMastersForService.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_DnsMastersForService(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_DnsMastersForServiceHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_DnsMastersForService.");
                        resultArrayList.add(new Linux_DnsMastersForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_DnsMastersForService.");
                        resultArrayList.add(new Linux_DnsMastersForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_DnsMastersForService)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DnsMastersForService.");
                        resultArrayList.add(new Linux_DnsMastersForService(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_DnsMastersForService getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_DnsMastersForService getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_DnsMastersForService dataInstance = null;
        Class<?> clazz = Linux_DnsMastersForServiceHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_DnsMastersForService)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DnsMastersForService.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_DnsMastersForService(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_DnsMastersForService getInstance(WBEMClient client, String namespace
                                                       ,Linux_DnsService GroupComponent
                                                       ,Linux_DnsMasters PartComponent
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_DnsMastersForService.PROPERTY_GROUPCOMPONENT_LINUX_DNSSERVICE.NAME,new CIMDataType(Linux_DnsService.CIM_CLASS_NAME),setThis,false,false,Linux_DnsMastersForService.CIM_CLASS_NAME); 
                   
                                 setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_DnsMastersForService.PROPERTY_PARTCOMPONENT_LINUX_DNSMASTERS.NAME,new CIMDataType(Linux_DnsMasters.CIM_CLASS_NAME),setThis,false,false,Linux_DnsMastersForService.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_DnsMastersForService.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_DnsMastersForService createInstance(WBEMClient client, Linux_DnsMastersForService dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_DnsMastersForService newDataInstance = Linux_DnsMastersForServiceHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_DnsMastersForService modifyInstance(WBEMClient client, Linux_DnsMastersForService dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_DnsMastersForService dataInstance2 = Linux_DnsMastersForServiceHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_DnsMastersForService dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_DnsMastersForService.getPackages());
    }
