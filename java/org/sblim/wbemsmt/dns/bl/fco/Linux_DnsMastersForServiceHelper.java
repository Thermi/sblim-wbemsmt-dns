...
public class Linux_DnsMastersForServiceHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DnsMastersForService.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DnsMastersForService.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DnsMastersForService.");
                        resultArrayList.add(new Linux_DnsMastersForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DnsMastersForService.");
                        resultArrayList.add(new Linux_DnsMastersForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DnsMastersForService.");
                        resultArrayList.add(new Linux_DnsMastersForService(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DnsMastersForService getInstance(WBEMClient client,
    ...
    public final static Linux_DnsMastersForService getInstance(WBEMClient client, String namespace,
            Linux_DnsService GroupComponent, Linux_DnsMasters PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                Linux_DnsMastersForService.PROPERTY_GROUPCOMPONENT_LINUX_DNSSERVICE.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_DnsMastersForService.PROPERTY_PARTCOMPONENT_LINUX_DNSMASTERS.NAME,
                new CIMDataType(Linux_DnsMasters.CIM_CLASS_NAME), setThis, false, false,
                Linux_DnsMastersForService.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DnsMastersForService createInstance(WBEMClient client,
            Linux_DnsMastersForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DnsMastersForService newDataInstance = Linux_DnsMastersForServiceHelper.getInstance(
     ...
     */
    public final static Linux_DnsMastersForService modifyInstance(WBEMClient client,
            Linux_DnsMastersForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DnsMastersForService dataInstance2 = Linux_DnsMastersForServiceHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_DnsMastersForService dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DnsMastersForService.getPackages());
    }
