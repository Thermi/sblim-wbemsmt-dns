/** 
 * Linux_DnsSettingForConfigurationHelper.java
 *
...
public final class Linux_DnsServiceSettingForServiceConfigurationHelper {

	public final static String CIM_CLASS_NAME = "Linux_DnsSettingForConfiguration";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new Linux_DnsServiceSettingForServiceConfiguration(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<Linux_DnsServiceSettingForServiceConfiguration.Java_Package_List.size(); i++) {
						if (!((String)(Linux_DnsServiceSettingForServiceConfiguration.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(Linux_DnsServiceSettingForServiceConfiguration.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							Linux_DnsServiceSettingForServiceConfiguration.Java_Package_List.setElementAt((String)(Linux_DnsServiceSettingForServiceConfiguration.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (Linux_DnsServiceSettingForServiceConfiguration.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_DnsSettingForConfiguration.");
						resultArrayList.add(new Linux_DnsServiceSettingForServiceConfiguration(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_DnsSettingForConfiguration.");
						resultArrayList.add(new Linux_DnsServiceSettingForServiceConfiguration(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DnsSettingForConfiguration.");
						resultArrayList.add(new Linux_DnsServiceSettingForServiceConfiguration(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static Linux_DnsServiceSettingForServiceConfiguration getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_DnsServiceSettingForServiceConfigurationHelper.getInstance(cimClient, new Linux_DnsServiceSettingForServiceConfiguration(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_DnsServiceSettingForServiceConfiguration getInstance(CIMClient cimClient, Linux_DnsServiceSettingForServiceConfiguration dataInstance) {
		...
		return Linux_DnsServiceSettingForServiceConfigurationHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_DnsServiceSettingForServiceConfiguration getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		Linux_DnsServiceSettingForServiceConfiguration dataInstance = null;
		try {
			dataInstance = new Linux_DnsServiceSettingForServiceConfiguration(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_DnsServiceSettingForServiceConfiguration createInstance(CIMClient cimClient, Linux_DnsServiceSettingForServiceConfiguration dataInstance, boolean notifyDifferencies){ 
		...
		Linux_DnsServiceSettingForServiceConfiguration newDataInstance = null;
		try {
			newDataInstance = Linux_DnsServiceSettingForServiceConfigurationHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_DnsServiceSettingForServiceConfiguration modifyInstance(CIMClient cimClient, Linux_DnsServiceSettingForServiceConfiguration dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_DnsServiceSettingForServiceConfigurationHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_DnsServiceSettingForServiceConfiguration dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_DnsServiceSettingForServiceConfiguration dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_DnsServiceSettingForServiceConfiguration.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_DnsServiceSettingForServiceConfiguration.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_DnsServiceSettingForServiceConfiguration.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_DnsServiceSettingForServiceConfiguration.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_DnsServiceSettingForServiceConfiguration.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_Linux_DnsConfiguration(Linux_DnsServiceConfiguration Linux_DnsConfiguration) {
		return true;
	}

	public static boolean isValid_Linux_DnsSetting(Linux_DnsServiceSettingData Linux_DnsSetting) {
		return true;
	}
