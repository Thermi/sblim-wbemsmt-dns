/**
 * Linux_DnsAllowUpdateForZone.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
 ...
 *            hosting the list of elements that are allowed to support the request type:
 *            allow-update. generated Class
 */
...
public class Linux_DnsAllowUpdateForZone extends CIM_Component {
    ...
    public Linux_DnsAllowUpdateForZone(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public Linux_DnsAllowUpdateForZone(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_DnsAllowUpdateForZone() {
    }
    ...
    public static CIMProperty create_GroupComponent_Linux_DnsZone(WBEMClient client,
        ...
        Linux_DnsAllowUpdateForZone fco = new Linux_DnsAllowUpdateForZone(client, namespace);
    ...
    public String getObjectName() {
        return Linux_DnsAllowUpdateForZone.CIM_CLASS_NAME;
    }
