...
public class Linux_DnsResourceRecordHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DnsResourceRecord.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DnsResourceRecord.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DnsResourceRecord.");
                        resultArrayList.add(new Linux_DnsResourceRecord(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DnsResourceRecord.");
                        resultArrayList.add(new Linux_DnsResourceRecord(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DnsResourceRecord.");
                        resultArrayList.add(new Linux_DnsResourceRecord(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DnsResourceRecord getInstance(WBEMClient client,
    ...
    public final static Linux_DnsResourceRecord getInstance(WBEMClient client, String namespace,
            String InstanceID, String Name, String Type, String Value, String ZoneName
        ...
        keyProperties[0] = new CIMProperty(Linux_DnsResourceRecord.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_DnsResourceRecord.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(Linux_DnsResourceRecord.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_DnsResourceRecord.CIM_CLASS_NAME);

        setThis = Type;

        keyProperties[2] = new CIMProperty(Linux_DnsResourceRecord.PROPERTY_TYPE.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_DnsResourceRecord.CIM_CLASS_NAME);

        setThis = Value;

        keyProperties[3] = new CIMProperty(Linux_DnsResourceRecord.PROPERTY_VALUE.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_DnsResourceRecord.CIM_CLASS_NAME);

        setThis = ZoneName;

        keyProperties[4] = new CIMProperty(Linux_DnsResourceRecord.PROPERTY_ZONENAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_DnsResourceRecord.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DnsResourceRecord createInstance(WBEMClient client,
            Linux_DnsResourceRecord dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DnsResourceRecord newDataInstance = Linux_DnsResourceRecordHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static Linux_DnsResourceRecord modifyInstance(WBEMClient client,
            Linux_DnsResourceRecord dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DnsResourceRecord dataInstance2 = Linux_DnsResourceRecordHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_DnsResourceRecord dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DnsResourceRecord.getPackages());
    }
