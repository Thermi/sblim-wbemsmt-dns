...
public class Linux_DnsSlaveZoneHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DnsSlaveZone.CIM_CLASS_NAME,
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(Linux_DnsSlaveZone.CIM_CLASS_NAME)) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DnsSlaveZone.");
                        resultArrayList.add(new Linux_DnsSlaveZone(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DnsSlaveZone.");
                        resultArrayList.add(new Linux_DnsSlaveZone(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DnsSlaveZone.");
                        resultArrayList.add(new Linux_DnsSlaveZone(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DnsSlaveZone getInstance(WBEMClient client,
     ...
     */
    public final static Linux_DnsSlaveZone getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static Linux_DnsSlaveZone getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(Linux_DnsSlaveZone.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_DnsSlaveZone.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(Linux_DnsSlaveZone.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_DnsSlaveZone.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DnsSlaveZone createInstance(WBEMClient client,
            Linux_DnsSlaveZone dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        Linux_DnsSlaveZone newDataInstance = Linux_DnsSlaveZoneHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static Linux_DnsSlaveZone modifyInstance(WBEMClient client,
            Linux_DnsSlaveZone dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DnsSlaveZone dataInstance2 = Linux_DnsSlaveZoneHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_DnsSlaveZone dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DnsSlaveZone.getPackages());
    }
