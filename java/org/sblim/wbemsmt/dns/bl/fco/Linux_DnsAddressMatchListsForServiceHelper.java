/** 
  * Linux_DnsAddressMatchListsForServiceHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_DnsAddressMatchListsForService
  *    
  * 
  * generated Class
  * @see Linux_DnsAddressMatchListsForService
  */
...
public class Linux_DnsAddressMatchListsForServiceHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_DnsAddressMatchListsForService or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_DnsAddressMatchListsForService.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_DnsAddressMatchListsForService.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_DnsAddressMatchListsForService or the subclasses if deep == true
    */        
    public final static List<Linux_DnsAddressMatchListsForService> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_DnsAddressMatchListsForService> resultArrayList = new ArrayList<Linux_DnsAddressMatchListsForService>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_DnsAddressMatchListsForService.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_DnsAddressMatchListsForService(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_DnsAddressMatchListsForServiceHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_DnsAddressMatchListsForService.");
                        resultArrayList.add(new Linux_DnsAddressMatchListsForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_DnsAddressMatchListsForService.");
                        resultArrayList.add(new Linux_DnsAddressMatchListsForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_DnsAddressMatchListsForService)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DnsAddressMatchListsForService.");
                        resultArrayList.add(new Linux_DnsAddressMatchListsForService(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_DnsAddressMatchListsForService getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_DnsAddressMatchListsForService getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_DnsAddressMatchListsForService dataInstance = null;
        Class<?> clazz = Linux_DnsAddressMatchListsForServiceHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_DnsAddressMatchListsForService)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DnsAddressMatchListsForService.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_DnsAddressMatchListsForService(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_DnsAddressMatchListsForService getInstance(WBEMClient client, String namespace
                                                       ,Linux_DnsService GroupComponent
                                                       ,Linux_DnsAddressMatchList PartComponent
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_DnsAddressMatchListsForService.PROPERTY_GROUPCOMPONENT_LINUX_DNSSERVICE.NAME,new CIMDataType(Linux_DnsService.CIM_CLASS_NAME),setThis,false,false,Linux_DnsAddressMatchListsForService.CIM_CLASS_NAME); 
                   
                                 setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_DnsAddressMatchListsForService.PROPERTY_PARTCOMPONENT_LINUX_DNSADDRESSMATCHLIST.NAME,new CIMDataType(Linux_DnsAddressMatchList.CIM_CLASS_NAME),setThis,false,false,Linux_DnsAddressMatchListsForService.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_DnsAddressMatchListsForService.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_DnsAddressMatchListsForService createInstance(WBEMClient client, Linux_DnsAddressMatchListsForService dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_DnsAddressMatchListsForService newDataInstance = Linux_DnsAddressMatchListsForServiceHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_DnsAddressMatchListsForService modifyInstance(WBEMClient client, Linux_DnsAddressMatchListsForService dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_DnsAddressMatchListsForService dataInstance2 = Linux_DnsAddressMatchListsForServiceHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_DnsAddressMatchListsForService dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_DnsAddressMatchListsForService.getPackages());
    }
