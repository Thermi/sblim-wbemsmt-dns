...
public class Linux_DnsAddressMatchListsForServiceHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DnsAddressMatchListsForService.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DnsAddressMatchListsForService.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_DnsAddressMatchListsForServiceHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_DnsAddressMatchListsForService.");
                        resultArrayList.add(new Linux_DnsAddressMatchListsForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DnsAddressMatchListsForService.");
                        resultArrayList.add(new Linux_DnsAddressMatchListsForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DnsAddressMatchListsForService.");
                        resultArrayList.add(new Linux_DnsAddressMatchListsForService(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DnsAddressMatchListsForService getInstance(WBEMClient client,
     ...
     */
    public final static Linux_DnsAddressMatchListsForService getInstance(WBEMClient client,
            String namespace, Linux_DnsService GroupComponent,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_DnsAddressMatchListsForService.PROPERTY_GROUPCOMPONENT_LINUX_DNSSERVICE.NAME,
                new CIMDataType(Linux_DnsService.CIM_CLASS_NAME), setThis, false, false,
                Linux_DnsAddressMatchListsForService.CIM_CLASS_NAME);

        setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                Linux_DnsAddressMatchListsForService.PROPERTY_PARTCOMPONENT_LINUX_DNSADDRESSMATCHLIST.NAME,
                new CIMDataType(Linux_DnsAddressMatchList.CIM_CLASS_NAME), setThis, false, false,
                Linux_DnsAddressMatchListsForService.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DnsAddressMatchListsForService createInstance(WBEMClient client,
            Linux_DnsAddressMatchListsForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DnsAddressMatchListsForService newDataInstance = Linux_DnsAddressMatchListsForServiceHelper
     ...
     */
    public final static Linux_DnsAddressMatchListsForService modifyInstance(WBEMClient client,
            Linux_DnsAddressMatchListsForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DnsAddressMatchListsForService dataInstance2 = Linux_DnsAddressMatchListsForServiceHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_DnsAddressMatchListsForService dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DnsAddressMatchListsForService.getPackages());
    }
