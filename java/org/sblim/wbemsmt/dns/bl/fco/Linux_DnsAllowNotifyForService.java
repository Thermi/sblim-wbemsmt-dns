/**
 * Linux_DnsAllowNotifyForService.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
 ...
 *            hosting the list of elements that are allowed to support the request type: notify.
 *            generated Class
 */
...
public class Linux_DnsAllowNotifyForService extends CIM_Component {
    ...
    public Linux_DnsAllowNotifyForService(WBEMClient client, String namespace)
    ...
    public Linux_DnsAllowNotifyForService(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_DnsAllowNotifyForService() {
    }
    ...
    public static CIMProperty create_GroupComponent_Linux_DnsService(WBEMClient client,
        ...
        Linux_DnsAllowNotifyForService fco = new Linux_DnsAllowNotifyForService(client, namespace);
    ...
    public String getObjectName() {
        return Linux_DnsAllowNotifyForService.CIM_CLASS_NAME;
    }
