/**
 * Linux_DnsResourceRecordsForZone.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
 ...
 *            Karnam<prkarnam@in.ibm.com> Description: Association representing the DNS resource
 *            records, that have been specified in the scope of their DNS zone. generated Class
 */
...
public class Linux_DnsResourceRecordsForZone extends CIM_Component {
     ...
     * 
     */
    public static class PROPERTY_PARTCOMPONENT_LINUX_DNSRESOURCERECORD {
        /**
    ...
    public Linux_DnsResourceRecordsForZone(WBEMClient client, String namespace)
    ...
    public Linux_DnsResourceRecordsForZone(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_DnsResourceRecordsForZone() {
    }
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        ...
        propertiesToCheck.put("PartComponent", new CIMProperty("PartComponent", new CIMDataType(
                Linux_DnsResourceRecord.CIM_CLASS_NAME), null));
    ...
    public static CIMProperty create_GroupComponent_Linux_DnsZone(WBEMClient client,
        ...
        Linux_DnsResourceRecordsForZone fco = new Linux_DnsResourceRecordsForZone(client, namespace);
    ...
    public Linux_DnsResourceRecord get_PartComponent_Linux_DnsResourceRecord(
            javax.wbem.client.WBEMClient client) throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_PARTCOMPONENT_LINUX_DNSRESOURCERECORD.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_PARTCOMPONENT_LINUX_DNSRESOURCERECORD.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }

        return Linux_DnsResourceRecordHelper.getInstance(client, (CIMObjectPath) currentProperty
                .getValue());
    ...
    public static CIMProperty create_PartComponent_Linux_DnsResourceRecord(WBEMClient client,
            String namespace, Linux_DnsResourceRecord newValue) throws WbemsmtException {
        Linux_DnsResourceRecordsForZone fco = new Linux_DnsResourceRecordsForZone(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_PARTCOMPONENT_LINUX_DNSRESOURCERECORD.NAME);
        if (property != null) {
            property = setPropertyValue_PartComponent_Linux_DnsResourceRecord(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_PARTCOMPONENT_LINUX_DNSRESOURCERECORD.NAME
                    + " was not found in instance " + fco.getCimObjectPath());
    ...
    private static CIMProperty setPropertyValue_PartComponent_Linux_DnsResourceRecord(
            CIMProperty currentProperty, Linux_DnsResourceRecord newValue) {
        Object setThis = null;
    ...
    public String getObjectName() {
        return Linux_DnsResourceRecordsForZone.CIM_CLASS_NAME;
    }
