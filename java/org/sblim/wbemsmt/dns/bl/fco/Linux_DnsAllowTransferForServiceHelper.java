/** 
  * Linux_DnsAllowTransferForServiceHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_DnsAllowTransferForService
  *    
  * 
  * generated Class
  * @see Linux_DnsAllowTransferForService
  */
...
public class Linux_DnsAllowTransferForServiceHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_DnsAllowTransferForService or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_DnsAllowTransferForService.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_DnsAllowTransferForService.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_DnsAllowTransferForService or the subclasses if deep == true
    */        
    public final static List<Linux_DnsAllowTransferForService> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_DnsAllowTransferForService> resultArrayList = new ArrayList<Linux_DnsAllowTransferForService>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_DnsAllowTransferForService.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_DnsAllowTransferForService(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_DnsAllowTransferForServiceHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_DnsAllowTransferForService.");
                        resultArrayList.add(new Linux_DnsAllowTransferForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_DnsAllowTransferForService.");
                        resultArrayList.add(new Linux_DnsAllowTransferForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_DnsAllowTransferForService)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DnsAllowTransferForService.");
                        resultArrayList.add(new Linux_DnsAllowTransferForService(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_DnsAllowTransferForService getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_DnsAllowTransferForService getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_DnsAllowTransferForService dataInstance = null;
        Class<?> clazz = Linux_DnsAllowTransferForServiceHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_DnsAllowTransferForService)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DnsAllowTransferForService.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_DnsAllowTransferForService(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_DnsAllowTransferForService getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_DnsAllowTransferForService.PROPERTY_GROUPCOMPONENT_LINUX_DNSSERVICE.NAME,new CIMDataType(Linux_DnsService.CIM_CLASS_NAME),setThis,false,false,Linux_DnsAllowTransferForService.CIM_CLASS_NAME); 
                   
                                 setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_DnsAllowTransferForService.PROPERTY_PARTCOMPONENT_LINUX_DNSADDRESSMATCHLIST.NAME,new CIMDataType(Linux_DnsAddressMatchList.CIM_CLASS_NAME),setThis,false,false,Linux_DnsAllowTransferForService.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_DnsAllowTransferForService.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_DnsAllowTransferForService createInstance(WBEMClient client, Linux_DnsAllowTransferForService dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_DnsAllowTransferForService newDataInstance = Linux_DnsAllowTransferForServiceHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_DnsAllowTransferForService modifyInstance(WBEMClient client, Linux_DnsAllowTransferForService dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_DnsAllowTransferForService dataInstance2 = Linux_DnsAllowTransferForServiceHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_DnsAllowTransferForService dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_DnsAllowTransferForService.getPackages());
    }
