/** 
  * Linux_DnsAllowTransferForZoneHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_DnsAllowTransferForZone
  *    
  * 
  * generated Class
  * @see Linux_DnsAllowTransferForZone
  */
...
public class Linux_DnsAllowTransferForZoneHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_DnsAllowTransferForZone or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_DnsAllowTransferForZone.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_DnsAllowTransferForZone.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_DnsAllowTransferForZone or the subclasses if deep == true
    */        
    public final static List<Linux_DnsAllowTransferForZone> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_DnsAllowTransferForZone> resultArrayList = new ArrayList<Linux_DnsAllowTransferForZone>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_DnsAllowTransferForZone.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_DnsAllowTransferForZone(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_DnsAllowTransferForZoneHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_DnsAllowTransferForZone.");
                        resultArrayList.add(new Linux_DnsAllowTransferForZone(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_DnsAllowTransferForZone.");
                        resultArrayList.add(new Linux_DnsAllowTransferForZone(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_DnsAllowTransferForZone)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DnsAllowTransferForZone.");
                        resultArrayList.add(new Linux_DnsAllowTransferForZone(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_DnsAllowTransferForZone getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_DnsAllowTransferForZone getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_DnsAllowTransferForZone dataInstance = null;
        Class<?> clazz = Linux_DnsAllowTransferForZoneHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_DnsAllowTransferForZone)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DnsAllowTransferForZone.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_DnsAllowTransferForZone(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_DnsAllowTransferForZone getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_DnsAllowTransferForZone.PROPERTY_GROUPCOMPONENT_LINUX_DNSZONE.NAME,new CIMDataType(Linux_DnsZone.CIM_CLASS_NAME),setThis,false,false,Linux_DnsAllowTransferForZone.CIM_CLASS_NAME); 
                   
                                 setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_DnsAllowTransferForZone.PROPERTY_PARTCOMPONENT_LINUX_DNSADDRESSMATCHLIST.NAME,new CIMDataType(Linux_DnsAddressMatchList.CIM_CLASS_NAME),setThis,false,false,Linux_DnsAllowTransferForZone.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_DnsAllowTransferForZone.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_DnsAllowTransferForZone createInstance(WBEMClient client, Linux_DnsAllowTransferForZone dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_DnsAllowTransferForZone newDataInstance = Linux_DnsAllowTransferForZoneHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_DnsAllowTransferForZone modifyInstance(WBEMClient client, Linux_DnsAllowTransferForZone dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_DnsAllowTransferForZone dataInstance2 = Linux_DnsAllowTransferForZoneHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_DnsAllowTransferForZone dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_DnsAllowTransferForZone.getPackages());
    }
