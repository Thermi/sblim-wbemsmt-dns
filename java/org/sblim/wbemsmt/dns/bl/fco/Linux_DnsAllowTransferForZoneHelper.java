...
public class Linux_DnsAllowTransferForZoneHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DnsAllowTransferForZone.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DnsAllowTransferForZone.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_DnsAllowTransferForZoneHelper
                            .findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_DnsAllowTransferForZone.");
                        resultArrayList.add(new Linux_DnsAllowTransferForZone(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DnsAllowTransferForZone.");
                        resultArrayList.add(new Linux_DnsAllowTransferForZone(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DnsAllowTransferForZone.");
                        resultArrayList.add(new Linux_DnsAllowTransferForZone(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DnsAllowTransferForZone getInstance(WBEMClient client,
     ...
     */
    public final static Linux_DnsAllowTransferForZone getInstance(WBEMClient client,
            String namespace, Linux_DnsZone GroupComponent, Linux_DnsAddressMatchList PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                Linux_DnsAllowTransferForZone.PROPERTY_GROUPCOMPONENT_LINUX_DNSZONE.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_DnsAllowTransferForZone.PROPERTY_PARTCOMPONENT_LINUX_DNSADDRESSMATCHLIST.NAME,
     ...
     *
     */
    public final static Linux_DnsAllowTransferForZone createInstance(WBEMClient client,
            Linux_DnsAllowTransferForZone dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DnsAllowTransferForZone newDataInstance = Linux_DnsAllowTransferForZoneHelper
     ...
     */
    public final static Linux_DnsAllowTransferForZone modifyInstance(WBEMClient client,
            Linux_DnsAllowTransferForZone dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DnsAllowTransferForZone dataInstance2 = Linux_DnsAllowTransferForZoneHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_DnsAllowTransferForZone dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DnsAllowTransferForZone.getPackages());
    }
