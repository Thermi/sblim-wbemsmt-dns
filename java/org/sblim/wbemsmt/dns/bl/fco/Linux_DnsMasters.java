...
public class Linux_DnsMasters extends CIM_SettingData {
    ...
    public static class PROPERTY_MASTERELEMENTTYPE {
        ...
        public final static javax.cim.UnsignedInteger8 VALUE_MAP_ENTRY_1_FOR_VALUE_ENTRY_IPv4 = new javax.cim.UnsignedInteger8(
                "1");
        ...
        public final static javax.cim.UnsignedInteger8 VALUE_MAP_ENTRY_2_FOR_VALUE_ENTRY_IPv6 = new javax.cim.UnsignedInteger8(
                "2");
        ...
        public final static javax.cim.UnsignedInteger8 VALUE_MAP_ENTRY_3_FOR_VALUE_ENTRY_NestedMaster = new javax.cim.UnsignedInteger8(
                "3");

        /**
         * constant for value entry NestedMaster (corresponds to mapEntry 3 )
         */
        public final static String VALUE_ENTRY_NestedMaster = "NestedMaster";
         ...
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@5c3987
        ...
        public final static String[] VALUE_ENTRIES = { VALUE_ENTRY_Unknown, VALUE_ENTRY_IPv4,
                VALUE_ENTRY_IPv6, VALUE_ENTRY_NestedMaster };
        ...
        public final static String[] VALUE_ENTRIES_FOR_DISPLAY = { VALUE_ENTRY_Unknown,
                VALUE_ENTRY_IPv4, VALUE_ENTRY_IPv6, VALUE_ENTRY_NestedMaster };
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        propertiesToCheck.put("MasterElementType", new CIMProperty("MasterElementType",
                CIMDataType.UINT8_ARRAY_T, null));
        propertiesToCheck.put("MasterElement", new CIMProperty("MasterElement",
    ...
    public javax.cim.UnsignedInteger8[] get_MasterElementType() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_MASTERELEMENTTYPE.NAME
    ...
    public static CIMProperty create_MasterElementType(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_MasterElementType(CIMProperty currentProperty,
    ...
    public String[] get_MasterElement() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_MASTERELEMENT.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_MasterElement(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_MasterElement(CIMProperty currentProperty,
            String[] newValue) {
        Object setThis = null;
    ...
    public java.util.List getAssociated_Linux_DnsService_Linux_DnsMastersForServices(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_Linux_DnsService_Linux_DnsMastersForServices(cimClient,
    ...
    public java.util.List getAssociated_Linux_DnsService_Linux_DnsMastersForServiceNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_Linux_DnsService_Linux_DnsMastersForServiceNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_LINUX_DNSMASTERSFORSERVICE,
    ...
    public java.util.List getAssociated_Linux_DnsZone_Linux_DnsMastersForZones(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_Linux_DnsZone_Linux_DnsMastersForZones(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_LINUX_DNSMASTERSFORZONE, Linux_DnsZone.CIM_CLASS_NAME,
    ...
    public java.util.List getAssociated_Linux_DnsZone_Linux_DnsMastersForZones(
            WBEMClient cimClient, String resultClass, String role, String resultRole)
            throws WbemsmtException {
    ...
    public java.util.List getAssociated_Linux_DnsZone_Linux_DnsMastersForZoneNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_Linux_DnsZone_Linux_DnsMastersForZoneNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_LINUX_DNSMASTERSFORZONE, Linux_DnsZone.CIM_CLASS_NAME,
                null, null);
    }
