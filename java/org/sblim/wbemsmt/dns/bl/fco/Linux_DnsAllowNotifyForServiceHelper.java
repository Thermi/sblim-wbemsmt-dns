...
public class Linux_DnsAllowNotifyForServiceHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DnsAllowNotifyForService.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DnsAllowNotifyForService.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_DnsAllowNotifyForServiceHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_DnsAllowNotifyForService.");
                        resultArrayList.add(new Linux_DnsAllowNotifyForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DnsAllowNotifyForService.");
                        resultArrayList.add(new Linux_DnsAllowNotifyForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DnsAllowNotifyForService.");
                        resultArrayList.add(new Linux_DnsAllowNotifyForService(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DnsAllowNotifyForService getInstance(WBEMClient client,
    ...
    public final static Linux_DnsAllowNotifyForService getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_DnsAllowNotifyForService.PROPERTY_GROUPCOMPONENT_LINUX_DNSSERVICE.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_DnsAllowNotifyForService.PROPERTY_PARTCOMPONENT_LINUX_DNSADDRESSMATCHLIST.NAME,
     ...
     *
     */
    public final static Linux_DnsAllowNotifyForService createInstance(WBEMClient client,
            Linux_DnsAllowNotifyForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DnsAllowNotifyForService newDataInstance = Linux_DnsAllowNotifyForServiceHelper
     ...
     */
    public final static Linux_DnsAllowNotifyForService modifyInstance(WBEMClient client,
            Linux_DnsAllowNotifyForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DnsAllowNotifyForService dataInstance2 = Linux_DnsAllowNotifyForServiceHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_DnsAllowNotifyForService dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DnsAllowNotifyForService.getPackages());
    }
