...
public class Linux_DnsForwardersForServiceHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DnsForwardersForService.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DnsForwardersForService.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_DnsForwardersForServiceHelper
                            .findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_DnsForwardersForService.");
                        resultArrayList.add(new Linux_DnsForwardersForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DnsForwardersForService.");
                        resultArrayList.add(new Linux_DnsForwardersForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DnsForwardersForService.");
                        resultArrayList.add(new Linux_DnsForwardersForService(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DnsForwardersForService getInstance(WBEMClient client,
     ...
     */
    public final static Linux_DnsForwardersForService getInstance(WBEMClient client,
            String namespace, Linux_DnsService GroupComponent, Linux_DnsForwarders PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                Linux_DnsForwardersForService.PROPERTY_GROUPCOMPONENT_LINUX_DNSSERVICE.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_DnsForwardersForService.PROPERTY_PARTCOMPONENT_LINUX_DNSFORWARDERS.NAME,
                new CIMDataType(Linux_DnsForwarders.CIM_CLASS_NAME), setThis, false, false,
                Linux_DnsForwardersForService.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DnsForwardersForService createInstance(WBEMClient client,
            Linux_DnsForwardersForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DnsForwardersForService newDataInstance = Linux_DnsForwardersForServiceHelper
     ...
     */
    public final static Linux_DnsForwardersForService modifyInstance(WBEMClient client,
            Linux_DnsForwardersForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DnsForwardersForService dataInstance2 = Linux_DnsForwardersForServiceHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_DnsForwardersForService dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DnsForwardersForService.getPackages());
    }
