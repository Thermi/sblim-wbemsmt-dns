/** 
  * Linux_DnsForwardersForServiceHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_DnsForwardersForService
  *    
  * 
  * generated Class
  * @see Linux_DnsForwardersForService
  */
...
public class Linux_DnsForwardersForServiceHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_DnsForwardersForService or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_DnsForwardersForService.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_DnsForwardersForService.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_DnsForwardersForService or the subclasses if deep == true
    */        
    public final static List<Linux_DnsForwardersForService> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_DnsForwardersForService> resultArrayList = new ArrayList<Linux_DnsForwardersForService>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_DnsForwardersForService.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_DnsForwardersForService(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_DnsForwardersForServiceHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_DnsForwardersForService.");
                        resultArrayList.add(new Linux_DnsForwardersForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_DnsForwardersForService.");
                        resultArrayList.add(new Linux_DnsForwardersForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_DnsForwardersForService)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DnsForwardersForService.");
                        resultArrayList.add(new Linux_DnsForwardersForService(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_DnsForwardersForService getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_DnsForwardersForService getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_DnsForwardersForService dataInstance = null;
        Class<?> clazz = Linux_DnsForwardersForServiceHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_DnsForwardersForService)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DnsForwardersForService.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_DnsForwardersForService(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_DnsForwardersForService getInstance(WBEMClient client, String namespace
                                                       ,Linux_DnsService GroupComponent
                                                       ,Linux_DnsForwarders PartComponent
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_DnsForwardersForService.PROPERTY_GROUPCOMPONENT_LINUX_DNSSERVICE.NAME,new CIMDataType(Linux_DnsService.CIM_CLASS_NAME),setThis,false,false,Linux_DnsForwardersForService.CIM_CLASS_NAME); 
                   
                                 setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_DnsForwardersForService.PROPERTY_PARTCOMPONENT_LINUX_DNSFORWARDERS.NAME,new CIMDataType(Linux_DnsForwarders.CIM_CLASS_NAME),setThis,false,false,Linux_DnsForwardersForService.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_DnsForwardersForService.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_DnsForwardersForService createInstance(WBEMClient client, Linux_DnsForwardersForService dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_DnsForwardersForService newDataInstance = Linux_DnsForwardersForServiceHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_DnsForwardersForService modifyInstance(WBEMClient client, Linux_DnsForwardersForService dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_DnsForwardersForService dataInstance2 = Linux_DnsForwardersForServiceHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_DnsForwardersForService dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_DnsForwardersForService.getPackages());
    }
