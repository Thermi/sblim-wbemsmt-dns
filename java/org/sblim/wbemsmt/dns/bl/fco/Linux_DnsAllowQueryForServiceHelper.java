...
public class Linux_DnsAllowQueryForServiceHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DnsAllowQueryForService.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DnsAllowQueryForService.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_DnsAllowQueryForServiceHelper
                            .findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_DnsAllowQueryForService.");
                        resultArrayList.add(new Linux_DnsAllowQueryForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DnsAllowQueryForService.");
                        resultArrayList.add(new Linux_DnsAllowQueryForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DnsAllowQueryForService.");
                        resultArrayList.add(new Linux_DnsAllowQueryForService(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DnsAllowQueryForService getInstance(WBEMClient client,
    ...
    public final static Linux_DnsAllowQueryForService getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_DnsAllowQueryForService.PROPERTY_GROUPCOMPONENT_LINUX_DNSSERVICE.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_DnsAllowQueryForService.PROPERTY_PARTCOMPONENT_LINUX_DNSADDRESSMATCHLIST.NAME,
     ...
     *
     */
    public final static Linux_DnsAllowQueryForService createInstance(WBEMClient client,
            Linux_DnsAllowQueryForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DnsAllowQueryForService newDataInstance = Linux_DnsAllowQueryForServiceHelper
     ...
     */
    public final static Linux_DnsAllowQueryForService modifyInstance(WBEMClient client,
            Linux_DnsAllowQueryForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DnsAllowQueryForService dataInstance2 = Linux_DnsAllowQueryForServiceHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_DnsAllowQueryForService dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DnsAllowQueryForService.getPackages());
    }
