/** 
  * Linux_DnsAllowRecursionForServiceHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_DnsAllowRecursionForService
  *    
  * 
  * generated Class
  * @see Linux_DnsAllowRecursionForService
  */
...
public class Linux_DnsAllowRecursionForServiceHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_DnsAllowRecursionForService or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_DnsAllowRecursionForService.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_DnsAllowRecursionForService.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_DnsAllowRecursionForService or the subclasses if deep == true
    */        
    public final static List<Linux_DnsAllowRecursionForService> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_DnsAllowRecursionForService> resultArrayList = new ArrayList<Linux_DnsAllowRecursionForService>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_DnsAllowRecursionForService.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_DnsAllowRecursionForService(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_DnsAllowRecursionForServiceHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_DnsAllowRecursionForService.");
                        resultArrayList.add(new Linux_DnsAllowRecursionForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_DnsAllowRecursionForService.");
                        resultArrayList.add(new Linux_DnsAllowRecursionForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_DnsAllowRecursionForService)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DnsAllowRecursionForService.");
                        resultArrayList.add(new Linux_DnsAllowRecursionForService(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_DnsAllowRecursionForService getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_DnsAllowRecursionForService getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_DnsAllowRecursionForService dataInstance = null;
        Class<?> clazz = Linux_DnsAllowRecursionForServiceHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_DnsAllowRecursionForService)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DnsAllowRecursionForService.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_DnsAllowRecursionForService(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_DnsAllowRecursionForService getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_DnsAllowRecursionForService.PROPERTY_GROUPCOMPONENT_LINUX_DNSSERVICE.NAME,new CIMDataType(Linux_DnsService.CIM_CLASS_NAME),setThis,false,false,Linux_DnsAllowRecursionForService.CIM_CLASS_NAME); 
                   
                                 setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_DnsAllowRecursionForService.PROPERTY_PARTCOMPONENT_LINUX_DNSADDRESSMATCHLIST.NAME,new CIMDataType(Linux_DnsAddressMatchList.CIM_CLASS_NAME),setThis,false,false,Linux_DnsAllowRecursionForService.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_DnsAllowRecursionForService.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_DnsAllowRecursionForService createInstance(WBEMClient client, Linux_DnsAllowRecursionForService dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_DnsAllowRecursionForService newDataInstance = Linux_DnsAllowRecursionForServiceHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_DnsAllowRecursionForService modifyInstance(WBEMClient client, Linux_DnsAllowRecursionForService dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_DnsAllowRecursionForService dataInstance2 = Linux_DnsAllowRecursionForServiceHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_DnsAllowRecursionForService dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_DnsAllowRecursionForService.getPackages());
    }
