/**
 * Linux_DnsAllowTransferForService.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED
 ...
 *            hosting the list of elements that are allowed to support the request type: transfer.
 *            generated Class
 */
...
public class Linux_DnsAllowTransferForService extends CIM_Component {
    ...
    public Linux_DnsAllowTransferForService(WBEMClient client, String namespace)
    ...
    public Linux_DnsAllowTransferForService(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_DnsAllowTransferForService() {
    }
    ...
    public static CIMProperty create_GroupComponent_Linux_DnsService(WBEMClient client,
        ...
        Linux_DnsAllowTransferForService fco = new Linux_DnsAllowTransferForService(client,
                namespace);
    ...
    public String getObjectName() {
        return Linux_DnsAllowTransferForService.CIM_CLASS_NAME;
    }
