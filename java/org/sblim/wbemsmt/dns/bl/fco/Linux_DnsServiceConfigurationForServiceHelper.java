...
public class Linux_DnsServiceConfigurationForServiceHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(
                Linux_DnsServiceConfigurationForService.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    Linux_DnsServiceConfigurationForService.CIM_CLASS_NAME)) {
                        resultArrayList
                                .add(new Linux_DnsServiceConfigurationForService(cimInstance));
                        continue;
                    }
                    Class clazz = Linux_DnsServiceConfigurationForServiceHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_DnsServiceConfigurationForService.");
                        resultArrayList
                                .add(new Linux_DnsServiceConfigurationForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DnsServiceConfigurationForService.");
                        resultArrayList
                                .add(new Linux_DnsServiceConfigurationForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DnsServiceConfigurationForService.");
                        resultArrayList
                                .add(new Linux_DnsServiceConfigurationForService(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DnsServiceConfigurationForService getInstance(WBEMClient client,
     ...
     */
    public final static Linux_DnsServiceConfigurationForService getInstance(WBEMClient client,
            String namespace, Linux_DnsService Element, Linux_DnsServiceConfiguration Configuration
        ...
        keyProperties[0] = new CIMProperty(
                Linux_DnsServiceConfigurationForService.PROPERTY_ELEMENT_LINUX_DNSSERVICE.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_DnsServiceConfigurationForService.PROPERTY_CONFIGURATION_LINUX_DNSSERVICECONFIGURATION.NAME,
                new CIMDataType(Linux_DnsServiceConfiguration.CIM_CLASS_NAME), setThis, false,
                false, Linux_DnsServiceConfigurationForService.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DnsServiceConfigurationForService createInstance(WBEMClient client,
            Linux_DnsServiceConfigurationForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DnsServiceConfigurationForService newDataInstance = Linux_DnsServiceConfigurationForServiceHelper
     ...
     */
    public final static Linux_DnsServiceConfigurationForService modifyInstance(WBEMClient client,
            Linux_DnsServiceConfigurationForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DnsServiceConfigurationForService dataInstance2 = Linux_DnsServiceConfigurationForServiceHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_DnsServiceConfigurationForService dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DnsServiceConfigurationForService.getPackages());
    }
