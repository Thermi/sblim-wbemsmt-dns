/** 
  * Linux_DnsServiceConfigurationForServiceHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_DnsServiceConfigurationForService
  *    
  * 
  * generated Class
  * @see Linux_DnsServiceConfigurationForService
  */
...
public class Linux_DnsServiceConfigurationForServiceHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_DnsServiceConfigurationForService or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_DnsServiceConfigurationForService.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_DnsServiceConfigurationForService.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_DnsServiceConfigurationForService or the subclasses if deep == true
    */        
    public final static List<Linux_DnsServiceConfigurationForService> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_DnsServiceConfigurationForService> resultArrayList = new ArrayList<Linux_DnsServiceConfigurationForService>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_DnsServiceConfigurationForService.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_DnsServiceConfigurationForService(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_DnsServiceConfigurationForServiceHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_DnsServiceConfigurationForService.");
                        resultArrayList.add(new Linux_DnsServiceConfigurationForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_DnsServiceConfigurationForService.");
                        resultArrayList.add(new Linux_DnsServiceConfigurationForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_DnsServiceConfigurationForService)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DnsServiceConfigurationForService.");
                        resultArrayList.add(new Linux_DnsServiceConfigurationForService(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_DnsServiceConfigurationForService getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_DnsServiceConfigurationForService getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_DnsServiceConfigurationForService dataInstance = null;
        Class<?> clazz = Linux_DnsServiceConfigurationForServiceHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_DnsServiceConfigurationForService)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DnsServiceConfigurationForService.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_DnsServiceConfigurationForService(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_DnsServiceConfigurationForService getInstance(WBEMClient client, String namespace
                                                       ,Linux_DnsService Element
                                                       ,Linux_DnsServiceConfiguration Configuration
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_DnsServiceConfigurationForService.PROPERTY_ELEMENT_LINUX_DNSSERVICE.NAME,new CIMDataType(Linux_DnsService.CIM_CLASS_NAME),setThis,false,false,Linux_DnsServiceConfigurationForService.CIM_CLASS_NAME); 
                   
                                 setThis = Configuration != null ? Configuration.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_DnsServiceConfigurationForService.PROPERTY_CONFIGURATION_LINUX_DNSSERVICECONFIGURATION.NAME,new CIMDataType(Linux_DnsServiceConfiguration.CIM_CLASS_NAME),setThis,false,false,Linux_DnsServiceConfigurationForService.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_DnsServiceConfigurationForService.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_DnsServiceConfigurationForService createInstance(WBEMClient client, Linux_DnsServiceConfigurationForService dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_DnsServiceConfigurationForService newDataInstance = Linux_DnsServiceConfigurationForServiceHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_DnsServiceConfigurationForService modifyInstance(WBEMClient client, Linux_DnsServiceConfigurationForService dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_DnsServiceConfigurationForService dataInstance2 = Linux_DnsServiceConfigurationForServiceHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_DnsServiceConfigurationForService dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_DnsServiceConfigurationForService.getPackages());
    }
