/**
 * Linux_DnsAllowQueryForZone.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class Linux_DnsAllowQueryForZone extends CIM_Component {
    ...
    public Linux_DnsAllowQueryForZone(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public Linux_DnsAllowQueryForZone(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_DnsAllowQueryForZone() {
    }
    ...
    public static CIMProperty create_GroupComponent_Linux_DnsZone(WBEMClient client,
        ...
        Linux_DnsAllowQueryForZone fco = new Linux_DnsAllowQueryForZone(client, namespace);
    ...
    public String getObjectName() {
        return Linux_DnsAllowQueryForZone.CIM_CLASS_NAME;
    }
