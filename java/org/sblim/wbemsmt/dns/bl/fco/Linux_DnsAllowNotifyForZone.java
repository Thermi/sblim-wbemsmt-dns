/**
 * Linux_DnsAllowNotifyForZone.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class Linux_DnsAllowNotifyForZone extends CIM_Component {
    ...
    public Linux_DnsAllowNotifyForZone(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public Linux_DnsAllowNotifyForZone(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_DnsAllowNotifyForZone() {
    }
    ...
    public static CIMProperty create_GroupComponent_Linux_DnsZone(WBEMClient client,
        ...
        Linux_DnsAllowNotifyForZone fco = new Linux_DnsAllowNotifyForZone(client, namespace);
    ...
    public String getObjectName() {
        return Linux_DnsAllowNotifyForZone.CIM_CLASS_NAME;
    }
