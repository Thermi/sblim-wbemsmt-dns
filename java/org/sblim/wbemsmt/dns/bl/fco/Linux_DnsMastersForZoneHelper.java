...
public class Linux_DnsMastersForZoneHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DnsMastersForZone.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DnsMastersForZone.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DnsMastersForZone.");
                        resultArrayList.add(new Linux_DnsMastersForZone(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DnsMastersForZone.");
                        resultArrayList.add(new Linux_DnsMastersForZone(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DnsMastersForZone.");
                        resultArrayList.add(new Linux_DnsMastersForZone(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DnsMastersForZone getInstance(WBEMClient client,
    ...
    public final static Linux_DnsMastersForZone getInstance(WBEMClient client, String namespace,
            Linux_DnsZone GroupComponent, Linux_DnsMasters PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                Linux_DnsMastersForZone.PROPERTY_GROUPCOMPONENT_LINUX_DNSZONE.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_DnsMastersForZone.PROPERTY_PARTCOMPONENT_LINUX_DNSMASTERS.NAME,
     ...
     *
     */
    public final static Linux_DnsMastersForZone createInstance(WBEMClient client,
            Linux_DnsMastersForZone dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DnsMastersForZone newDataInstance = Linux_DnsMastersForZoneHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static Linux_DnsMastersForZone modifyInstance(WBEMClient client,
            Linux_DnsMastersForZone dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DnsMastersForZone dataInstance2 = Linux_DnsMastersForZoneHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_DnsMastersForZone dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DnsMastersForZone.getPackages());
    }
