/** 
  * Linux_DnsMastersForZoneHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_DnsMastersForZone
  *    
  * 
  * generated Class
  * @see Linux_DnsMastersForZone
  */
...
public class Linux_DnsMastersForZoneHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_DnsMastersForZone or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_DnsMastersForZone.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_DnsMastersForZone.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_DnsMastersForZone or the subclasses if deep == true
    */        
    public final static List<Linux_DnsMastersForZone> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_DnsMastersForZone> resultArrayList = new ArrayList<Linux_DnsMastersForZone>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_DnsMastersForZone.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_DnsMastersForZone(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_DnsMastersForZoneHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_DnsMastersForZone.");
                        resultArrayList.add(new Linux_DnsMastersForZone(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_DnsMastersForZone.");
                        resultArrayList.add(new Linux_DnsMastersForZone(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_DnsMastersForZone)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DnsMastersForZone.");
                        resultArrayList.add(new Linux_DnsMastersForZone(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_DnsMastersForZone getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_DnsMastersForZone getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_DnsMastersForZone dataInstance = null;
        Class<?> clazz = Linux_DnsMastersForZoneHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_DnsMastersForZone)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DnsMastersForZone.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_DnsMastersForZone(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_DnsMastersForZone getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_DnsMastersForZone.PROPERTY_GROUPCOMPONENT_LINUX_DNSZONE.NAME,new CIMDataType(Linux_DnsZone.CIM_CLASS_NAME),setThis,false,false,Linux_DnsMastersForZone.CIM_CLASS_NAME); 
                   
                                 setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_DnsMastersForZone.PROPERTY_PARTCOMPONENT_LINUX_DNSMASTERS.NAME,new CIMDataType(Linux_DnsMasters.CIM_CLASS_NAME),setThis,false,false,Linux_DnsMastersForZone.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_DnsMastersForZone.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_DnsMastersForZone createInstance(WBEMClient client, Linux_DnsMastersForZone dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_DnsMastersForZone newDataInstance = Linux_DnsMastersForZoneHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_DnsMastersForZone modifyInstance(WBEMClient client, Linux_DnsMastersForZone dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_DnsMastersForZone dataInstance2 = Linux_DnsMastersForZoneHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_DnsMastersForZone dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_DnsMastersForZone.getPackages());
    }
