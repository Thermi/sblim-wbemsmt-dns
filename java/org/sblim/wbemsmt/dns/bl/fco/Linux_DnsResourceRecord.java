...
public class Linux_DnsResourceRecord extends CIM_SettingData {
    ...
    public static class PROPERTY_FAMILY {
        ...
        public final static javax.cim.UnsignedInteger8 VALUE_MAP_ENTRY_1_FOR_VALUE_ENTRY_Internet = new javax.cim.UnsignedInteger8(
                "1");

        /**
         * constant for value entry Internet (corresponds to mapEntry 1 )
         */
        public final static String VALUE_ENTRY_Internet = "Internet";

        /**
         * constant for value map entry 2
         */

        public final static javax.cim.UnsignedInteger8 VALUE_MAP_ENTRY_2_FOR_VALUE_ENTRY_Hesiod = new javax.cim.UnsignedInteger8(
                "2");

        /**
         * constant for value entry Hesiod (corresponds to mapEntry 2 )
         */
        public final static String VALUE_ENTRY_Hesiod = "Hesiod";

        /**
         * constant for value map entry 3
         */

        public final static javax.cim.UnsignedInteger8 VALUE_MAP_ENTRY_3_FOR_VALUE_ENTRY_Chaos = new javax.cim.UnsignedInteger8(
                "3");

        /**
         * constant for value entry Chaos (corresponds to mapEntry 3 )
         */
        public final static String VALUE_ENTRY_Chaos = "Chaos";
        ...
        public final static javax.cim.UnsignedInteger8[] VALUE_MAP_ENTRIES = {
                ...
                VALUE_MAP_ENTRY_2_FOR_VALUE_ENTRY_Hesiod, VALUE_MAP_ENTRY_3_FOR_VALUE_ENTRY_Chaos };
         ...
         * Value Map for the property Family   
         */
        public final static String[] VALUE_ENTRIES = { VALUE_ENTRY_Unknown, VALUE_ENTRY_Internet,
                VALUE_ENTRY_Hesiod, VALUE_ENTRY_Chaos };
        ...
        public final static String[] VALUE_ENTRIES_FOR_DISPLAY = { VALUE_ENTRY_Unknown,
                VALUE_ENTRY_Internet, VALUE_ENTRY_Hesiod, VALUE_ENTRY_Chaos };
    ...
    public static CIMProperty create_key_Type(WBEMClient client, String namespace, String newValue)
            throws WbemsmtException {
        Linux_DnsResourceRecord fco = new Linux_DnsResourceRecord(client, namespace);
    ...
    private static CIMProperty setPropertyValue_key_Type(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public String get_key_Value() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_VALUE.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_key_Value(WBEMClient client, String namespace, String newValue)
            throws WbemsmtException {
        Linux_DnsResourceRecord fco = new Linux_DnsResourceRecord(client, namespace);
    ...
    private static CIMProperty setPropertyValue_key_Value(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public String get_key_ZoneName() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_ZONENAME.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_key_ZoneName(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_key_ZoneName(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public java.util.List getAssociated_Linux_DnsZone_Linux_DnsResourceRecordsForZones(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_Linux_DnsZone_Linux_DnsResourceRecordsForZones(cimClient,
    ...
    public java.util.List getAssociated_Linux_DnsZone_Linux_DnsResourceRecordsForZoneNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_Linux_DnsZone_Linux_DnsResourceRecordsForZoneNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_LINUX_DNSRESOURCERECORDSFORZONE,
