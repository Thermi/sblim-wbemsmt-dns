/** 
  * Linux_DnsForwardersForZoneHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_DnsForwardersForZone
  *    
  * 
  * generated Class
  * @see Linux_DnsForwardersForZone
  */
...
public class Linux_DnsForwardersForZoneHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_DnsForwardersForZone or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_DnsForwardersForZone.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_DnsForwardersForZone.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_DnsForwardersForZone or the subclasses if deep == true
    */        
    public final static List<Linux_DnsForwardersForZone> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_DnsForwardersForZone> resultArrayList = new ArrayList<Linux_DnsForwardersForZone>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_DnsForwardersForZone.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_DnsForwardersForZone(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_DnsForwardersForZoneHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_DnsForwardersForZone.");
                        resultArrayList.add(new Linux_DnsForwardersForZone(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_DnsForwardersForZone.");
                        resultArrayList.add(new Linux_DnsForwardersForZone(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_DnsForwardersForZone)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DnsForwardersForZone.");
                        resultArrayList.add(new Linux_DnsForwardersForZone(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_DnsForwardersForZone getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_DnsForwardersForZone getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_DnsForwardersForZone dataInstance = null;
        Class<?> clazz = Linux_DnsForwardersForZoneHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_DnsForwardersForZone)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DnsForwardersForZone.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_DnsForwardersForZone(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_DnsForwardersForZone getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_DnsForwardersForZone.PROPERTY_GROUPCOMPONENT_LINUX_DNSZONE.NAME,new CIMDataType(Linux_DnsZone.CIM_CLASS_NAME),setThis,false,false,Linux_DnsForwardersForZone.CIM_CLASS_NAME); 
                   
                                 setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_DnsForwardersForZone.PROPERTY_PARTCOMPONENT_LINUX_DNSFORWARDERS.NAME,new CIMDataType(Linux_DnsForwarders.CIM_CLASS_NAME),setThis,false,false,Linux_DnsForwardersForZone.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_DnsForwardersForZone.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_DnsForwardersForZone createInstance(WBEMClient client, Linux_DnsForwardersForZone dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_DnsForwardersForZone newDataInstance = Linux_DnsForwardersForZoneHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_DnsForwardersForZone modifyInstance(WBEMClient client, Linux_DnsForwardersForZone dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_DnsForwardersForZone dataInstance2 = Linux_DnsForwardersForZoneHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_DnsForwardersForZone dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_DnsForwardersForZone.getPackages());
    }
