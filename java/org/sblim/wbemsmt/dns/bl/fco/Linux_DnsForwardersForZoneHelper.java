...
public class Linux_DnsForwardersForZoneHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DnsForwardersForZone.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DnsForwardersForZone.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DnsForwardersForZone.");
                        resultArrayList.add(new Linux_DnsForwardersForZone(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DnsForwardersForZone.");
                        resultArrayList.add(new Linux_DnsForwardersForZone(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DnsForwardersForZone.");
                        resultArrayList.add(new Linux_DnsForwardersForZone(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DnsForwardersForZone getInstance(WBEMClient client,
    ...
    public final static Linux_DnsForwardersForZone getInstance(WBEMClient client, String namespace,
            Linux_DnsZone GroupComponent, Linux_DnsForwarders PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                Linux_DnsForwardersForZone.PROPERTY_GROUPCOMPONENT_LINUX_DNSZONE.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_DnsForwardersForZone.PROPERTY_PARTCOMPONENT_LINUX_DNSFORWARDERS.NAME,
     ...
     *
     */
    public final static Linux_DnsForwardersForZone createInstance(WBEMClient client,
            Linux_DnsForwardersForZone dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DnsForwardersForZone newDataInstance = Linux_DnsForwardersForZoneHelper.getInstance(
     ...
     */
    public final static Linux_DnsForwardersForZone modifyInstance(WBEMClient client,
            Linux_DnsForwardersForZone dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DnsForwardersForZone dataInstance2 = Linux_DnsForwardersForZoneHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_DnsForwardersForZone dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DnsForwardersForZone.getPackages());
    }
