/**
 * Linux_DnsSlaveZone.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS
 ...
 *            Karnam<prkarnam@in.ibm.com> Description: Class representing DNS zones of type Slave.
 *            generated Class
 */
...
public class Linux_DnsSlaveZone extends Linux_DnsZone {
    ...
    public Linux_DnsSlaveZone(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public Linux_DnsSlaveZone(CIMInstance cimInstance) throws WbemsmtException {
    ...
    public static CIMProperty create_Forward(WBEMClient client, String namespace,
        ...
        Linux_DnsSlaveZone fco = new Linux_DnsSlaveZone(client, namespace);
    ...
    public String getObjectName() {
        return Linux_DnsSlaveZone.CIM_CLASS_NAME;
    }
