...
public class Linux_DnsServiceHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DnsService.CIM_CLASS_NAME,
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DnsService.");
                        resultArrayList.add(new Linux_DnsService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DnsService.");
                        resultArrayList.add(new Linux_DnsService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DnsService.");
                        resultArrayList.add(new Linux_DnsService(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DnsService getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static Linux_DnsService getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static Linux_DnsService getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(Linux_DnsService.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_DnsService.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(Linux_DnsService.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_DnsService.CIM_CLASS_NAME);

        setThis = SystemCreationClassName;

        keyProperties[2] = new CIMProperty(Linux_DnsService.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_DnsService.CIM_CLASS_NAME);

        setThis = SystemName;

        keyProperties[3] = new CIMProperty(Linux_DnsService.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_DnsService.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DnsService createInstance(WBEMClient client,
            Linux_DnsService dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        Linux_DnsService newDataInstance = Linux_DnsServiceHelper
     ...
     */
    public final static Linux_DnsService modifyInstance(WBEMClient client,
            Linux_DnsService dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DnsService dataInstance2 = Linux_DnsServiceHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_DnsService dataInstance)
            throws WbemsmtException {
