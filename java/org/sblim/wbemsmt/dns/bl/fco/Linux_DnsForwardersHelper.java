...
public class Linux_DnsForwardersHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DnsForwarders.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DnsForwarders.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName()
                                    .equals(Linux_DnsForwarders.CIM_CLASS_NAME)) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_DnsForwarders.");
                        resultArrayList.add(new Linux_DnsForwarders(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DnsForwarders.");
                        resultArrayList.add(new Linux_DnsForwarders(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DnsForwarders.");
                        resultArrayList.add(new Linux_DnsForwarders(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DnsForwarders getInstance(WBEMClient client,
     ...
     */
    public final static Linux_DnsForwarders getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static Linux_DnsForwarders getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(Linux_DnsForwarders.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_DnsForwarders.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(Linux_DnsForwarders.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_DnsForwarders.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DnsForwarders createInstance(WBEMClient client,
            Linux_DnsForwarders dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        Linux_DnsForwarders newDataInstance = Linux_DnsForwardersHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static Linux_DnsForwarders modifyInstance(WBEMClient client,
            Linux_DnsForwarders dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DnsForwarders dataInstance2 = Linux_DnsForwardersHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_DnsForwarders dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DnsForwarders.getPackages());
    }
