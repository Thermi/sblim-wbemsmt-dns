...
public class Linux_DnsBlackholeForService extends CIM_Component {
    ...
    public Linux_DnsBlackholeForService(WBEMClient client, String namespace)
    ...
    public Linux_DnsBlackholeForService(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_DnsBlackholeForService() {
    }
    ...
    public static CIMProperty create_GroupComponent_Linux_DnsService(WBEMClient client,
        ...
        Linux_DnsBlackholeForService fco = new Linux_DnsBlackholeForService(client, namespace);
    ...
    public String getObjectName() {
        return Linux_DnsBlackholeForService.CIM_CLASS_NAME;
    }
