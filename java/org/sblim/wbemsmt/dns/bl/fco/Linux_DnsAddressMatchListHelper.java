...
public class Linux_DnsAddressMatchListHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DnsAddressMatchList.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DnsAddressMatchList.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DnsAddressMatchList.");
                        resultArrayList.add(new Linux_DnsAddressMatchList(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DnsAddressMatchList.");
                        resultArrayList.add(new Linux_DnsAddressMatchList(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DnsAddressMatchList.");
                        resultArrayList.add(new Linux_DnsAddressMatchList(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DnsAddressMatchList getInstance(WBEMClient client,
    ...
    public final static Linux_DnsAddressMatchList getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(Linux_DnsAddressMatchList.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                Linux_DnsAddressMatchList.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(Linux_DnsAddressMatchList.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                Linux_DnsAddressMatchList.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DnsAddressMatchList createInstance(WBEMClient client,
            Linux_DnsAddressMatchList dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DnsAddressMatchList newDataInstance = Linux_DnsAddressMatchListHelper.getInstance(
     ...
     */
    public final static Linux_DnsAddressMatchList modifyInstance(WBEMClient client,
            Linux_DnsAddressMatchList dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DnsAddressMatchList dataInstance2 = Linux_DnsAddressMatchListHelper.getInstance(
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_DnsAddressMatchList dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DnsAddressMatchList.getPackages());
    }
