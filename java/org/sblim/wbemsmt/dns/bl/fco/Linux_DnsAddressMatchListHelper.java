/** 
  * Linux_DnsAddressMatchListHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_DnsAddressMatchList
  *    
  * 
  * generated Class
  * @see Linux_DnsAddressMatchList
  */
...
public class Linux_DnsAddressMatchListHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_DnsAddressMatchList or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_DnsAddressMatchList.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_DnsAddressMatchList.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_DnsAddressMatchList or the subclasses if deep == true
    */        
    public final static List<Linux_DnsAddressMatchList> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_DnsAddressMatchList> resultArrayList = new ArrayList<Linux_DnsAddressMatchList>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_DnsAddressMatchList.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_DnsAddressMatchList(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_DnsAddressMatchListHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_DnsAddressMatchList.");
                        resultArrayList.add(new Linux_DnsAddressMatchList(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_DnsAddressMatchList.");
                        resultArrayList.add(new Linux_DnsAddressMatchList(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_DnsAddressMatchList)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DnsAddressMatchList.");
                        resultArrayList.add(new Linux_DnsAddressMatchList(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_DnsAddressMatchList getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_DnsAddressMatchList getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_DnsAddressMatchList dataInstance = null;
        Class<?> clazz = Linux_DnsAddressMatchListHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_DnsAddressMatchList)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DnsAddressMatchList.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_DnsAddressMatchList(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_DnsAddressMatchList getInstance(WBEMClient client, String namespace
                                                       ,String InstanceID
                                                       ,String Name
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_DnsAddressMatchList.PROPERTY_INSTANCEID.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_DnsAddressMatchList.CIM_CLASS_NAME); 
                   
                   setThis = Name;
                
           keyProperties[1]  = new CIMProperty(Linux_DnsAddressMatchList.PROPERTY_NAME.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_DnsAddressMatchList.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_DnsAddressMatchList.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_DnsAddressMatchList createInstance(WBEMClient client, Linux_DnsAddressMatchList dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_DnsAddressMatchList newDataInstance = Linux_DnsAddressMatchListHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_DnsAddressMatchList modifyInstance(WBEMClient client, Linux_DnsAddressMatchList dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_DnsAddressMatchList dataInstance2 = Linux_DnsAddressMatchListHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_DnsAddressMatchList dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_DnsAddressMatchList.getPackages());
    }
