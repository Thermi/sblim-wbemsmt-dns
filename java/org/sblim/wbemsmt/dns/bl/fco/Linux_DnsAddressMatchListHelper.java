...
public final class Linux_DnsAddressMatchListHelper {
	...
	*/	
	public final static Linux_DnsAddressMatchList getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_DnsAddressMatchListHelper.getInstance(cimClient, new Linux_DnsAddressMatchList(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_DnsAddressMatchList getInstance(CIMClient cimClient, Linux_DnsAddressMatchList dataInstance) {
		...
		return Linux_DnsAddressMatchListHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_DnsAddressMatchList getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			...
			{
				dataInstance = new Linux_DnsAddressMatchList(cimObjectPath, cimInstance);
			}
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = Linux_DnsAddressMatchList.getPackages();
	...
	*/	
	public final static Linux_DnsAddressMatchList createInstance(CIMClient cimClient, Linux_DnsAddressMatchList dataInstance, boolean notifyDifferencies){ 
		...
		Linux_DnsAddressMatchList newDataInstance = null;
		try {
			newDataInstance = Linux_DnsAddressMatchListHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_DnsAddressMatchList modifyInstance(CIMClient cimClient, Linux_DnsAddressMatchList dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_DnsAddressMatchListHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_DnsAddressMatchList dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_DnsAddressMatchList dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_DnsAddressMatchList.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_DnsAddressMatchList.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_DnsAddressMatchList.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_DnsAddressMatchList.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_DnsAddressMatchList.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_AddressMatchListElementType(UnsignedInt8[] AddressMatchListElementType) {
		return true;
	}

	public static boolean isValid_AddressMatchListElement(String[] AddressMatchListElement) {
		return true;
	}
