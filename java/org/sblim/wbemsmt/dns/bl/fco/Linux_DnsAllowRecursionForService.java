/**
 * Linux_DnsAllowRecursionForService.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED
 ...
 *            hosting the list of elements that are allowed to support the request type: recursion.
 *            generated Class
 */
...
public class Linux_DnsAllowRecursionForService extends CIM_Component {
    ...
    public Linux_DnsAllowRecursionForService(WBEMClient client, String namespace)
    ...
    public Linux_DnsAllowRecursionForService(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_DnsAllowRecursionForService() {
    }
    ...
    public static CIMProperty create_GroupComponent_Linux_DnsService(WBEMClient client,
        ...
        Linux_DnsAllowRecursionForService fco = new Linux_DnsAllowRecursionForService(client,
                namespace);
    ...
    public String getObjectName() {
        return Linux_DnsAllowRecursionForService.CIM_CLASS_NAME;
    }
