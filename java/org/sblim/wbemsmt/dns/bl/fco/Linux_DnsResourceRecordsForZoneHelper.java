/** 
  * Linux_DnsResourceRecordsForZoneHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_DnsResourceRecordsForZone
  *    
  * 
  * generated Class
  * @see Linux_DnsResourceRecordsForZone
  */
...
public class Linux_DnsResourceRecordsForZoneHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_DnsResourceRecordsForZone or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_DnsResourceRecordsForZone.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_DnsResourceRecordsForZone.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_DnsResourceRecordsForZone or the subclasses if deep == true
    */        
    public final static List<Linux_DnsResourceRecordsForZone> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_DnsResourceRecordsForZone> resultArrayList = new ArrayList<Linux_DnsResourceRecordsForZone>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_DnsResourceRecordsForZone.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_DnsResourceRecordsForZone(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_DnsResourceRecordsForZoneHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_DnsResourceRecordsForZone.");
                        resultArrayList.add(new Linux_DnsResourceRecordsForZone(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_DnsResourceRecordsForZone.");
                        resultArrayList.add(new Linux_DnsResourceRecordsForZone(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_DnsResourceRecordsForZone)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DnsResourceRecordsForZone.");
                        resultArrayList.add(new Linux_DnsResourceRecordsForZone(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_DnsResourceRecordsForZone getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_DnsResourceRecordsForZone getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_DnsResourceRecordsForZone dataInstance = null;
        Class<?> clazz = Linux_DnsResourceRecordsForZoneHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_DnsResourceRecordsForZone)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DnsResourceRecordsForZone.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_DnsResourceRecordsForZone(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_DnsResourceRecordsForZone getInstance(WBEMClient client, String namespace
                                                       ,Linux_DnsZone GroupComponent
                                                       ,Linux_DnsResourceRecord PartComponent
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_DnsResourceRecordsForZone.PROPERTY_GROUPCOMPONENT_LINUX_DNSZONE.NAME,new CIMDataType(Linux_DnsZone.CIM_CLASS_NAME),setThis,false,false,Linux_DnsResourceRecordsForZone.CIM_CLASS_NAME); 
                   
                                 setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(Linux_DnsResourceRecordsForZone.PROPERTY_PARTCOMPONENT_LINUX_DNSRESOURCERECORD.NAME,new CIMDataType(Linux_DnsResourceRecord.CIM_CLASS_NAME),setThis,false,false,Linux_DnsResourceRecordsForZone.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_DnsResourceRecordsForZone.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_DnsResourceRecordsForZone createInstance(WBEMClient client, Linux_DnsResourceRecordsForZone dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_DnsResourceRecordsForZone newDataInstance = Linux_DnsResourceRecordsForZoneHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_DnsResourceRecordsForZone modifyInstance(WBEMClient client, Linux_DnsResourceRecordsForZone dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_DnsResourceRecordsForZone dataInstance2 = Linux_DnsResourceRecordsForZoneHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_DnsResourceRecordsForZone dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_DnsResourceRecordsForZone.getPackages());
    }
