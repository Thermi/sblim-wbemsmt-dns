...
public class Linux_DnsResourceRecordsForZoneHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DnsResourceRecordsForZone.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DnsResourceRecordsForZone.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = Linux_DnsResourceRecordsForZoneHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class Linux_DnsResourceRecordsForZone.");
                        resultArrayList.add(new Linux_DnsResourceRecordsForZone(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DnsResourceRecordsForZone.");
                        resultArrayList.add(new Linux_DnsResourceRecordsForZone(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DnsResourceRecordsForZone.");
                        resultArrayList.add(new Linux_DnsResourceRecordsForZone(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DnsResourceRecordsForZone getInstance(WBEMClient client,
     ...
     */
    public final static Linux_DnsResourceRecordsForZone getInstance(WBEMClient client,
            String namespace, Linux_DnsZone GroupComponent, Linux_DnsResourceRecord PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                Linux_DnsResourceRecordsForZone.PROPERTY_GROUPCOMPONENT_LINUX_DNSZONE.NAME,
                new CIMDataType(Linux_DnsZone.CIM_CLASS_NAME), setThis, false, false,
                Linux_DnsResourceRecordsForZone.CIM_CLASS_NAME);

        setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                Linux_DnsResourceRecordsForZone.PROPERTY_PARTCOMPONENT_LINUX_DNSRESOURCERECORD.NAME,
                new CIMDataType(Linux_DnsResourceRecord.CIM_CLASS_NAME), setThis, false, false,
                Linux_DnsResourceRecordsForZone.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DnsResourceRecordsForZone createInstance(WBEMClient client,
            Linux_DnsResourceRecordsForZone dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DnsResourceRecordsForZone newDataInstance = Linux_DnsResourceRecordsForZoneHelper
     ...
     */
    public final static Linux_DnsResourceRecordsForZone modifyInstance(WBEMClient client,
            Linux_DnsResourceRecordsForZone dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DnsResourceRecordsForZone dataInstance2 = Linux_DnsResourceRecordsForZoneHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_DnsResourceRecordsForZone dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DnsResourceRecordsForZone.getPackages());
    }
