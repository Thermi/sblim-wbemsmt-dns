   ...
   public final static String CIM_CLASS_DISPLAYNAME = CIM_CLASS_NAME;
    ...
    public static class PROPERTY_FORWARD
    {
       ...
       public final static String NAME = "Forward";                  
          ...
          public final static javax.cim.UnsignedInteger8 VALUE_MAP_ENTRY_1_FOR_VALUE_ENTRY_Only 
                              = new javax.cim.UnsignedInteger8("1");
	          	
                       /**
              * constant for value entry Only (corresponds to mapEntry 1 )
              */
             public final static String VALUE_ENTRY_Only 
                              = "Only";
          ...
          public final static javax.cim.UnsignedInteger8 VALUE_MAP_ENTRY_2_FOR_VALUE_ENTRY_First 
                              = new javax.cim.UnsignedInteger8("2");
	          	
                       /**
              * constant for value entry First (corresponds to mapEntry 2 )
              */
             public final static String VALUE_ENTRY_First 
                              = "First";
      ...
      public final static javax.cim.UnsignedInteger8[] VALUE_MAP_ENTRIES = { 
	         	                              VALUE_MAP_ENTRY_0_FOR_VALUE_ENTRY_Unknown
                     	                            ,  VALUE_MAP_ENTRY_1_FOR_VALUE_ENTRY_Only
    ...
    public static class PROPERTY_XFERFORMAT
    {
       ...
       public final static String NAME = "XferFormat";                  
          ...
          public final static javax.cim.UnsignedInteger8 VALUE_MAP_ENTRY_1_FOR_VALUE_ENTRY_Incremental 
                              = new javax.cim.UnsignedInteger8("1");
	          	
                       /**
              * constant for value entry Incremental (corresponds to mapEntry 1 )
              */
             public final static String VALUE_ENTRY_Incremental 
                              = "Incremental";
          ...
          public final static javax.cim.UnsignedInteger8 VALUE_MAP_ENTRY_2_FOR_VALUE_ENTRY_Complete 
                              = new javax.cim.UnsignedInteger8("2");
	          	
                       /**
              * constant for value entry Complete (corresponds to mapEntry 2 )
              */
             public final static String VALUE_ENTRY_Complete 
                              = "Complete";
      ...
      public final static javax.cim.UnsignedInteger8[] VALUE_MAP_ENTRIES = { 
       ...
       public final static String[] VALUE_ENTRIES = { 
                                                   VALUE_ENTRY_Unknown
                                                                 ,  VALUE_ENTRY_Incremental
                                                                 ,  VALUE_ENTRY_Complete
                                    };
...
//**********************************************************************
   ...
   {
              propertiesToCheck.put("ConfigurationDirectory",new CIMProperty("ConfigurationDirectory",CIMDataType.STRING_T,null));
              propertiesToCheck.put("Forward",new CIMProperty("Forward",CIMDataType.UINT8_T,null));
              propertiesToCheck.put("Name",new CIMProperty("Name",CIMDataType.STRING_T,null));
              propertiesToCheck.put("XferFormat",new CIMProperty("XferFormat",CIMDataType.UINT8_T,null));
...
//**********************************************************************
   ...
   public String get_ConfigurationDirectory()    {
       ...
       if (currentProperty == null || currentProperty.getValue() == null) {
           logger.warning("Property " + PROPERTY_CONFIGURATIONDIRECTORY.NAME + " was not found in instance " + getCimObjectPath());
           return null;
       }
   ...
   public boolean set_ConfigurationDirectory(String newValue)
   {
    ...
    public static CIMProperty create_ConfigurationDirectory(WBEMClient client, String namespace, String newValue) throws WbemsmtException {
        ...
        if (property != null)
        {
       	 ...
       	 {
       	 		   logger.warning("Property " + PROPERTY_CONFIGURATIONDIRECTORY.NAME + " was not found in instance " + fco.getCimObjectPath());
       	 }
        return property;
    }
   ...
   private static CIMProperty setPropertyValue_ConfigurationDirectory(CIMProperty currentProperty, String newValue)
   {
        Object setThis = null;        
   ...
   public javax.cim.UnsignedInteger8 get_Forward()    {
       ...
       if (currentProperty == null || currentProperty.getValue() == null) {
           logger.warning("Property " + PROPERTY_FORWARD.NAME + " was not found in instance " + getCimObjectPath());
           return null;
       }
   ...
   public boolean set_Forward(javax.cim.UnsignedInteger8 newValue)
   {
    ...
    public static CIMProperty create_Forward(WBEMClient client, String namespace, javax.cim.UnsignedInteger8 newValue) throws WbemsmtException {
        Linux_DnsServiceSettingData fco = new Linux_DnsServiceSettingData(client,namespace);
        ...
        if (property != null)
        {
       	 ...
       	 {
       	 		   logger.warning("Property " + PROPERTY_FORWARD.NAME + " was not found in instance " + fco.getCimObjectPath());
       	 }
        return property;
    }
   ...
   private static CIMProperty setPropertyValue_Forward(CIMProperty currentProperty, javax.cim.UnsignedInteger8 newValue)
   {
        Object setThis = null;        
   ...
   public javax.cim.UnsignedInteger8 get_XferFormat()    {
       ...
       if (currentProperty == null || currentProperty.getValue() == null) {
           logger.warning("Property " + PROPERTY_XFERFORMAT.NAME + " was not found in instance " + getCimObjectPath());
           return null;
       }
   ...
   public boolean set_XferFormat(javax.cim.UnsignedInteger8 newValue)
   {
    ...
    public static CIMProperty create_XferFormat(WBEMClient client, String namespace, javax.cim.UnsignedInteger8 newValue) throws WbemsmtException {
        Linux_DnsServiceSettingData fco = new Linux_DnsServiceSettingData(client,namespace);
        ...
        if (property != null)
        {
       	 ...
       	 {
       	 		   logger.warning("Property " + PROPERTY_XFERFORMAT.NAME + " was not found in instance " + fco.getCimObjectPath());
       	 }
        return property;
    }
   ...
   private static CIMProperty setPropertyValue_XferFormat(CIMProperty currentProperty, javax.cim.UnsignedInteger8 newValue)
   {
        Object setThis = null;        
...
//**********************************************************************
     ...
     **/
     ...
     public java.util.List<Linux_DnsServiceConfiguration> getAssociated_Linux_DnsServiceConfiguration_Linux_DnsServiceSettingDataForServiceConfigurations(WBEMClient cimClient) throws WbemsmtException {
     ...
     **/
     ...
     public java.util.List<Linux_DnsServiceConfiguration> getAssociated_Linux_DnsServiceConfiguration_Linux_DnsServiceSettingDataForServiceConfigurations(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_Linux_DnsServiceConfiguration_Linux_DnsServiceSettingDataForServiceConfigurationNames(WBEMClient cimClient) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_Linux_DnsServiceConfiguration_Linux_DnsServiceSettingDataForServiceConfigurationNames(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_Linux_DnsServiceConfiguration_Linux_DnsServiceSettingDataForServiceConfigurationNames(WBEMClient cimClient,boolean deep,String associationClass, String resultClass, String role, String resultRole) throws WbemsmtException {
   ...
   public java.util.List<Linux_DnsServiceSettingDataForServiceConfiguration> getAssociations_Linux_DnsServiceSettingDataForServiceConfiguration(WBEMClient cimClient, boolean includeQualifiers, boolean includeClassOrigin, String role,java.lang.String[] propertyList) throws WbemsmtException {

       if (cimClient == null) {
            throw new WbemsmtException(WbemsmtException.ERR_INVALID_PARAMETER ,"The cimClient parameter does not contain a valid reference.");
       }

       java.util.List<Linux_DnsServiceSettingDataForServiceConfiguration> result = new java.util.ArrayList<Linux_DnsServiceSettingDataForServiceConfiguration>();
       CloseableIterator enumeration = null;
       ...
       try {
        ...
        try {
          while (enumeration.hasNext()) {
             ...
             if (obj instanceof CIMInstance) {
                CIMInstance cimInstance = (CIMInstance)obj;
                Class<?> clazz = Linux_DnsServiceSettingDataForServiceConfigurationHelper.findClass(cimClient, cimInstance);
                    
                if (clazz == null) {
                   System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of the base class.");
                   result.add(new Linux_DnsServiceSettingDataForServiceConfiguration(cimInstance));
                   continue;
                }
                ...
                try {
                   Object[] actargs = new Object[] {cimInstance};
                   Object dataObj = cons.newInstance(actargs);
                   result.add((Linux_DnsServiceSettingDataForServiceConfiguration)dataObj);
                } catch (Exception e) {
                   System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of the base class.");
                   result.add(new Linux_DnsServiceSettingDataForServiceConfiguration(cimInstance));
                   continue;
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociationNames_Linux_DnsServiceSettingDataForServiceConfiguration(WBEMClient cimClient,String role, boolean deep) throws WbemsmtException {
        ...
        try {
                while (enumeration.hasNext()) {
                   ...
                   if (obj instanceof CIMObjectPath) {
                      if (deep || ((CIMObjectPath)obj).getObjectName().equals(Linux_DnsServiceSettingDataForServiceConfiguration.CIM_CLASS_NAME)) {
                         result.add((CIMObjectPath)obj);
                      }
                   }
                }
