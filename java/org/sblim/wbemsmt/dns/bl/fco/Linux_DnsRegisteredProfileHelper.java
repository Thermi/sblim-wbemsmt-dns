/** 
 * Linux_DnsRegisteredProfileHelper.java
 *
...
public final class Linux_DnsRegisteredProfileHelper {

	public final static String CIM_CLASS_NAME = "Linux_DnsRegisteredProfile";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new Linux_DnsRegisteredProfile(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<Linux_DnsRegisteredProfile.Java_Package_List.size(); i++) {
						if (!((String)(Linux_DnsRegisteredProfile.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(Linux_DnsRegisteredProfile.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							Linux_DnsRegisteredProfile.Java_Package_List.setElementAt((String)(Linux_DnsRegisteredProfile.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (Linux_DnsRegisteredProfile.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_DnsRegisteredProfile.");
						resultArrayList.add(new Linux_DnsRegisteredProfile(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_DnsRegisteredProfile.");
						resultArrayList.add(new Linux_DnsRegisteredProfile(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DnsRegisteredProfile.");
						resultArrayList.add(new Linux_DnsRegisteredProfile(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static Linux_DnsRegisteredProfile getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return Linux_DnsRegisteredProfileHelper.getInstance(cimClient, new Linux_DnsRegisteredProfile(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_DnsRegisteredProfile getInstance(CIMClient cimClient, Linux_DnsRegisteredProfile dataInstance) {
		...
		return Linux_DnsRegisteredProfileHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static Linux_DnsRegisteredProfile getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		Linux_DnsRegisteredProfile dataInstance = null;
		try {
			dataInstance = new Linux_DnsRegisteredProfile(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_DnsRegisteredProfile createInstance(CIMClient cimClient, Linux_DnsRegisteredProfile dataInstance, boolean notifyDifferencies){ 
		...
		Linux_DnsRegisteredProfile newDataInstance = null;
		try {
			newDataInstance = Linux_DnsRegisteredProfileHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static Linux_DnsRegisteredProfile modifyInstance(CIMClient cimClient, Linux_DnsRegisteredProfile dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = Linux_DnsRegisteredProfileHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, Linux_DnsRegisteredProfile dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, Linux_DnsRegisteredProfile dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					Linux_DnsRegisteredProfile.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!Linux_DnsRegisteredProfile.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < Linux_DnsRegisteredProfile.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(Linux_DnsRegisteredProfile.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(Linux_DnsRegisteredProfile.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
