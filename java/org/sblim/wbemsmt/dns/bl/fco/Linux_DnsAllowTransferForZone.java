/**
 * Linux_DnsAllowTransferForZone.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
 ...
 *            allow-transfer. generated Class
 */
...
public class Linux_DnsAllowTransferForZone extends CIM_Component {
    ...
    public Linux_DnsAllowTransferForZone(WBEMClient client, String namespace)
    ...
    public Linux_DnsAllowTransferForZone(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected Linux_DnsAllowTransferForZone() {
    }
    ...
    public static CIMProperty create_GroupComponent_Linux_DnsZone(WBEMClient client,
        ...
        Linux_DnsAllowTransferForZone fco = new Linux_DnsAllowTransferForZone(client, namespace);
    ...
    public String getObjectName() {
        return Linux_DnsAllowTransferForZone.CIM_CLASS_NAME;
    }
