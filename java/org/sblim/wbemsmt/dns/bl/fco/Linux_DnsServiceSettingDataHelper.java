...
public class Linux_DnsServiceSettingDataHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DnsServiceSettingData.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DnsServiceSettingData.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DnsServiceSettingData.");
                        resultArrayList.add(new Linux_DnsServiceSettingData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DnsServiceSettingData.");
                        resultArrayList.add(new Linux_DnsServiceSettingData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DnsServiceSettingData.");
                        resultArrayList.add(new Linux_DnsServiceSettingData(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DnsServiceSettingData getInstance(WBEMClient client,
    ...
    public final static Linux_DnsServiceSettingData getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(Linux_DnsServiceSettingData.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                Linux_DnsServiceSettingData.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(Linux_DnsServiceSettingData.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                Linux_DnsServiceSettingData.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DnsServiceSettingData createInstance(WBEMClient client,
            Linux_DnsServiceSettingData dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DnsServiceSettingData newDataInstance = Linux_DnsServiceSettingDataHelper
     ...
     */
    public final static Linux_DnsServiceSettingData modifyInstance(WBEMClient client,
            Linux_DnsServiceSettingData dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DnsServiceSettingData dataInstance2 = Linux_DnsServiceSettingDataHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_DnsServiceSettingData dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DnsServiceSettingData.getPackages());
    }
