/** 
  * Linux_DnsServiceSettingDataHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for Linux_DnsServiceSettingData
  *    
  * 
  * generated Class
  * @see Linux_DnsServiceSettingData
  */
...
public class Linux_DnsServiceSettingDataHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type Linux_DnsServiceSettingData or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(Linux_DnsServiceSettingData.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || Linux_DnsServiceSettingData.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type Linux_DnsServiceSettingData or the subclasses if deep == true
    */        
    public final static List<Linux_DnsServiceSettingData> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<Linux_DnsServiceSettingData> resultArrayList = new ArrayList<Linux_DnsServiceSettingData>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(Linux_DnsServiceSettingData.CIM_CLASS_NAME)) {
                        resultArrayList.add(new Linux_DnsServiceSettingData(cimInstance));
                        continue;
                    }
                    Class<?> clazz = Linux_DnsServiceSettingDataHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class Linux_DnsServiceSettingData.");
                        resultArrayList.add(new Linux_DnsServiceSettingData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class Linux_DnsServiceSettingData.");
                        resultArrayList.add(new Linux_DnsServiceSettingData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((Linux_DnsServiceSettingData)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DnsServiceSettingData.");
                        resultArrayList.add(new Linux_DnsServiceSettingData(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static Linux_DnsServiceSettingData getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static Linux_DnsServiceSettingData getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        Linux_DnsServiceSettingData dataInstance = null;
        Class<?> clazz = Linux_DnsServiceSettingDataHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (Linux_DnsServiceSettingData)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class Linux_DnsServiceSettingData.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new Linux_DnsServiceSettingData(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static Linux_DnsServiceSettingData getInstance(WBEMClient client, String namespace
                                                       ,String InstanceID
                                                       ,String Name
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(Linux_DnsServiceSettingData.PROPERTY_INSTANCEID.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_DnsServiceSettingData.CIM_CLASS_NAME); 
                   
                   setThis = Name;
                
           keyProperties[1]  = new CIMProperty(Linux_DnsServiceSettingData.PROPERTY_NAME.NAME,CIMDataType.STRING_T,setThis,true,false,Linux_DnsServiceSettingData.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(Linux_DnsServiceSettingData.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static Linux_DnsServiceSettingData createInstance(WBEMClient client, Linux_DnsServiceSettingData dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        Linux_DnsServiceSettingData newDataInstance = Linux_DnsServiceSettingDataHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static Linux_DnsServiceSettingData modifyInstance(WBEMClient client, Linux_DnsServiceSettingData dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           Linux_DnsServiceSettingData dataInstance2 = Linux_DnsServiceSettingDataHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, Linux_DnsServiceSettingData dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,Linux_DnsServiceSettingData.getPackages());
    }
