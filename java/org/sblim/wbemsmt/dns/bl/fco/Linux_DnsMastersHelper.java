...
public class Linux_DnsMastersHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DnsMasters.CIM_CLASS_NAME,
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DnsMasters.");
                        resultArrayList.add(new Linux_DnsMasters(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DnsMasters.");
                        resultArrayList.add(new Linux_DnsMasters(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DnsMasters.");
                        resultArrayList.add(new Linux_DnsMasters(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DnsMasters getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static Linux_DnsMasters getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static Linux_DnsMasters getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(Linux_DnsMasters.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_DnsMasters.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(Linux_DnsMasters.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_DnsMasters.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DnsMasters createInstance(WBEMClient client,
            Linux_DnsMasters dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        Linux_DnsMasters newDataInstance = Linux_DnsMastersHelper
     ...
     */
    public final static Linux_DnsMasters modifyInstance(WBEMClient client,
            Linux_DnsMasters dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DnsMasters dataInstance2 = Linux_DnsMastersHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_DnsMasters dataInstance)
            throws WbemsmtException {
