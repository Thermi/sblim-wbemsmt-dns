...
public class Linux_DnsBlackholeForServiceHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DnsBlackholeForService.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DnsBlackholeForService.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DnsBlackholeForService.");
                        resultArrayList.add(new Linux_DnsBlackholeForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DnsBlackholeForService.");
                        resultArrayList.add(new Linux_DnsBlackholeForService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DnsBlackholeForService.");
                        resultArrayList.add(new Linux_DnsBlackholeForService(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DnsBlackholeForService getInstance(WBEMClient client,
    ...
    public final static Linux_DnsBlackholeForService getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                Linux_DnsBlackholeForService.PROPERTY_GROUPCOMPONENT_LINUX_DNSSERVICE.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_DnsBlackholeForService.PROPERTY_PARTCOMPONENT_LINUX_DNSADDRESSMATCHLIST.NAME,
     ...
     *
     */
    public final static Linux_DnsBlackholeForService createInstance(WBEMClient client,
            Linux_DnsBlackholeForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DnsBlackholeForService newDataInstance = Linux_DnsBlackholeForServiceHelper
     ...
     */
    public final static Linux_DnsBlackholeForService modifyInstance(WBEMClient client,
            Linux_DnsBlackholeForService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DnsBlackholeForService dataInstance2 = Linux_DnsBlackholeForServiceHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_DnsBlackholeForService dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DnsBlackholeForService.getPackages());
    }
