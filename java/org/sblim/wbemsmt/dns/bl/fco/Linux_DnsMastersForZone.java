 ...
 *
 *
 * Description:  Association pointing to the Masters, managing this Zone. The Zone can be of
 * type Slave or Stub.
 * 
 */
...
/**
 *  Association pointing to the Masters, managing this Zone. The Zone can be of
 * type Slave or Stub.
 */
public class Linux_DnsMastersForZone extends CIM_Component  {
	
	public final static String CIM_CLASS_NAME = "Linux_DnsMastersForZone"; //$NON-NLS-1$
	...
	static {
		...
		for (int i = 0; i < CIM_Component.CIM_PropertyNameList.size(); i++) {
			...
			Linux_DnsMastersForZone.CIM_PropertyNameList.add(CIM_Component.CIM_PropertyNameList.elementAt(i));
		}
	...
	*	Class constructor
	*/	
	public Linux_DnsMastersForZone() {
	...
	*	Class constructor
	*/	
	public Linux_DnsMastersForZone(Vector keyProperties){ 
		this();
	...
	*	Class constructor
	*/	
	public Linux_DnsMastersForZone(CIMObjectPath cimObjectPath, CIMInstance cimInstance){ 
	...
	*/	
	public boolean equals(Object object) {
	    ...
	    if (!(object instanceof Linux_DnsMastersForZone)) {
	        return false;
	    }
	    
	    if (this.cimInstance == null && ((Linux_DnsMastersForZone)object).cimInstance != null) {
	    	return false;
	    	
	    } else if (this.cimInstance != null && ((Linux_DnsMastersForZone)object).cimInstance == null) {
	    	return false;
	    	
	    } else if (this.cimInstance != null && !this.cimInstance.equals(((Linux_DnsMastersForZone)object).cimInstance)) {
	    	return false;
	    	
	    } else if (this.original_cimInstance == null && ((Linux_DnsMastersForZone)object).original_cimInstance != null) {
	    	return false;
	    	
	    } else if (this.original_cimInstance != null && ((Linux_DnsMastersForZone)object).original_cimInstance == null) {
	    	return false;
	    	
	    } else if (this.original_cimInstance != null && !this.original_cimInstance.equals(((Linux_DnsMastersForZone)object).original_cimInstance)) {
	        return false;
	        
	    } else if (this.cimObjectPath == null && ((Linux_DnsMastersForZone)object).cimObjectPath != null) {
	    	return false;
	    	
	    } else if (this.cimObjectPath != null && ((Linux_DnsMastersForZone)object).cimObjectPath == null) {
	    	return false;
		    	
	    } else if (this.cimObjectPath != null && !this.cimObjectPath.equals(((Linux_DnsMastersForZone)object).cimObjectPath)) {
	        return false;
	...
	*/	
	...
	public CIMObjectPath get_Linux_DnsZone() {
		...
		CIMProperty currentProperty = this.cimInstance.getProperty(Linux_DnsMastersForZone.CIM_PROPERTY_LINUX_DNSZONE);
	...
	public CIMObjectPath get_Linux_DnsMasters() {
		...
		CIMProperty currentProperty = this.cimInstance.getProperty(Linux_DnsMastersForZone.CIM_PROPERTY_LINUX_DNSMASTERS);
