...
public class Linux_DnsAllowQueryForZoneHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DnsAllowQueryForZone.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DnsAllowQueryForZone.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DnsAllowQueryForZone.");
                        resultArrayList.add(new Linux_DnsAllowQueryForZone(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DnsAllowQueryForZone.");
                        resultArrayList.add(new Linux_DnsAllowQueryForZone(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DnsAllowQueryForZone.");
                        resultArrayList.add(new Linux_DnsAllowQueryForZone(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DnsAllowQueryForZone getInstance(WBEMClient client,
    ...
    public final static Linux_DnsAllowQueryForZone getInstance(WBEMClient client, String namespace,
            Linux_DnsZone GroupComponent, Linux_DnsAddressMatchList PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                Linux_DnsAllowQueryForZone.PROPERTY_GROUPCOMPONENT_LINUX_DNSZONE.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                Linux_DnsAllowQueryForZone.PROPERTY_PARTCOMPONENT_LINUX_DNSADDRESSMATCHLIST.NAME,
     ...
     *
     */
    public final static Linux_DnsAllowQueryForZone createInstance(WBEMClient client,
            Linux_DnsAllowQueryForZone dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        Linux_DnsAllowQueryForZone newDataInstance = Linux_DnsAllowQueryForZoneHelper.getInstance(
     ...
     */
    public final static Linux_DnsAllowQueryForZone modifyInstance(WBEMClient client,
            Linux_DnsAllowQueryForZone dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DnsAllowQueryForZone dataInstance2 = Linux_DnsAllowQueryForZoneHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            Linux_DnsAllowQueryForZone dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DnsAllowQueryForZone.getPackages());
    }
