...
public class Linux_DnsForwardZoneHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(Linux_DnsForwardZone.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || Linux_DnsForwardZone.CIM_CLASS_NAME
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class Linux_DnsForwardZone.");
                        resultArrayList.add(new Linux_DnsForwardZone(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class Linux_DnsForwardZone.");
                        resultArrayList.add(new Linux_DnsForwardZone(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class Linux_DnsForwardZone.");
                        resultArrayList.add(new Linux_DnsForwardZone(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static Linux_DnsForwardZone getInstance(WBEMClient client,
     ...
     */
    public final static Linux_DnsForwardZone getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static Linux_DnsForwardZone getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(Linux_DnsForwardZone.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_DnsForwardZone.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(Linux_DnsForwardZone.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, Linux_DnsForwardZone.CIM_CLASS_NAME);
     ...
     *
     */
    public final static Linux_DnsForwardZone createInstance(WBEMClient client,
            Linux_DnsForwardZone dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        Linux_DnsForwardZone newDataInstance = Linux_DnsForwardZoneHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static Linux_DnsForwardZone modifyInstance(WBEMClient client,
            Linux_DnsForwardZone dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            Linux_DnsForwardZone dataInstance2 = Linux_DnsForwardZoneHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, Linux_DnsForwardZone dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                Linux_DnsForwardZone.getPackages());
    }
