...
public class CreateForwardZoneWizardContainer extends AbstractWizardContainerBase implements
        IWizardContainer {
    ...
    public CreateForwardZoneWizardContainer(AbstractBaseCimAdapter adapter,
            CreateForwardZoneWizardContainerPanels panels) {
        super(adapter);
        this.panels = panels;
        hmPages = new HashMap();
