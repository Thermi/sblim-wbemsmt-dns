/** 
  * CreateForwardZoneWizardContainer.java
  *
 ...
 * © Copyright IBM Corp. 2005
  ...
  * Contributors: 
  * 
  * Description: WizardContainer for Wizard forForwardZones
  * 
  * generated Class
  */
...
import org.sblim.wbemsmt.bl.adapter.AbstractBaseCimAdapter;
	...
	public class CreateForwardZoneWizardContainer extends AbstractWizardContainerBase implements IWizardContainer {

	org.sblim.wbemsmt.tools.wizard.WizardContainerUtil util = new CreateForwardZoneWizardContainerUtil();
	static Logger logger = Logger.getLogger(CreateForwardZoneWizardContainer.class.getName());
	
			public static final String WIZARD_PANEL_MAIN = "main";
    		public static final String WIZARD_PANEL_OVERVIEW = "overview";
    
	private final CreateForwardZoneWizardContainerPanels panels;
	
	public CreateForwardZoneWizardContainer(AbstractBaseCimAdapter adapter, CreateForwardZoneWizardContainerPanels panels) {
		super(adapter);
		this.panels = panels;
		hmPages = new HashMap();
