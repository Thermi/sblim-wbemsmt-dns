 /** 
  * MasterWizardContainerUtil.java
  *
  ...
  * Contributors: 
  * 
  * Description: Util for creating Masters
  * 
  */
...
public class MasterWizardContainerUtil extends WizardContainerUtil {

	
	static final String[] panelNames = new String[]{
		MasterWizardContainer.WIZARD_PANEL_PAGE1,
		MasterWizardContainer.WIZARD_PANEL_SUMMARY
	};
