...
public class CreateResourceRecordWizardContainer extends AbstractWizardContainerBase implements
        IWizardContainer {
    ...
    public CreateResourceRecordWizardContainer(AbstractBaseCimAdapter adapter,
            CreateResourceRecordWizardContainerPanels panels) {
        super(adapter);
        this.panels = panels;
        hmPages = new HashMap();
