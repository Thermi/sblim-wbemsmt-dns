 /** 
  * CreateMasterZoneWizardContainerUtil.java
  *
  ...
  * Contributors: 
  * 
  * Description: Wizard container util for creating a MasterZone
  * 
  */
...
public class CreateMasterZoneWizardContainerUtil extends WizardContainerUtil {

	static final String[] panelNames = new String[]{
		CreateMasterZoneWizardContainer.WIZARD_PANEL_MAIN,
		CreateMasterZoneWizardContainer.WIZARD_PANEL_OVERVIEW
	};

	/**
	 * 
	 */
	public CreateMasterZoneWizardContainerUtil() {
		super();
	}
