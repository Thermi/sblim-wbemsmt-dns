...
public class CreateReverseZoneWizardContainer extends AbstractWizardContainerBase implements
        IWizardContainer {
    ...
    public CreateReverseZoneWizardContainer(AbstractBaseCimAdapter adapter,
            CreateReverseZoneWizardContainerPanels panels) {
        super(adapter);
        this.panels = panels;
        hmPages = new HashMap();
