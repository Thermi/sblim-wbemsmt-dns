 /** 
  * CreateSlaveZoneWizardContainerUtil.java
  *
  ...
  * Contributors: 
  * 
  * Description: Wizard container util for creating a SlaveZone
  * 
  */
...
public class CreateSlaveZoneWizardContainerUtil extends WizardContainerUtil {
	...
	static final String[] panelNames = new String[]{
		CreateSlaveZoneWizardContainer.WIZARD_PANEL_MAIN,
		CreateSlaveZoneWizardContainer.WIZARD_PANEL_OVERVIEW
	};
