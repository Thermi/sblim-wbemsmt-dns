 /** 
  * AddressMatchListWizardContainerUtil.java
  *
  ...
  * Contributors: 
  * 
  * Description: Util for creating AddressMatchLists
  * 
  */
...
public class AddressMatchListWizardContainerUtil extends WizardContainerUtil {

	
	static final String[] panelNames = new String[]{
		AddressMatchListWizardContainer.WIZARD_PANEL_PAGE1,
		AddressMatchListWizardContainer.WIZARD_PANEL_SUMMARY
	};
