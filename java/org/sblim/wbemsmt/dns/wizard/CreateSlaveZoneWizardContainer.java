...
public class CreateSlaveZoneWizardContainer extends AbstractWizardContainerBase implements
        IWizardContainer {
    ...
    public CreateSlaveZoneWizardContainer(AbstractBaseCimAdapter adapter,
            CreateSlaveZoneWizardContainerPanels panels) {
        super(adapter);
        this.panels = panels;
        hmPages = new HashMap();
