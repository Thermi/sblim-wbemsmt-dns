...
public class CreateMasterZoneWizardContainer extends AbstractWizardContainerBase implements
        IWizardContainer {
    ...
    public CreateMasterZoneWizardContainer(AbstractBaseCimAdapter adapter,
            CreateMasterZoneWizardContainerPanels panels) {
        super(adapter);
        this.panels = panels;
        hmPages = new HashMap();
