...
public class CreateStubZoneWizardContainer extends AbstractWizardContainerBase implements
        IWizardContainer {
    ...
    public CreateStubZoneWizardContainer(AbstractBaseCimAdapter adapter,
            CreateStubZoneWizardContainerPanels panels) {
        super(adapter);
        this.panels = panels;
        hmPages = new HashMap();
