/** 
  * CreateStubZoneWizardContainer.java
  *
 ...
 * (C) Copyright IBM Corp. 2005
  ...
  * Contributors: 
  * 
  * Description: WizardContainer for Wizard for StubZones
  * 
  * generated Class
  */
...
import org.sblim.wbemsmt.bl.adapter.AbstractBaseCimAdapter;
	...
	public class CreateStubZoneWizardContainer extends AbstractWizardContainerBase implements IWizardContainer {

	org.sblim.wbemsmt.tools.wizard.WizardContainerUtil util = new CreateStubZoneWizardContainerUtil();
	static Logger logger = Logger.getLogger(CreateStubZoneWizardContainer.class.getName());
	
			public static final String WIZARD_PANEL_MAIN = "main";
    		public static final String WIZARD_PANEL_OVERVIEW = "overview";
    
	private final CreateStubZoneWizardContainerPanels panels;
	
	public CreateStubZoneWizardContainer(AbstractBaseCimAdapter adapter, CreateStubZoneWizardContainerPanels panels) {
		super(adapter);
		this.panels = panels;
		hmPages = new HashMap();
