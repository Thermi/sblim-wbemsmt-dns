/**
 * EditAddressMatchListListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class EditAddressMatchListListener extends TaskLauncherContextMenuEventListenerImpl
        implements org.sblim.wbemsmt.tasklauncher.event.EditListener {

    String jsfListener = "org.sblim.wbemsmt.jsf.dns.listener.EditAddressMatchListListener";
    String swingListener = "org.sblim.wbemsmt.jswing.dns.listener.EditAddressMatchListListener";

    //String cmdListener = "org.sblim.wbemsmt.cli.dns.EditAddressMatchListListener";
