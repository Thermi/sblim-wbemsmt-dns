/** 
  * DeleteReverseZoneListener.java
  *
...
public class DeleteReverseZoneListener extends TaskLauncherContextMenuEventListenerImpl implements org.sblim.wbemsmt.tasklauncher.event.DeleteListener {
