/**
 * ListDnsResourceRecordListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER
...
public class ListDnsResourceRecordListener extends TaskLauncherContextMenuEventListenerImpl
        implements org.sblim.wbemsmt.tasklauncher.event.ListListener {

    String jsfListener = "org.sblim.wbemsmt.jsf.dns.listener.ListDnsResourceRecordListener";
    String swingListener = "org.sblim.wbemsmt.jswing.dns.listener.ListDnsResourceRecordListener";

    //String cmdListener = "org.sblim.wbemsmt.cli.dns.ListDnsResourceRecordListener";
