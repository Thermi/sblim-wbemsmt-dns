/** 
  * ListDnsResourceRecordListener.java
  *
...
public class ListDnsResourceRecordListener extends TaskLauncherContextMenuEventListenerImpl implements org.sblim.wbemsmt.tasklauncher.event.ListListener {
