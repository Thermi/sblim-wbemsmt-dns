/**
 * DeleteForwardZoneListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class DeleteForwardZoneListener extends TaskLauncherContextMenuEventListenerImpl implements
        org.sblim.wbemsmt.tasklauncher.event.DeleteListener {

    String jsfListener = "org.sblim.wbemsmt.jsf.dns.listener.DeleteForwardZoneListener";
    String swingListener = "org.sblim.wbemsmt.jswing.dns.listener.DeleteForwardZoneListener";

    //String cmdListener = "org.sblim.wbemsmt.cli.dns.DeleteForwardZoneListener";
