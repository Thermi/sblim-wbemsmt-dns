/** 
  * DeleteForwardZoneListener.java
  *
...
public class DeleteForwardZoneListener extends TaskLauncherContextMenuEventListenerImpl implements org.sblim.wbemsmt.tasklauncher.event.DeleteListener {
