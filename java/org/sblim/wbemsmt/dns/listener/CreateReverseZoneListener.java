/**
 * CreateReverseZoneListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class CreateReverseZoneListener extends TaskLauncherContextMenuEventListenerImpl implements
        org.sblim.wbemsmt.tasklauncher.event.CreateListener {

    String jsfListener = "org.sblim.wbemsmt.jsf.dns.listener.CreateReverseZoneListener";
    String swingListener = "org.sblim.wbemsmt.jswing.dns.listener.CreateReverseZoneListener";

    //String cmdListener = "org.sblim.wbemsmt.cli.dns.CreateReverseZoneListener";
