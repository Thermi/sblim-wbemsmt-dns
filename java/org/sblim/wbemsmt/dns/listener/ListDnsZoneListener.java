/**
 * ListDnsZoneListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS
...
public class ListDnsZoneListener extends TaskLauncherContextMenuEventListenerImpl implements
        org.sblim.wbemsmt.tasklauncher.event.ListListener {

    String jsfListener = "org.sblim.wbemsmt.jsf.dns.listener.ListDnsZoneListener";
    String swingListener = "org.sblim.wbemsmt.jswing.dns.listener.ListDnsZoneListener";

    //String cmdListener = "org.sblim.wbemsmt.cli.dns.ListDnsZoneListener";
