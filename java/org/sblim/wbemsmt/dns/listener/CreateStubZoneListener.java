/**
 * CreateStubZoneListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class CreateStubZoneListener extends TaskLauncherContextMenuEventListenerImpl implements
        org.sblim.wbemsmt.tasklauncher.event.CreateListener {

    String jsfListener = "org.sblim.wbemsmt.jsf.dns.listener.CreateStubZoneListener";
    String swingListener = "org.sblim.wbemsmt.jswing.dns.listener.CreateStubZoneListener";

    //String cmdListener = "org.sblim.wbemsmt.cli.dns.CreateStubZoneListener";
