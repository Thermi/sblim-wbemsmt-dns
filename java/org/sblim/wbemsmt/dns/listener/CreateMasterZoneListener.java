/**
 * CreateMasterZoneListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE
...
public class CreateMasterZoneListener extends TaskLauncherContextMenuEventListenerImpl implements
        org.sblim.wbemsmt.tasklauncher.event.CreateListener {

    String jsfListener = "org.sblim.wbemsmt.jsf.dns.listener.CreateMasterZoneListener";
    String swingListener = "org.sblim.wbemsmt.jswing.dns.listener.CreateMasterZoneListener";

    //String cmdListener = "org.sblim.wbemsmt.cli.dns.CreateMasterZoneListener";
