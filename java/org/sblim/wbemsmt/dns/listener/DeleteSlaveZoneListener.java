/**
 * DeleteSlaveZoneListener.java Â© Copyright IBM Corp.  2009,2006,2007 THIS FILE IS PROVIDED UNDER THE TER
...
public class DeleteSlaveZoneListener extends TaskLauncherContextMenuEventListenerImpl implements
        org.sblim.wbemsmt.tasklauncher.event.DeleteListener {

    String jsfListener = "org.sblim.wbemsmt.jsf.dns.listener.DeleteSlaveZoneListener";
    String swingListener = "org.sblim.wbemsmt.jswing.dns.listener.DeleteSlaveZoneListener";

    //String cmdListener = "org.sblim.wbemsmt.cli.dns.DeleteSlaveZoneListener";
